...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    localStorage.setItem('lms_lessons_v19_ie', JSON.stringify(initialLessons));
