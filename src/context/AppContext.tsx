...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    localStorage.setItem('lms_lessons_v21_ie', JSON.stringify(initialLessons));
