...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    ['lms_lessons_ie', 'lms_lessons_v2_ie', 'lms_lessons_v3_ie', 'lms_lessons_v4_ie', 'lms_lessons_v5_ie', 'lms_lessons_v6_ie', 'lms_lessons_v7_ie', 'lms_lessons_v8_ie', 'lms_lessons_v9_ie', 'lms_lessons_v10_ie', 'lms_lessons_v11_ie', 'lms_lessons_v12_ie'].forEach(k => {
      try { localStorage.removeItem(k); } catch (e) {}
    });

    const savedLessons = localStorage.getItem('lms_lessons_v13_ie');
    ...
    localStorage.setItem('lms_lessons_v13_ie', JSON.stringify(initialLessons));
