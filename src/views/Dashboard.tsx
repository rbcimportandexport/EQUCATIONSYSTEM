      ...
      <div className="varsity-hero-container">
        <div className="varsity-hero-left">
          ...
          <p className="varsity-description">
            {language === 'hi'
              ? 'आरबीसी एकेडमी आरबीसी के व्यापार विशेषज्ञों द्वारा तैयार किए गए अंतर्राष्ट्रीय व्यापार, आयात-निर्यात नियमों, सीमा शुल्क दस्तावेजों और वैश्विक रसद लॉजिस्टिक्स पाठों का एक विस्तृत संग्रह है। यह सभी के लिए पूरी तरह से मुफ्त और खुला है।'
              : language === 'gu'
        ...
        <div className="varsity-cards-grid">
          ...
          <div className="varsity-card" onClick={() => setActiveView('Videos')}>
            ...
            <div className="varsity-card-body">
              ...
              <p className="varsity-card-desc">
                {language === 'hi'
                  ? 'वीडियो ट्यूटोरियल और पोर्ट रसद लॉजिस्टिक्स गाइड'
                  : language === 'gu'
