...
export const PencilLoader: React.FC<PencilLoaderProps> = ({ text, textColor = '#475569', color = '#0284c7' }) => {
  return (
    <div style={{
      display: 'flex',
      ...
      <svg xmlns="http://www.w3.org/2000/svg" height="160px" width="160px" viewBox="0 0 200 200" className="pencil">
        <defs>
