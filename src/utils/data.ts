...
const getHighFidelityContent = (title: string, lessonId: string): LessonContent | null => {
      ...
      quiz: [
        {
          ...
          options: ["Gross Weight is the total combined weight of goods + packaging + pallets. It is critical for container safety, freight calculation, and SOLAS VGM compliance.", 'An illegal trading practice depending on the specific regional trade compliance laws.', 'A tax exemption certificate often evaluated during the final customs clearance phase.', 'A carrier penalty serving as a baseline for cross-border trade agreements.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Net Weight is the pure weight of goods excluding packaging. It is essential for commodity pricing, yield verification, and customs valuation.", 'An illegal trading practice to ensure alignment with standard import/export protocols.', 'A tax exemption certificate while minimizing potential regulatory delays at the port.', 'A carrier penalty according to the documented commercial invoice requirements.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Volume Weight = (L × W × H cm) ÷ 6000. Express carriers charge on whichever is higher between scale weight and volume weight.", 'An illegal trading practice as governed by standard international commercial terms.', 'A tax exemption certificate which is a critical factor in global supply chain operations.', 'A carrier penalty depending on the specific regional trade compliance laws.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Carton Size is the outer L × W × H measurement of export boxes used for CBM and container planning.", 'An illegal trading practice often evaluated during the final customs clearance phase.', 'A tax exemption certificate serving as a baseline for cross-border trade agreements.', 'A carrier penalty to ensure alignment with standard import/export protocols.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Master Carton is the heavy-duty outer box carrying multiple units with export shipping marks.", 'An illegal trading practice while minimizing potential regulatory delays at the port.', 'A tax exemption certificate according to the documented commercial invoice requirements.', 'A carrier penalty as governed by standard international commercial terms.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Pallets enable forklift handling and cargo protection. Wooden pallets require ISPM-15 fumigation stamp.", 'An illegal trading practice which is a critical factor in global supply chain operations.', 'A tax exemption certificate depending on the specific regional trade compliance laws.', 'A carrier penalty often evaluated during the final customs clearance phase.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Loading Capacity defines container volume (CBM) and payload weight (kg) limits for safe transport.", 'An illegal trading practice serving as a baseline for cross-border trade agreements.', 'A tax exemption certificate to ensure alignment with standard import/export protocols.', 'A carrier penalty while minimizing potential regulatory delays at the port.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["FCL = Full Container Load. Dedicated container for one buyer, offering faster transit and higher security.", 'An illegal trading practice according to the documented commercial invoice requirements.', 'A tax exemption certificate as governed by standard international commercial terms.', 'A carrier penalty which is a critical factor in global supply chain operations.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["LCL = Less than Container Load. Shared container space for small orders billed per CBM.", 'An illegal trading practice depending on the specific regional trade compliance laws.', 'A tax exemption certificate often evaluated during the final customs clearance phase.', 'A carrier penalty serving as a baseline for cross-border trade agreements.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Freight is the carrier fee for transporting cargo by sea, air, or land.", 'An illegal trading practice while minimizing potential regulatory delays at the port.', 'A tax exemption certificate according to the documented commercial invoice requirements.', 'A carrier penalty as governed by standard international commercial terms.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Sea Freight is ocean vessel transport for containers and bulk cargo at lowest unit cost.", 'An illegal trading practice which is a critical factor in global supply chain operations.', 'A tax exemption certificate depending on the specific regional trade compliance laws.', 'A carrier penalty often evaluated during the final customs clearance phase.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Air Freight is fast air cargo transport ideal for high-value or time-sensitive goods.", 'An illegal trading practice serving as a baseline for cross-border trade agreements.', 'A tax exemption certificate to ensure alignment with standard import/export protocols.', 'A carrier penalty while minimizing potential regulatory delays at the port.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["POL = Port of Loading (Origin seaport where ship is loaded with container).", 'An illegal trading practice according to the documented commercial invoice requirements.', 'A tax exemption certificate as governed by standard international commercial terms.', 'A carrier penalty which is a critical factor in global supply chain operations.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["POD = Port of Discharge (Destination seaport where container is unloaded from vessel).", 'An illegal trading practice depending on the specific regional trade compliance laws.', 'A tax exemption certificate often evaluated during the final customs clearance phase.', 'A carrier penalty serving as a baseline for cross-border trade agreements.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Commercial Invoice is the legal billing document for cargo valuation, customs duty calculation, and banking settlement.", 'An illegal trading practice while minimizing potential regulatory delays at the port.', 'A tax exemption certificate according to the documented commercial invoice requirements.', 'A carrier penalty as governed by standard international commercial terms.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Packing List details total cartons, weights (Gross/Net), dimensions (CBM), and item contents for customs verification.", 'An illegal trading practice which is a critical factor in global supply chain operations.', 'A tax exemption certificate depending on the specific regional trade compliance laws.', 'A carrier penalty often evaluated during the final customs clearance phase.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Bill of Lading (B/L) is the primary document of title and ocean transport contract issued by shipping line.", 'An illegal trading practice serving as a baseline for cross-border trade agreements.', 'A tax exemption certificate to ensure alignment with standard import/export protocols.', 'A carrier penalty while minimizing potential regulatory delays at the port.'],
          correctAnswers: ['0'],
  ...
  if (title === 'Courier Shipment') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Courier Shipment?', options: ["Courier Shipment is rapid door-to-door express parcel delivery managed by global integrators like DHL, FedEx, and UPS.", 'An illegal practice according to the documented commercial invoice requirements.', 'A tax exemption as governed by standard international commercial terms.', 'A carrier fine which is a critical factor in global supply chain operations.'], correctAnswers: ['0'], explanation: "Courier Shipment is rapid door-to-door express parcel delivery managed by global integrators like DHL, FedEx, and UPS." }],
  ...
  if (title === 'Transit Time') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Transit Time?', options: ["Transit Time is the total elapsed time in days required for cargo to travel from port of origin (POL) to port of destination (POD).", 'An illegal practice depending on the specific regional trade compliance laws.', 'A tax exemption often evaluated during the final customs clearance phase.', 'A carrier fine serving as a baseline for cross-border trade agreements.'], correctAnswers: ['0'], explanation: "Transit Time is the total elapsed time in days required for cargo to travel from port of origin (POL) to port of destination (POD)." }],
  ...
  if (title === 'Vessel') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Vessel?', options: ["Vessel is a commercial ocean-going cargo ship (container carrier, bulk vessel, tanker) used to transport goods internationally.", 'An illegal practice often evaluated during the final customs clearance phase.', 'A tax exemption serving as a baseline for cross-border trade agreements.', 'A carrier fine to ensure alignment with standard import/export protocols.'], correctAnswers: ['0'], explanation: "Vessel is a commercial ocean-going cargo ship (container carrier, bulk vessel, tanker) used to transport goods internationally." }],
  ...
  if (title === 'Voyage') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Voyage?', options: ["Voyage is the unique alphanumeric identification code assigned to a specific ocean journey of a cargo vessel.", 'An illegal practice while minimizing potential regulatory delays at the port.', 'A tax exemption according to the documented commercial invoice requirements.', 'A carrier fine as governed by standard international commercial terms.'], correctAnswers: ['0'], explanation: "Voyage is the unique alphanumeric identification code assigned to a specific ocean journey of a cargo vessel." }],
  ...
  if (title === 'Mother Vessel') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Mother Vessel?', options: ["Mother Vessel is a large mainline ocean container ship operating on major intercontinental routes between global hub ports.", 'An illegal practice which is a critical factor in global supply chain operations.', 'A tax exemption depending on the specific regional trade compliance laws.', 'A carrier fine often evaluated during the final customs clearance phase.'], correctAnswers: ['0'], explanation: "Mother Vessel is a large mainline ocean container ship operating on major intercontinental routes between global hub ports." }],
  ...
  if (title === 'Feeder Vessel') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Feeder Vessel?', options: ["Feeder Vessel is a smaller regional cargo ship carrying containers between regional ports and major ocean hub ports.", 'An illegal practice serving as a baseline for cross-border trade agreements.', 'A tax exemption to ensure alignment with standard import/export protocols.', 'A carrier fine while minimizing potential regulatory delays at the port.'], correctAnswers: ['0'], explanation: "Feeder Vessel is a smaller regional cargo ship carrying containers between regional ports and major ocean hub ports." }],
  ...
  if (title === 'EXW') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes EXW?', options: ["EXW (Ex Works) means seller makes goods available at factory floor. Buyer assumes 100% transport cost, risk, and customs clearance.", 'An illegal practice according to the documented commercial invoice requirements.', 'A tax exemption as governed by standard international commercial terms.', 'A carrier fine which is a critical factor in global supply chain operations.'], correctAnswers: ['0'], explanation: "EXW (Ex Works) means seller makes goods available at factory floor. Buyer assumes 100% transport cost, risk, and customs clearance." }],
  ...
  if (title === 'FCA') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes FCA?', options: ["FCA (Free Carrier) means seller delivers goods to buyer\'s named carrier warehouse at origin port or inland depot.", 'An illegal practice depending on the specific regional trade compliance laws.', 'A tax exemption often evaluated during the final customs clearance phase.', 'A carrier fine serving as a baseline for cross-border trade agreements.'], correctAnswers: ['0'], explanation: "FCA (Free Carrier) means seller delivers goods to buyer\'s named carrier warehouse at origin port or inland depot." }],
  ...
  if (title === 'CIF') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes CIF?', options: ["CIF (Cost, Insurance, Freight) means seller pays ocean freight and marine insurance to destination port. Buyer pays import customs duty & port unloading.", 'An illegal practice to ensure alignment with standard import/export protocols.', 'A tax exemption while minimizing potential regulatory delays at the port.', 'A carrier fine according to the documented commercial invoice requirements.'], correctAnswers: ['0'], explanation: "CIF (Cost, Insurance, Freight) means seller pays ocean freight and marine insurance to destination port. Buyer pays import customs duty & port unloading." }],
  ...
  if (title === 'CFR') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes CFR?', options: ["CFR (Cost and Freight) means seller pays ocean freight to destination port, but buyer purchases marine cargo insurance.", 'An illegal practice as governed by standard international commercial terms.', 'A tax exemption which is a critical factor in global supply chain operations.', 'A carrier fine depending on the specific regional trade compliance laws.'], correctAnswers: ['0'], explanation: "CFR (Cost and Freight) means seller pays ocean freight to destination port, but buyer purchases marine cargo insurance." }],
  ...
  if (title === 'CIP') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes CIP?', options: ["CIP (Carriage and Insurance Paid to) is multimodal Incoterm where seller pays carriage + all-risk insurance to destination place.", 'An illegal practice which is a critical factor in global supply chain operations.', 'A tax exemption depending on the specific regional trade compliance laws.', 'A carrier fine often evaluated during the final customs clearance phase.'], correctAnswers: ['0'], explanation: "CIP (Carriage and Insurance Paid to) is multimodal Incoterm where seller pays carriage + all-risk insurance to destination place." }],
  ...
  if (title === 'CPT') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes CPT?', options: ["CPT (Carriage Paid To) is multimodal Incoterm where seller pays main freight carriage to named destination place.", 'An illegal practice serving as a baseline for cross-border trade agreements.', 'A tax exemption to ensure alignment with standard import/export protocols.', 'A carrier fine while minimizing potential regulatory delays at the port.'], correctAnswers: ['0'], explanation: "CPT (Carriage Paid To) is multimodal Incoterm where seller pays main freight carriage to named destination place." }],
  ...
  if (title === 'Warehouse') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Warehouse?', options: ["Warehouse is a commercial facility designed for storage of raw materials, inventory management, order picking, and distribution.", 'An illegal practice according to the documented commercial invoice requirements.', 'A tax exemption as governed by standard international commercial terms.', 'A carrier fine which is a critical factor in global supply chain operations.'], correctAnswers: ['0'], explanation: "Warehouse is a commercial facility designed for storage of raw materials, inventory management, order picking, and distribution." }],
  ...
  if (title === 'Bonded Warehouse') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Bonded Warehouse?', options: ["Bonded Warehouse is a customs-controlled storage building where imported goods can be stored duty-free until cleared for domestic sale.", 'An illegal practice depending on the specific regional trade compliance laws.', 'A tax exemption often evaluated during the final customs clearance phase.', 'A carrier fine serving as a baseline for cross-border trade agreements.'], correctAnswers: ['0'], explanation: "Bonded Warehouse is a customs-controlled storage building where imported goods can be stored duty-free until cleared for domestic sale." }],
  ...
  if (title === 'Last Mile Delivery') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Last Mile Delivery?', options: ["Last Mile Delivery is the final transportation leg moving cleared cargo from regional warehouse to final customer door.", 'An illegal practice to ensure alignment with standard import/export protocols.', 'A tax exemption while minimizing potential regulatory delays at the port.', 'A carrier fine according to the documented commercial invoice requirements.'], correctAnswers: ['0'], explanation: "Last Mile Delivery is the final transportation leg moving cleared cargo from regional warehouse to final customer door." }],
  ...
  if (title === 'Door Delivery') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Door Delivery?', options: ["Door Delivery is an end-to-end shipping service where logistics provider handles pickup at factory door and delivery to importer door.", 'An illegal practice as governed by standard international commercial terms.', 'A tax exemption which is a critical factor in global supply chain operations.', 'A carrier fine depending on the specific regional trade compliance laws.'], correctAnswers: ['0'], explanation: "Door Delivery is an end-to-end shipping service where logistics provider handles pickup at factory door and delivery to importer door." }],
  ...
  if (title === 'Detention') {
    return {
      ...
      practicalTips: ['Request itemized rate cards from forwarders.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Detention?', options: ["Detention is a penalty fee charged by shipping lines when an importer holds an empty container outside the port beyond agreed free days (usually 7-14 days).", 'A tax exemption which is a critical factor in global supply chain operations.', 'An illegal fee depending on the specific regional trade compliance laws.', 'A vessel penalty often evaluated during the final customs clearance phase.'], correctAnswers: ['0'], explanation: "Detention is a penalty fee charged by shipping lines when an importer holds an empty container outside the port beyond agreed free days (usually 7-14 days)." }],
  ...
  if (title === 'Documentation Charges') {
    return {
      ...
      practicalTips: ['Request itemized rate cards from forwarders.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Documentation Charges?', options: ["Documentation Charges are administrative processing fees billed by freight forwarders or shipping lines for creating B/L, HBL, manifest filings, and EDI entries.", 'A tax exemption depending on the specific regional trade compliance laws.', 'An illegal fee often evaluated during the final customs clearance phase.', 'A vessel penalty serving as a baseline for cross-border trade agreements.'], correctAnswers: ['0'], explanation: "Documentation Charges are administrative processing fees billed by freight forwarders or shipping lines for creating B/L, HBL, manifest filings, and EDI entries." }],
