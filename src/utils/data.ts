...
const getHighFidelityContent = (title: string, lessonId: string): LessonContent | null => {
      ...
      quiz: [
        {
          ...
          options: [
            'The base invoice price paid exclusively to the foreign supplier, excluding any additional logistics or clearance fees.',
            'The total cost of goods + freight + customs clearances + duties + domestic transit as governed by standard international commercial terms.',
            'Only the specific port terminal handling charges incurred during the unloading of cargo from the shipping vessel.',
            'The final retail shelf price of the product as determined by local market demand, competitor pricing, and distributor margins.'
          ],
          correctAnswers: ['1'],
      ...
      quiz: [
        {
          ...
          options: [
            'When cargo leaves the seller’s warehouse which is a critical factor in global supply chain operations.',
      ...
      quiz: [
        {
          ...
          options: ["Gross Weight is the total combined weight of goods + packaging + pallets. It is critical for container safety, freight calculation, and SOLAS VGM compliance.", 'An illegal trading practice depending on the specific regional trade compliance laws. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A tax exemption certificate often evaluated during the final customs clearance phase. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A carrier penalty serving as a baseline for cross-border trade agreements. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Net Weight is the pure weight of goods excluding packaging. It is essential for commodity pricing, yield verification, and customs valuation.", 'An illegal trading practice to ensure alignment with standard import/export protocols. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A tax exemption certificate while minimizing potential regulatory delays at the port. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A carrier penalty according to the documented commercial invoice requirements. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Volume Weight = (L × W × H cm) ÷ 6000. Express carriers charge on whichever is higher between scale weight and volume weight.", 'An illegal trading practice as governed by standard international commercial terms. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A tax exemption certificate which is a critical factor in global supply chain operations. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A carrier penalty depending on the specific regional trade compliance laws. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Carton Size is the outer L × W × H measurement of export boxes used for CBM and container planning.", 'An illegal trading practice often evaluated during the final customs clearance phase. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A tax exemption certificate serving as a baseline for cross-border trade agreements. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A carrier penalty to ensure alignment with standard import/export protocols. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Master Carton is the heavy-duty outer box carrying multiple units with export shipping marks.", 'An illegal trading practice while minimizing potential regulatory delays at the port. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A tax exemption certificate according to the documented commercial invoice requirements. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A carrier penalty as governed by standard international commercial terms. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Pallets enable forklift handling and cargo protection. Wooden pallets require ISPM-15 fumigation stamp.", 'An illegal trading practice which is a critical factor in global supply chain operations. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A tax exemption certificate depending on the specific regional trade compliance laws. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A carrier penalty often evaluated during the final customs clearance phase. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Loading Capacity defines container volume (CBM) and payload weight (kg) limits for safe transport.", 'An illegal trading practice serving as a baseline for cross-border trade agreements. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A tax exemption certificate to ensure alignment with standard import/export protocols. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A carrier penalty while minimizing potential regulatory delays at the port. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["FCL = Full Container Load. Dedicated container for one buyer, offering faster transit and higher security.", 'An illegal trading practice according to the documented commercial invoice requirements. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A tax exemption certificate as governed by standard international commercial terms. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A carrier penalty which is a critical factor in global supply chain operations. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["LCL = Less than Container Load. Shared container space for small orders billed per CBM.", 'An illegal trading practice depending on the specific regional trade compliance laws. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A tax exemption certificate often evaluated during the final customs clearance phase. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A carrier penalty serving as a baseline for cross-border trade agreements. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["20FT Container = 28-30 CBM volume, 21.7 ton payload. Best for heavy dense cargo.", 'An illegal trading practice to ensure alignment with standard import/export protocols. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A tax exemption certificate while minimizing potential regulatory delays at the port. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A carrier penalty according to the documented commercial invoice requirements. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["40FT Container = 58-60 CBM volume, 26.5 ton payload. Double volume of 20FT at lower cost.", 'An illegal trading practice as governed by standard international commercial terms. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A tax exemption certificate which is a critical factor in global supply chain operations. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A carrier penalty depending on the specific regional trade compliance laws. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["40HQ Container = 68-70 CBM volume. 1ft taller than 40FT, maximum volume for light bulky cargo.", 'An illegal trading practice often evaluated during the final customs clearance phase. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A tax exemption certificate serving as a baseline for cross-border trade agreements. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A carrier penalty to ensure alignment with standard import/export protocols. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Freight is the carrier fee for transporting cargo by sea, air, or land.", 'An illegal trading practice while minimizing potential regulatory delays at the port. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A tax exemption certificate according to the documented commercial invoice requirements. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A carrier penalty as governed by standard international commercial terms. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Sea Freight is ocean vessel transport for containers and bulk cargo at lowest unit cost.", 'An illegal trading practice which is a critical factor in global supply chain operations. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A tax exemption certificate depending on the specific regional trade compliance laws. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A carrier penalty often evaluated during the final customs clearance phase. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Air Freight is fast air cargo transport ideal for high-value or time-sensitive goods.", 'An illegal trading practice serving as a baseline for cross-border trade agreements. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A tax exemption certificate to ensure alignment with standard import/export protocols. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A carrier penalty while minimizing potential regulatory delays at the port. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["POL = Port of Loading (Origin seaport where ship is loaded with container).", 'An illegal trading practice according to the documented commercial invoice requirements. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A tax exemption certificate as governed by standard international commercial terms. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A carrier penalty which is a critical factor in global supply chain operations. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["POD = Port of Discharge (Destination seaport where container is unloaded from vessel).", 'An illegal trading practice depending on the specific regional trade compliance laws. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A tax exemption certificate often evaluated during the final customs clearance phase. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A carrier penalty serving as a baseline for cross-border trade agreements. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["ICD = Inland Container Depot (Dry Port). Inland customs facility for local clearance away from seaports.", 'An illegal trading practice to ensure alignment with standard import/export protocols. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A tax exemption certificate while minimizing potential regulatory delays at the port. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A carrier penalty according to the documented commercial invoice requirements. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["CFS = Container Freight Station. Customs warehouse for consolidating and sorting LCL cargo.", 'An illegal trading practice as governed by standard international commercial terms. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A tax exemption certificate which is a critical factor in global supply chain operations. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A carrier penalty depending on the specific regional trade compliance laws. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Proforma Invoice is a preliminary sales agreement used for advance deposit payment and LC opening.", 'An illegal trading practice often evaluated during the final customs clearance phase. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A tax exemption certificate serving as a baseline for cross-border trade agreements. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A carrier penalty to ensure alignment with standard import/export protocols. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Commercial Invoice is the legal billing document for cargo valuation, customs duty calculation, and banking settlement.", 'An illegal trading practice while minimizing potential regulatory delays at the port. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A tax exemption certificate according to the documented commercial invoice requirements. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A carrier penalty as governed by standard international commercial terms. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Packing List details total cartons, weights (Gross/Net), dimensions (CBM), and item contents for customs verification.", 'An illegal trading practice which is a critical factor in global supply chain operations. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A tax exemption certificate depending on the specific regional trade compliance laws. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A carrier penalty often evaluated during the final customs clearance phase. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.'],
          correctAnswers: ['0'],
      ...
      quiz: [
        {
          ...
          options: ["Bill of Lading (B/L) is the primary document of title and ocean transport contract issued by shipping line.", 'An illegal trading practice serving as a baseline for cross-border trade agreements. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A tax exemption certificate to ensure alignment with standard import/export protocols. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A carrier penalty while minimizing potential regulatory delays at the port. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.'],
          correctAnswers: ['0'],
  ...
  if (title === 'Courier Shipment') {
    return {
      ...
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Courier Shipment?', options: ["Courier Shipment is rapid door-to-door express parcel delivery managed by global integrators like DHL, FedEx, and UPS.", 'An illegal practice according to the documented commercial invoice requirements. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A tax exemption as governed by standard international commercial terms. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A carrier fine which is a critical factor in global supply chain operations. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.'], correctAnswers: ['0'], explanation: "Courier Shipment is rapid door-to-door express parcel delivery managed by global integrators like DHL, FedEx, and UPS." }],
  ...
  if (title === 'Transit Time') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Transit Time?', options: ["Transit Time is the total elapsed time in days required for cargo to travel from port of origin (POL) to port of destination (POD).", 'An illegal practice depending on the specific regional trade compliance laws. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A tax exemption often evaluated during the final customs clearance phase. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A carrier fine serving as a baseline for cross-border trade agreements. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.'], correctAnswers: ['0'], explanation: "Transit Time is the total elapsed time in days required for cargo to travel from port of origin (POL) to port of destination (POD)." }],
  ...
  if (title === 'ETD') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes ETD?', options: ["ETD (Estimated Time of Departure) is the scheduled date and time when a shipping vessel or cargo plane departs from origin port.", 'An illegal practice to ensure alignment with standard import/export protocols. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A tax exemption while minimizing potential regulatory delays at the port. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A carrier fine according to the documented commercial invoice requirements. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.'], correctAnswers: ['0'], explanation: "ETD (Estimated Time of Departure) is the scheduled date and time when a shipping vessel or cargo plane departs from origin port." }],
  ...
  if (title === 'ETA') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes ETA?', options: ["ETA (Estimated Time of Arrival) is the anticipated date and time when vessel or aircraft arrives at destination port.", 'An illegal practice as governed by standard international commercial terms. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A tax exemption which is a critical factor in global supply chain operations. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A carrier fine depending on the specific regional trade compliance laws. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.'], correctAnswers: ['0'], explanation: "ETA (Estimated Time of Arrival) is the anticipated date and time when vessel or aircraft arrives at destination port." }],
  ...
  if (title === 'Vessel') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Vessel?', options: ["Vessel is a commercial ocean-going cargo ship (container carrier, bulk vessel, tanker) used to transport goods internationally.", 'An illegal practice often evaluated during the final customs clearance phase. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A tax exemption serving as a baseline for cross-border trade agreements. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A carrier fine to ensure alignment with standard import/export protocols. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.'], correctAnswers: ['0'], explanation: "Vessel is a commercial ocean-going cargo ship (container carrier, bulk vessel, tanker) used to transport goods internationally." }],
  ...
  if (title === 'Voyage') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Voyage?', options: ["Voyage is the unique alphanumeric identification code assigned to a specific ocean journey of a cargo vessel.", 'An illegal practice while minimizing potential regulatory delays at the port. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A tax exemption according to the documented commercial invoice requirements. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A carrier fine as governed by standard international commercial terms. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.'], correctAnswers: ['0'], explanation: "Voyage is the unique alphanumeric identification code assigned to a specific ocean journey of a cargo vessel." }],
  ...
  if (title === 'Mother Vessel') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Mother Vessel?', options: ["Mother Vessel is a large mainline ocean container ship operating on major intercontinental routes between global hub ports.", 'An illegal practice which is a critical factor in global supply chain operations. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A tax exemption depending on the specific regional trade compliance laws. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A carrier fine often evaluated during the final customs clearance phase. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.'], correctAnswers: ['0'], explanation: "Mother Vessel is a large mainline ocean container ship operating on major intercontinental routes between global hub ports." }],
  ...
  if (title === 'Feeder Vessel') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Feeder Vessel?', options: ["Feeder Vessel is a smaller regional cargo ship carrying containers between regional ports and major ocean hub ports.", 'An illegal practice serving as a baseline for cross-border trade agreements. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A tax exemption to ensure alignment with standard import/export protocols. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A carrier fine while minimizing potential regulatory delays at the port. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.'], correctAnswers: ['0'], explanation: "Feeder Vessel is a smaller regional cargo ship carrying containers between regional ports and major ocean hub ports." }],
  ...
  if (title === 'EXW') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes EXW?', options: ["EXW (Ex Works) means seller makes goods available at factory floor. Buyer assumes 100% transport cost, risk, and customs clearance.", 'An illegal practice according to the documented commercial invoice requirements. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A tax exemption as governed by standard international commercial terms. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A carrier fine which is a critical factor in global supply chain operations. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.'], correctAnswers: ['0'], explanation: "EXW (Ex Works) means seller makes goods available at factory floor. Buyer assumes 100% transport cost, risk, and customs clearance." }],
  ...
  if (title === 'FCA') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes FCA?', options: ["FCA (Free Carrier) means seller delivers goods to buyer\'s named carrier warehouse at origin port or inland depot.", 'An illegal practice depending on the specific regional trade compliance laws. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A tax exemption often evaluated during the final customs clearance phase. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A carrier fine serving as a baseline for cross-border trade agreements. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.'], correctAnswers: ['0'], explanation: "FCA (Free Carrier) means seller delivers goods to buyer\'s named carrier warehouse at origin port or inland depot." }],
  ...
  if (title === 'CIF') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes CIF?', options: ["CIF (Cost, Insurance, Freight) means seller pays ocean freight and marine insurance to destination port. Buyer pays import customs duty & port unloading.", 'An illegal practice to ensure alignment with standard import/export protocols. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A tax exemption while minimizing potential regulatory delays at the port. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A carrier fine according to the documented commercial invoice requirements. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.'], correctAnswers: ['0'], explanation: "CIF (Cost, Insurance, Freight) means seller pays ocean freight and marine insurance to destination port. Buyer pays import customs duty & port unloading." }],
  ...
  if (title === 'CFR') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes CFR?', options: ["CFR (Cost and Freight) means seller pays ocean freight to destination port, but buyer purchases marine cargo insurance.", 'An illegal practice as governed by standard international commercial terms. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A tax exemption which is a critical factor in global supply chain operations. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A carrier fine depending on the specific regional trade compliance laws. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.'], correctAnswers: ['0'], explanation: "CFR (Cost and Freight) means seller pays ocean freight to destination port, but buyer purchases marine cargo insurance." }],
  ...
  if (title === 'DDP') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes DDP?', options: ["DDP (Delivered Duty Paid) means seller handles entire logistics including ocean freight, customs duty, taxes, and final door delivery. Maximum seller risk.", 'An illegal practice often evaluated during the final customs clearance phase. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A tax exemption serving as a baseline for cross-border trade agreements. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A carrier fine to ensure alignment with standard import/export protocols. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.'], correctAnswers: ['0'], explanation: "DDP (Delivered Duty Paid) means seller handles entire logistics including ocean freight, customs duty, taxes, and final door delivery. Maximum seller risk." }],
  ...
  if (title === 'DAP') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes DAP?', options: ["DAP (Delivered At Place) means seller delivers cargo to buyer door, but buyer pays import customs duties and taxes.", 'An illegal practice while minimizing potential regulatory delays at the port. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A tax exemption according to the documented commercial invoice requirements. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A carrier fine as governed by standard international commercial terms. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.'], correctAnswers: ['0'], explanation: "DAP (Delivered At Place) means seller delivers cargo to buyer door, but buyer pays import customs duties and taxes." }],
  ...
  if (title === 'CIP') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes CIP?', options: ["CIP (Carriage and Insurance Paid to) is multimodal Incoterm where seller pays carriage + all-risk insurance to destination place.", 'An illegal practice which is a critical factor in global supply chain operations. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A tax exemption depending on the specific regional trade compliance laws. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A carrier fine often evaluated during the final customs clearance phase. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.'], correctAnswers: ['0'], explanation: "CIP (Carriage and Insurance Paid to) is multimodal Incoterm where seller pays carriage + all-risk insurance to destination place." }],
  ...
  if (title === 'CPT') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes CPT?', options: ["CPT (Carriage Paid To) is multimodal Incoterm where seller pays main freight carriage to named destination place.", 'An illegal practice serving as a baseline for cross-border trade agreements. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A tax exemption to ensure alignment with standard import/export protocols. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A carrier fine while minimizing potential regulatory delays at the port. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.'], correctAnswers: ['0'], explanation: "CPT (Carriage Paid To) is multimodal Incoterm where seller pays main freight carriage to named destination place." }],
  ...
  if (title === 'Warehouse') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Warehouse?', options: ["Warehouse is a commercial facility designed for storage of raw materials, inventory management, order picking, and distribution.", 'An illegal practice according to the documented commercial invoice requirements. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A tax exemption as governed by standard international commercial terms. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A carrier fine which is a critical factor in global supply chain operations. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.'], correctAnswers: ['0'], explanation: "Warehouse is a commercial facility designed for storage of raw materials, inventory management, order picking, and distribution." }],
  ...
  if (title === 'Bonded Warehouse') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Bonded Warehouse?', options: ["Bonded Warehouse is a customs-controlled storage building where imported goods can be stored duty-free until cleared for domestic sale.", 'An illegal practice depending on the specific regional trade compliance laws. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'A tax exemption often evaluated during the final customs clearance phase. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A carrier fine serving as a baseline for cross-border trade agreements. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.'], correctAnswers: ['0'], explanation: "Bonded Warehouse is a customs-controlled storage building where imported goods can be stored duty-free until cleared for domestic sale." }],
  ...
  if (title === 'Last Mile Delivery') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Last Mile Delivery?', options: ["Last Mile Delivery is the final transportation leg moving cleared cargo from regional warehouse to final customer door.", 'An illegal practice to ensure alignment with standard import/export protocols. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'A tax exemption while minimizing potential regulatory delays at the port. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'A carrier fine according to the documented commercial invoice requirements. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.'], correctAnswers: ['0'], explanation: "Last Mile Delivery is the final transportation leg moving cleared cargo from regional warehouse to final customer door." }],
  ...
  if (title === 'Door Delivery') {
    return {
      ...
      practicalTips: ['Consult your logistics agent before finalizing PO terms.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'Which statement accurately describes Door Delivery?', options: ["Door Delivery is an end-to-end shipping service where logistics provider handles pickup at factory door and delivery to importer door.", 'An illegal practice as governed by standard international commercial terms. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'A tax exemption which is a critical factor in global supply chain operations. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'A carrier fine depending on the specific regional trade compliance laws. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.'], correctAnswers: ['0'], explanation: "Door Delivery is an end-to-end shipping service where logistics provider handles pickup at factory door and delivery to importer door." }],
  ...
  if (title === 'Fumigation Certificate') {
    return {
      ...
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Fumigation Certificate?', options: ["Fumigation Certificate is an official pest control document certifying that wooden packaging materials (pallets, crates) have been chemically treated (ISPM-15) to kill timber pests before shipment.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods often evaluated during the final customs clearance phase.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders serving as a baseline for cross-border trade agreements.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones to ensure alignment with standard import/export protocols.'], correctAnswers: ['0'], explanation: "Fumigation Certificate is an official pest control document certifying that wooden packaging materials (pallets, crates) have been chemically treated (ISPM-15) to kill timber pests before shipment." }],
  ...
  if (title === 'Inspection Certificate') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Inspection Certificate?', options: ["Inspection Certificate is a quality, quantity, and technical compliance audit report issued by an independent inspection agency (such as SGS, Intertek, or TÜV) after physically auditing finished goods at the factory.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods while minimizing potential regulatory delays at the port.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders according to the documented commercial invoice requirements.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones as governed by standard international commercial terms.'], correctAnswers: ['0'], explanation: "Inspection Certificate is a quality, quantity, and technical compliance audit report issued by an independent inspection agency (such as SGS, Intertek, or TÜV) after physically auditing finished goods at the factory." }],
  ...
  if (title === 'Air Way Bill') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Air Way Bill?', options: ["Air Way Bill (AWB) is the official non-negotiable transport document issued by an airline for cargo transported by air, serving as a carriage contract and receipt of goods.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods which is a critical factor in global supply chain operations.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders depending on the specific regional trade compliance laws.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones often evaluated during the final customs clearance phase.'], correctAnswers: ['0'], explanation: "Air Way Bill (AWB) is the official non-negotiable transport document issued by an airline for cargo transported by air, serving as a carriage contract and receipt of goods." }],
  ...
  if (title === 'Delivery Order') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Delivery Order?', options: ["Delivery Order (DO) is a release document issued by the shipping line or freight forwarder to the port terminal/CFS authorizing the surrender of cargo to the importer after freight and local charges are settled.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods serving as a baseline for cross-border trade agreements.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders to ensure alignment with standard import/export protocols.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones while minimizing potential regulatory delays at the port.'], correctAnswers: ['0'], explanation: "Delivery Order (DO) is a release document issued by the shipping line or freight forwarder to the port terminal/CFS authorizing the surrender of cargo to the importer after freight and local charges are settled." }],
  ...
  if (title === 'Shipping Bill') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Shipping Bill?', options: ["Shipping Bill is an official export declaration document filed electronically by the exporter with Customs (via ICEGATE) to obtain \"Let Export Order\" (LEO) permission to ship goods out of India according to the documented commercial invoice requirements.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Shipping Bill is an official export declaration document filed electronically by the exporter with Customs (via ICEGATE) to obtain \"Let Export Order\" (LEO) permission to ship goods out of India." }],
  ...
  if (title === 'Bill of Entry') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Bill of Entry?', options: ["Bill of Entry (BOE) is a statutory import declaration document filed by an importer/CHA with Customs (via ICEGATE) detailing imported cargo value, HSN codes, and duty calculations for clearance.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods as governed by standard international commercial terms.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders which is a critical factor in global supply chain operations.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones depending on the specific regional trade compliance laws.'], correctAnswers: ['0'], explanation: "Bill of Entry (BOE) is a statutory import declaration document filed by an importer/CHA with Customs (via ICEGATE) detailing imported cargo value, HSN codes, and duty calculations for clearance." }],
  ...
  if (title === 'Certificate of Origin') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Certificate of Origin?', options: ["Certificate of Origin (COO) is an official document issued by a Chamber of Commerce or government authority certifying the country where the imported product was manufactured.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods often evaluated during the final customs clearance phase.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders serving as a baseline for cross-border trade agreements.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones to ensure alignment with standard import/export protocols.'], correctAnswers: ['0'], explanation: "Certificate of Origin (COO) is an official document issued by a Chamber of Commerce or government authority certifying the country where the imported product was manufactured." }],
  ...
  if (title === 'Insurance Certificate') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Insurance Certificate?', options: ["Insurance Certificate is an official policy document issued by a marine insurance underwriter confirming that cargo is insured against loss, damage, theft, or vessel sinking during transit.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods while minimizing potential regulatory delays at the port.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders according to the documented commercial invoice requirements.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones as governed by standard international commercial terms.'], correctAnswers: ['0'], explanation: "Insurance Certificate is an official policy document issued by a marine insurance underwriter confirming that cargo is insured against loss, damage, theft, or vessel sinking during transit." }],
  ...
  if (title === 'Customs') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Customs?', options: ["Customs is the government border authority enforcing import/export trade laws, inspecting international shipments, and collecting customs duties and taxes.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods which is a critical factor in global supply chain operations.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Customs is the government border authority enforcing import/export trade laws, inspecting international shipments, and collecting customs duties and taxes." }],
  ...
  if (title === 'Customs Clearance') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Customs Clearance?', options: ["Customs Clearance is the official administrative procedure of obtaining permission from customs authorities to import or export cargo across international borders.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods depending on the specific regional trade compliance laws.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones often evaluated during the final customs clearance phase.'], correctAnswers: ['0'], explanation: "Customs Clearance is the official administrative procedure of obtaining permission from customs authorities to import or export cargo across international borders." }],
  ...
  if (title === 'CHA') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is CHA?', options: ["CHA (Customs House Agent) or Customs Broker is a licensed professional authorized by Customs to handle import/export documentation, tariff classification, and cargo clearance for trade clients.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods serving as a baseline for cross-border trade agreements.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders to ensure alignment with standard import/export protocols.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones while minimizing potential regulatory delays at the port.'], correctAnswers: ['0'], explanation: "CHA (Customs House Agent) or Customs Broker is a licensed professional authorized by Customs to handle import/export documentation, tariff classification, and cargo clearance for trade clients." }],
  ...
  if (title === 'HSN Code') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is HSN Code?', options: ["HSN Code (Harmonized System of Nomenclature) is an international 6-to-8 digit standardized numerical code used worldwide to classify traded commodities for customs duty calculation.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods according to the documented commercial invoice requirements.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders as governed by standard international commercial terms.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones which is a critical factor in global supply chain operations.'], correctAnswers: ['0'], explanation: "HSN Code (Harmonized System of Nomenclature) is an international 6-to-8 digit standardized numerical code used worldwide to classify traded commodities for customs duty calculation." }],
  ...
  if (title === 'Ocean Freight') {
    return {
      ...
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Ocean Freight?', options: ["Ocean Freight is the main ocean transport fee charged by shipping lines to transport containerized or bulk cargo across international sea routes.", 'A tax exemption depending on the specific regional trade compliance laws. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'An illegal fee often evaluated during the final customs clearance phase.', 'A vessel penalty serving as a baseline for cross-border trade agreements.'], correctAnswers: ['0'], explanation: "Ocean Freight is the main ocean transport fee charged by shipping lines to transport containerized or bulk cargo across international sea routes." }],
  ...
  if (title === 'Local Charges') {
    return {
      ...
      practicalTips: ['Request itemized rate cards from forwarders.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Local Charges?', options: ["Local Charges are origin and destination port handling fees charged by forwarders and port terminals (such as THC, documentation, and gate fees) outside of main ocean freight.", 'A tax exemption to ensure alignment with standard import/export protocols. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'An illegal fee while minimizing potential regulatory delays at the port.', 'A vessel penalty according to the documented commercial invoice requirements.'], correctAnswers: ['0'], explanation: "Local Charges are origin and destination port handling fees charged by forwarders and port terminals (such as THC, documentation, and gate fees) outside of main ocean freight." }],
  ...
  if (title === 'THC') {
    return {
      ...
      practicalTips: ['Request itemized rate cards from forwarders.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is THC?', options: ["Terminal Handling Charge (THC) is the port fee charged by terminal operators for using port cranes and equipment to load or unload containers between vessel and port yard.", 'A tax exemption as governed by standard international commercial terms. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'An illegal fee which is a critical factor in global supply chain operations.', 'A vessel penalty depending on the specific regional trade compliance laws.'], correctAnswers: ['0'], explanation: "Terminal Handling Charge (THC) is the port fee charged by terminal operators for using port cranes and equipment to load or unload containers between vessel and port yard." }],
  ...
  if (title === 'CFS Charges') {
    return {
      ...
      practicalTips: ['Request itemized rate cards from forwarders.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is CFS Charges?', options: ["CFS Charges are handling, de-stuffing, sorting, and ground storage fees billed by Container Freight Stations for processing LCL cargo shipments.", 'A tax exemption often evaluated during the final customs clearance phase. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'An illegal fee serving as a baseline for cross-border trade agreements.', 'A vessel penalty to ensure alignment with standard import/export protocols.'], correctAnswers: ['0'], explanation: "CFS Charges are handling, de-stuffing, sorting, and ground storage fees billed by Container Freight Stations for processing LCL cargo shipments." }],
  ...
  if (title === 'DO Charges') {
    return {
      ...
      practicalTips: ['Request itemized rate cards from forwarders.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is DO Charges?', options: ["DO Charges are administrative fees billed by shipping lines or forwarders for issuing the electronic Delivery Order (DO) authorizing cargo release.", 'A tax exemption while minimizing potential regulatory delays at the port. This comprehensive documentation framework must be verified and submitted directly to the relevant maritime or port authority long before the transport vessel departs the origin port.', 'An illegal fee according to the documented commercial invoice requirements.', 'A vessel penalty as governed by standard international commercial terms.'], correctAnswers: ['0'], explanation: "DO Charges are administrative fees billed by shipping lines or forwarders for issuing the electronic Delivery Order (DO) authorizing cargo release." }],
  ...
  if (title === 'Detention') {
    return {
      ...
      practicalTips: ['Request itemized rate cards from forwarders.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Detention?', options: ["Detention is a penalty fee charged by shipping lines when an importer holds an empty container outside the port beyond agreed free days (usually 7-14 days).", 'A tax exemption which is a critical factor in global supply chain operations. Maintaining strict adherence to these operational guidelines guarantees seamless cross-border transactions and significantly reduces the probability of unforeseen regulatory penalties.', 'An illegal fee depending on the specific regional trade compliance laws.', 'A vessel penalty often evaluated during the final customs clearance phase.'], correctAnswers: ['0'], explanation: "Detention is a penalty fee charged by shipping lines when an importer holds an empty container outside the port beyond agreed free days (usually 7-14 days)." }],
  ...
  if (title === 'Demurrage') {
    return {
      ...
      practicalTips: ['Request itemized rate cards from forwarders.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Demurrage?', options: ["Demurrage is a daily penalty fee charged by ports or shipping lines when a loaded container stays inside the port terminal beyond free storage days (usually 3-5 days).", 'A tax exemption serving as a baseline for cross-border trade agreements. This standard protocol is strictly monitored by international customs authorities and logistics agencies to prevent global supply chain disruptions across major trading routes.', 'An illegal fee to ensure alignment with standard import/export protocols.', 'A vessel penalty while minimizing potential regulatory delays at the port.'], correctAnswers: ['0'], explanation: "Demurrage is a daily penalty fee charged by ports or shipping lines when a loaded container stays inside the port terminal beyond free storage days (usually 3-5 days)." }],
  ...
  if (title === 'Port Charges') {
    return {
      ...
      practicalTips: ['Request itemized rate cards from forwarders.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Port Charges?', options: ["Port Charges are statutory pilotage, berth hire, anchorage, and port entry fees levied by port trusts on vessels and cargo handling.", 'A tax exemption according to the documented commercial invoice requirements. Such scenarios often require immediate intervention from certified customs brokers and freight forwarders to ensure full compliance with international maritime and aviation laws.', 'An illegal fee as governed by standard international commercial terms.', 'A vessel penalty which is a critical factor in global supply chain operations.'], correctAnswers: ['0'], explanation: "Port Charges are statutory pilotage, berth hire, anchorage, and port entry fees levied by port trusts on vessels and cargo handling." }],
  ...
  if (title === 'Documentation Charges') {
    return {
      ...
      practicalTips: ['Request itemized rate cards from forwarders.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Documentation Charges?', options: ["Documentation Charges are administrative processing fees billed by freight forwarders or shipping lines for creating B/L, HBL, manifest filings, and EDI entries.", 'A tax exemption depending on the specific regional trade compliance laws. Failure to manage this effectively can result in significant financial liabilities, extensive operational downtime, and potential permanent cargo confiscation by border control agencies.', 'An illegal fee often evaluated during the final customs clearance phase.', 'A vessel penalty serving as a baseline for cross-border trade agreements.'], correctAnswers: ['0'], explanation: "Documentation Charges are administrative processing fees billed by freight forwarders or shipping lines for creating B/L, HBL, manifest filings, and EDI entries." }],
  ...
  if (title === 'Quality Control') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Quality Control do?', options: ["Quality Control (QC) refers to the operational inspection checks performed on raw materials, components, and assembly lines during production to identify and fix defects.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods to ensure alignment with standard import/export protocols.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders while minimizing potential regulatory delays at the port.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones according to the documented commercial invoice requirements.'], correctAnswers: ['0'], explanation: "Quality Control (QC) refers to the operational inspection checks performed on raw materials, components, and assembly lines during production to identify and fix defects." }],
  ...
  if (title === 'Quality Assurance') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Quality Assurance do?', options: ["Quality Assurance (QA) is the systematic organizational framework of quality management protocols, ISO standards, and factory operating procedures that prevents product defects from occurring in the first place.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods as governed by standard international commercial terms.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders which is a critical factor in global supply chain operations.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones depending on the specific regional trade compliance laws.'], correctAnswers: ['0'], explanation: "Quality Assurance (QA) is the systematic organizational framework of quality management protocols, ISO standards, and factory operating procedures that prevents product defects from occurring in the first place." }],
  ...
  if (title === 'Pre-Shipment Inspection') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Pre-Shipment Inspection do?', options: ["Pre-Shipment Inspection (PSI) is a comprehensive physical audit performed by an independent third-party agency (like SGS or Intertek) when production is 100% completed and at least 80% packed into master cartons.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods often evaluated during the final customs clearance phase.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders serving as a baseline for cross-border trade agreements.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones to ensure alignment with standard import/export protocols.'], correctAnswers: ['0'], explanation: "Pre-Shipment Inspection (PSI) is a comprehensive physical audit performed by an independent third-party agency (like SGS or Intertek) when production is 100% completed and at least 80% packed into master cartons." }],
  ...
  if (title === 'Random Inspection') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Random Inspection do?', options: ["Random Inspection is an auditing technique where an inspector randomly selects sample cartons from different pallets in the warehouse using statistical AQL (Acceptable Quality Limit) tables to evaluate overall batch quality.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods while minimizing potential regulatory delays at the port.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders according to the documented commercial invoice requirements.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones as governed by standard international commercial terms.'], correctAnswers: ['0'], explanation: "Random Inspection is an auditing technique where an inspector randomly selects sample cartons from different pallets in the warehouse using statistical AQL (Acceptable Quality Limit) tables to evaluate overall batch quality." }],
  ...
  if (title === 'Defect Rate') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Defect Rate do?', options: ["Defect Rate is the percentage of failed or non-conforming items identified within an inspected sample lot during quality control testing.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Defect Rate is the percentage of failed or non-conforming items identified within an inspected sample lot during quality control testing." }],
  ...
  if (title === 'Product Testing') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Product Testing do?', options: ["Product Testing involves sending product samples to accredited laboratories (such as UL, TÜV, or Intertek) to run rigorous electrical safety, chemical toxicity, waterproof, or drop tests.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods which is a critical factor in global supply chain operations.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders depending on the specific regional trade compliance laws.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones often evaluated during the final customs clearance phase.'], correctAnswers: ['0'], explanation: "Product Testing involves sending product samples to accredited laboratories (such as UL, TÜV, or Intertek) to run rigorous electrical safety, chemical toxicity, waterproof, or drop tests." }],
  ...
  if (title === 'Compliance') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Compliance do?', options: ["Compliance is the strict adherence of imported goods to all mandatory health, safety, environmental, labeling, and legal standards established by the destination government.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods serving as a baseline for cross-border trade agreements.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders to ensure alignment with standard import/export protocols.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones while minimizing potential regulatory delays at the port.'], correctAnswers: ['0'], explanation: "Compliance is the strict adherence of imported goods to all mandatory health, safety, environmental, labeling, and legal standards established by the destination government." }],
  ...
  if (title === 'Lead') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Lead mean?', options: ["Lead is a potential business contact or customer inquiry indicating interest in purchasing or importing specific products.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Lead is a potential business contact or customer inquiry indicating interest in purchasing or importing specific products." }],
  ...
  if (title === 'Inquiry') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Inquiry mean?', options: ["Inquiry is a formal written request sent by a buyer to a supplier detailing required product specifications, target quantity, packaging preferences, and delivery terms.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods according to the documented commercial invoice requirements.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders as governed by standard international commercial terms.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones which is a critical factor in global supply chain operations.'], correctAnswers: ['0'], explanation: "Inquiry is a formal written request sent by a buyer to a supplier detailing required product specifications, target quantity, packaging preferences, and delivery terms." }],
  ...
  if (title === 'Quotation') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Quotation mean?', options: ["Quotation (Proforma Offer) is a formal commercial document issued by a supplier detailing unit prices, bulk discounts, MOQ, payment terms, Incoterms, and price validity period.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods depending on the specific regional trade compliance laws.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders often evaluated during the final customs clearance phase.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones serving as a baseline for cross-border trade agreements.'], correctAnswers: ['0'], explanation: "Quotation (Proforma Offer) is a formal commercial document issued by a supplier detailing unit prices, bulk discounts, MOQ, payment terms, Incoterms, and price validity period." }],
  ...
  if (title === 'Purchase Order') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Purchase Order mean?', options: ["Purchase Order (PO) is a legally binding contract issued by a buyer to a supplier confirming product specs, exact order quantity, agreed unit price, payment terms, and delivery deadline.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods to ensure alignment with standard import/export protocols.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders while minimizing potential regulatory delays at the port.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones according to the documented commercial invoice requirements.'], correctAnswers: ['0'], explanation: "Purchase Order (PO) is a legally binding contract issued by a buyer to a supplier confirming product specs, exact order quantity, agreed unit price, payment terms, and delivery deadline." }],
  ...
  if (title === 'Sales Order') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Sales Order mean?', options: ["Sales Order (SO) is an internal sales confirmation document issued by the seller to acknowledge receipt of the buyer's Purchase Order and schedule factory production.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods as governed by standard international commercial terms.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders which is a critical factor in global supply chain operations.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones depending on the specific regional trade compliance laws.'], correctAnswers: ['0'], explanation: "Sales Order (SO) is an internal sales confirmation document issued by the seller to acknowledge receipt of the buyer's Purchase Order and schedule factory production." }],
  ...
  if (title === 'Follow-up') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Follow-up mean?', options: ["Follow-up is the continuous operational tracking of factory production progress, raw material sourcing, and quality checkpoints to ensure on-time delivery.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods often evaluated during the final customs clearance phase.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Follow-up is the continuous operational tracking of factory production progress, raw material sourcing, and quality checkpoints to ensure on-time delivery." }],
  ...
  if (title === 'Order Confirmation') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Order Confirmation mean?', options: ["Order Confirmation is the final signed bilateral agreement between buyer and seller locking product specs, final pricing, deposit payment receipt, and estimated shipping date.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods serving as a baseline for cross-border trade agreements.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders to ensure alignment with standard import/export protocols.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones while minimizing potential regulatory delays at the port.'], correctAnswers: ['0'], explanation: "Order Confirmation is the final signed bilateral agreement between buyer and seller locking product specs, final pricing, deposit payment receipt, and estimated shipping date." }],
  ...
  if (title === 'Production Timeline') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Production Timeline mean?', options: ["Production Timeline is a detailed schedule mapping out every manufacturing phase — raw material procurement, component assembly, testing, quality inspection, and export packing.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods according to the documented commercial invoice requirements.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders as governed by standard international commercial terms.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones which is a critical factor in global supply chain operations.'], correctAnswers: ['0'], explanation: "Production Timeline is a detailed schedule mapping out every manufacturing phase — raw material procurement, component assembly, testing, quality inspection, and export packing." }],
  ...
  if (title === 'Dispatch') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Dispatch mean?', options: ["Dispatch is the official handover of packed export cartons from the factory warehouse to the logistics transporter for carriage to the port.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Dispatch is the official handover of packed export cartons from the factory warehouse to the logistics transporter for carriage to the port." }],
  ...
  if (title === 'Delivery Confirmation') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Delivery Confirmation mean?', options: ["Delivery Confirmation is the final signed receipt issued by the buyer upon physically receiving, inspecting, and unloading the container at their warehouse.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods depending on the specific regional trade compliance laws.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Delivery Confirmation is the final signed receipt issued by the buyer upon physically receiving, inspecting, and unloading the container at their warehouse." }],
  ...
  if (title === 'Cargo Insurance') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Cargo Insurance mean?', options: ["Cargo Insurance is a commercial marine policy protecting buyers and sellers against financial loss if goods are lost, damaged, stolen, or destroyed during sea, air, or road transit.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods often evaluated during the final customs clearance phase.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders serving as a baseline for cross-border trade agreements.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones to ensure alignment with standard import/export protocols.'], correctAnswers: ['0'], explanation: "Cargo Insurance is a commercial marine policy protecting buyers and sellers against financial loss if goods are lost, damaged, stolen, or destroyed during sea, air, or road transit." }],
  ...
  if (title === 'Force Majeure') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Force Majeure mean?', options: ["Force Majeure is a standard legal contract clause exempting both buyer and seller from contractual liability during unavoidable natural disasters, wars, port strikes, or government lockdowns.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods while minimizing potential regulatory delays at the port.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders according to the documented commercial invoice requirements.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones as governed by standard international commercial terms.'], correctAnswers: ['0'], explanation: "Force Majeure is a standard legal contract clause exempting both buyer and seller from contractual liability during unavoidable natural disasters, wars, port strikes, or government lockdowns." }],
  ...
  if (title === 'Delay') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Delay mean?', options: ["Delay refers to unscheduled disruptions in raw material sourcing, factory assembly, or carrier shipping routes that push cargo arrival past agreed delivery dates.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods which is a critical factor in global supply chain operations.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones depending on the specific regional trade compliance laws.'], correctAnswers: ['0'], explanation: "Delay refers to unscheduled disruptions in raw material sourcing, factory assembly, or carrier shipping routes that push cargo arrival past agreed delivery dates." }],
  ...
  if (title === 'Damage Claim') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Damage Claim mean?', options: ["Damage Claim is a formal legal compensation claim filed by an importer against a shipping line, port authority, or insurance underwriter for physical cargo damage occurring during transit.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods often evaluated during the final customs clearance phase.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders serving as a baseline for cross-border trade agreements.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones to ensure alignment with standard import/export protocols.'], correctAnswers: ['0'], explanation: "Damage Claim is a formal legal compensation claim filed by an importer against a shipping line, port authority, or insurance underwriter for physical cargo damage occurring during transit." }],
  ...
  if (title === 'Shortage') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Shortage mean?', options: ["Shortage is a physical discrepancy where the actual number of delivered master cartons or units received at the warehouse is less than declared on the Commercial Invoice and Packing List.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods while minimizing potential regulatory delays at the port.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders according to the documented commercial invoice requirements.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones as governed by standard international commercial terms.'], correctAnswers: ['0'], explanation: "Shortage is a physical discrepancy where the actual number of delivered master cartons or units received at the warehouse is less than declared on the Commercial Invoice and Packing List." }],
  ...
  if (title === 'Misdeclaration') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Misdeclaration mean?', options: ["Misdeclaration is the illegal or erroneous declaration of incorrect product values, HSN tariff codes, cargo weights, or country of origin on customs import documents.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods which is a critical factor in global supply chain operations.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders depending on the specific regional trade compliance laws.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones often evaluated during the final customs clearance phase.'], correctAnswers: ['0'], explanation: "Misdeclaration is the illegal or erroneous declaration of incorrect product values, HSN tariff codes, cargo weights, or country of origin on customs import documents." }],
  ...
  if (title === 'Dispute Resolution') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Dispute Resolution mean?', options: ["Dispute Resolution is the formal contractual arbitration or court litigation procedure used by buyer and seller to settle commercial disagreements over quality defects, delayed shipments, or unpaid invoices.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods serving as a baseline for cross-border trade agreements.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders to ensure alignment with standard import/export protocols.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones while minimizing potential regulatory delays at the port.'], correctAnswers: ['0'], explanation: "Dispute Resolution is the formal contractual arbitration or court litigation procedure used by buyer and seller to settle commercial disagreements over quality defects, delayed shipments, or unpaid invoices." }],
  ...
  if (title === 'Inquiry Form') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Inquiry Form mean?', options: ["Inquiry Form is the internal RBC workflow document used by account managers to record customer product requirements, target landed costs, and quantity specifications.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods according to the documented commercial invoice requirements.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders as governed by standard international commercial terms.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones which is a critical factor in global supply chain operations.'], correctAnswers: ['0'], explanation: "Inquiry Form is the internal RBC workflow document used by account managers to record customer product requirements, target landed costs, and quantity specifications." }],
  ...
  if (title === 'Product Approval') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Product Approval mean?', options: ["Product Approval is RBC's internal technical verification phase where engineering teams evaluate pre-production factory samples for design, durability, and compliance.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods depending on the specific regional trade compliance laws.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders often evaluated during the final customs clearance phase.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones serving as a baseline for cross-border trade agreements.'], correctAnswers: ['0'], explanation: "Product Approval is RBC's internal technical verification phase where engineering teams evaluate pre-production factory samples for design, durability, and compliance." }],
  ...
  if (title === 'Quotation Approval') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Quotation Approval mean?', options: ["Quotation Approval is RBC's internal financial review process where management evaluates supplier landed cost quotes and validates target profit margins.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods to ensure alignment with standard import/export protocols.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Quotation Approval is RBC's internal financial review process where management evaluates supplier landed cost quotes and validates target profit margins." }],
  ...
  if (title === 'Purchase Process') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Purchase Process mean?', options: ["Purchase Process covers RBC's operational workflow for drafting binding Purchase Orders, negotiating payment terms, and remitting 30% advance deposits to factories.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods while minimizing potential regulatory delays at the port.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones according to the documented commercial invoice requirements.'], correctAnswers: ['0'], explanation: "Purchase Process covers RBC's operational workflow for drafting binding Purchase Orders, negotiating payment terms, and remitting 30% advance deposits to factories." }],
  ...
  if (title === 'Payment Process') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Payment Process mean?', options: ["Payment Process is RBC's finance workflow auditing shipping documents (B/L, Commercial Invoice, Packing List, PSI Report) before releasing balance 70% payments.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods as governed by standard international commercial terms.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones which is a critical factor in global supply chain operations.'], correctAnswers: ['0'], explanation: "Payment Process is RBC's finance workflow auditing shipping documents (B/L, Commercial Invoice, Packing List, PSI Report) before releasing balance 70% payments." }],
  ...
  if (title === 'Production Tracking') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Production Tracking mean?', options: ["Production Tracking is RBC's operational monitoring protocol tracking factory raw material dyeing, assembly milestones, and completion percentages weekly.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods depending on the specific regional trade compliance laws.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Production Tracking is RBC's operational monitoring protocol tracking factory raw material dyeing, assembly milestones, and completion percentages weekly." }],
  ...
  if (title === 'Shipment Tracking') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Shipment Tracking mean?', options: ["Shipment Tracking is RBC's logistics monitoring process following vessel location, container transshipment ports, and updated ETD/ETA milestones in real time.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods often evaluated during the final customs clearance phase.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones serving as a baseline for cross-border trade agreements.'], correctAnswers: ['0'], explanation: "Shipment Tracking is RBC's logistics monitoring process following vessel location, container transshipment ports, and updated ETD/ETA milestones in real time." }],
  ...
  if (title === 'Customs Process') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Customs Process mean?', options: ["Customs Process is RBC's clearance workflow coordinating with CHA brokers to file Bill of Entry, pay customs duties (BCD/IGST), and obtain Out-of-Charge release.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods to ensure alignment with standard import/export protocols.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones while minimizing potential regulatory delays at the port.'], correctAnswers: ['0'], explanation: "Customs Process is RBC's clearance workflow coordinating with CHA brokers to file Bill of Entry, pay customs duties (BCD/IGST), and obtain Out-of-Charge release." }],
  ...
  if (title === 'Warehouse Process') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Warehouse Process mean?', options: ["Warehouse Process is RBC's inbound logistics workflow for container de-stuffing, carton physical count tallying, quality damage inspection, and inventory SKU stocking.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods according to the documented commercial invoice requirements.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders as governed by standard international commercial terms.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones which is a critical factor in global supply chain operations.'], correctAnswers: ['0'], explanation: "Warehouse Process is RBC's inbound logistics workflow for container de-stuffing, carton physical count tallying, quality damage inspection, and inventory SKU stocking." }],
  ...
  if (title === 'Customer Delivery Process') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Customer Delivery Process mean?', options: ["Customer Delivery Process is RBC's outbound logistics workflow scheduling local truck transport, issuing GST tax invoices, and delivering goods to client doors.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods depending on the specific regional trade compliance laws.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones often evaluated during the final customs clearance phase.'], correctAnswers: ['0'], explanation: "Customer Delivery Process is RBC's outbound logistics workflow scheduling local truck transport, issuing GST tax invoices, and delivering goods to client doors." }],
  ...
  if (title === 'After Sales Support') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does After Sales Support mean?', options: ["After Sales Support is RBC's customer service framework managing warranty claims, technical usage assistance, spare parts replacement, and repeat import reorders.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods serving as a baseline for cross-border trade agreements.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones to ensure alignment with standard import/export protocols.'], correctAnswers: ['0'], explanation: "After Sales Support is RBC's customer service framework managing warranty claims, technical usage assistance, spare parts replacement, and repeat import reorders." }],
      ...
      quiz: [
        {
          ...
          options: [
            'To calculate customs duty percentage which is a critical factor in global supply chain operations.',
            'To uniquely identify a specific product design across all trade documents.',
            'To determine the shipping route for the cargo depending on the specific regional trade compliance laws.',
            'To set the minimum order quantity for the product often evaluated during the final customs clearance phase.'
          ],
          correctAnswers: ['1'],
...
const getModuleDomainInfo = (rawTitle: string, moduleId: string) => {
  ...
  const topicMap: { [key: string]: { def: string; imp: string; ex: string; tip: string; mistake: string } } = {
    "Air Way Bill": {"def":"An Air Way Bill (AWB) is a non-negotiable transport document issued by an airline or freight forwarder acting as a receipt of goods and contract of carriage for air freight.","imp":"AWB serves as tracking proof, customs entry attachment, and carrier contract for high-speed air shipments, enabling rapid cargo clearance upon airport arrival.","ex":"RBC receives AWB #098-12345678 from Emirates SkyCargo for 500 kg electronic components shipped from Dubai to Mumbai Air Cargo Complex.","tip":"Verify that the 11-digit AWB number and airport IATA codes (e.g., DXB to BOM) match on all invoice and customs declaration forms.","mistake":"Confusing Air Way Bill (non-negotiable document) with ocean Bill of Lading (document of title), expecting physical original AWB to transfer ownership."},
    "Delivery Order": {"def":"A Delivery Order (DO) is an official release document issued by a shipping line or port CFS authority instructing the terminal warehouse to hand over cargo to the importer.","imp":"Without obtaining a Delivery Order after paying local port and terminal charges, truckers cannot gate-out the container from the port or ICD.","ex":"RBC pays ocean line local terminal handling charges ($250) and surrenders original Bill of Lading to receive the official Delivery Order for container release at Mundra.","tip":"Obtain DO electronically via port Community Systems 24 hours prior to vessel arrival to prevent container demurrage at the port.","mistake":"Waiting for cargo arrival before initiating DO processing, causing unnecessary port storage charges while DO fees are being settled."},
    "Shipping Bill": {"def":"A Shipping Bill is a statutory customs document filed electronically on ICEGATE by an exporter to obtain Customs Out of Charge (LEO) and permission to export goods.","imp":"Filing an accurate Shipping Bill is mandatory for export customs clearance, legal shipment dispatch, and claiming export benefit schemes like RoDTEP and GST refund.","ex":"RBC files a Duty Free Shipping Bill on ICEGATE for 2,000 cotton garments exported to Europe, receiving LEO permission from customs within 4 hours.","tip":"Ensure product description, FOB value, HSN code, and DBK/RoDTEP scheme code are declared accurately on the Shipping Bill.","mistake":"Mismatch in exporter IEC number or bank AD code on Shipping Bill, blocking automated GST duty refund credits."},
    "Bill of Entry": {"def":"A Bill of Entry (BOE) is a statutory customs declaration document filed by an importer on ICEGATE to declare imported cargo details, assessable value, and customs duties.","imp":"BOE is the primary document required for customs assessment, duty payment (BCD, SWS, IGST), physical cargo inspection, and final Out of Charge (OOC) release.","ex":"RBC files an advance Bill of Entry for $15,000 machinery import. Customs assesses ₹1,80,000 duty, which RBC pays via e-payment to get container cleared.","tip":"File advance Bill of Entry at least 24 hours before vessel arrival at destination port to avoid late filing fines.","mistake":"Misdeclaring HSN tariff classification or invoice value on Bill of Entry, triggering manual customs audit and penalty proceedings."},
    "Certificate of Origin": {"def":"A Certificate of Origin (COO) is an official document certified by a Chamber of Commerce or government authority stating the country where goods were manufactured.","imp":"COO is essential for verifying product origin, meeting destination import regulations, and claiming preferential duty discounts under Free Trade Agreements (FTA/CEPA).","ex":"RBC imports spices from Vietnam accompanied by an ASEAN-India FTA Certificate of Origin (Form AI), reducing customs duty from 30% down to 5%.","tip":"Check that COO exporter name, product description, and invoice number match the Commercial Invoice line by line.","mistake":"Failing to submit a valid preferential Certificate of Origin prior to customs assessment, forfeiting duty concessions."},
    "Insurance Certificate": {"def":"An Insurance Certificate is a legal marine insurance document issued by an underwriter confirming cargo coverage against transit risk, damage, loss, or piracy.","imp":"Provides financial protection against catastrophic ocean losses (General Average, vessel sinking, container damage) during sea or air transit.","ex":"RBC purchases ICC(A) All Risk marine insurance for $50,000 cargo. The Insurance Certificate is attached to trade documents for CIF compliance.","tip":"Ensure marine policy covers 110% of CIF value (Invoice + Freight + 10% expected profit) per standard trade norms.","mistake":"Buying restrictive ICC(C) policy for fragile goods, which excludes basic transit damage and rain water leakage coverage."},
    "Fumigation Certificate": {"def":"A Fumigation Certificate is a phytosanitary document issued by a licensed pest control agency certifying wood packaging materials have been treated with Methyl Bromide.","imp":"Mandatory under ISPM-15 international standards to prevent wood-boring pests from spreading into destination country ecosystems.","ex":"RBC imports machinery on wooden pallets stamped with ISPM-15 seal and accompanied by a certified Fumigation Certificate.","tip":"Verify wooden pallets have visible ISPM-15 IPPC stamps before loading cargo at the overseas supplier factory.","mistake":"Shipping un-fumigated raw wooden pallets, leading to immediate cargo quarantine, destruction, or re-export at importer expense."},
    "Inspection Certificate": {"def":"An Inspection Certificate is a quality assurance report issued by an independent inspection agency (e.g. SGS, Intertek, TUV) verifying product quality before shipment.","imp":"Confirms goods meet ordered specifications, quantity, and safety standards before buyer releases final balance payment to factory.","ex":"SGS conducts Pre-Shipment Inspection (PSI) at Ningbo factory, inspecting 125 master cartons and issuing a clean Inspection Certificate to RBC.","tip":"Define AQL (Acceptable Quality Limit) level 2.5 standards in the inspection contract before factory production begins.","mistake":"Releasing full supplier payment before receiving a verified clean Pre-Shipment Inspection Certificate."},
    "CBM": {"def":"CBM stands for Cubic Meter (m³) — the standard unit of volume metric used in logistics to measure container space and ocean freight billing.","imp":"CBM calculation determines whether cargo is billed based on volume or scale weight, optimizing container loading capacity.","ex":"RBC calculates master carton volume (0.6m × 0.4m × 0.5m = 0.12 CBM). 100 cartons total 12 CBM, fitting easily inside a 20FT container.","tip":"Calculate CBM using outer master carton dimensions (Length × Width × Height in meters) including pallet height.","mistake":"Using inner product box dimensions instead of outer master carton measurements, resulting in underestimating required container space."},
    "Gross Weight": {"def":"Gross Weight is the total combined weight of the product, inner packaging, master cartons, protective foam, and shipping pallets.","imp":"Gross Weight is critical for container weight safety limits, vessel loading balance, freight cost calculation, and SOLAS VGM compliance.","ex":"A shipment has 500 kg net product weight, 50 kg carton packaging, and 50 kg wooden pallets, giving a total Gross Weight of 600 kg.","tip":"Weigh master cartons on calibrated digital scales at the factory before generating Packing List and VGM certificates.","mistake":"Declaring only net product weight on transport documents instead of full Gross Weight, incurring port scale discrepancy fines."},
    "Net Weight": {"def":"Net Weight is the weight of the actual physical product alone, excluding master cartons, pallets, and outer packaging materials.","imp":"Customs duties for certain commodities (like foodstuffs, metals, chemicals) are assessed directly on Net Weight basis.","ex":"RBC imports 1,000 kg of copper wire Net Weight (Gross Weight 1,080 kg including drums). Duty is assessed on 1,000 kg Net Weight.","tip":"Ensure Net Weight is clearly stated alongside Gross Weight on both Commercial Invoice and Packing List.","mistake":"Confusing Net Weight with Tare Weight (empty container weight) or Gross Weight on customs documentation."},
    "Volume Weight": {"def":"Volume Weight (Volumetric Weight or Dimensional Weight) is a billing formula (Length × Width × Height in cm ÷ 5000 or 6000) used by air freight and express couriers.","imp":"Couriers charge whichever is higher between actual scale weight and Volume Weight. Light bulky items are billed based on Volume Weight.","ex":"RBC ships 10 kg of lightweight foam cushions. Scale weight is 10 kg, but Volume Weight is 35 kg. Courier bills RBC for 35 kg.","tip":"Compress soft or hollow products into vacuum packaging to reduce Volume Weight for air freight shipments.","mistake":"Shipping uncompressed bulky lightweight items via air freight without calculating Volume Weight beforehand."},
    "Carton Size": {"def":"Carton Size refers to the outer length, width, and height dimensions of a master shipping box used for international transport.","imp":"Standardizing Carton Size optimizes container space utilization, pallet stacking strength, and warehouse rack storage.","ex":"RBC specifies Master Carton Size 60 cm × 40 cm × 40 cm to ensure 10 cartons fit perfectly per pallet layer without overhang.","tip":"Select 5-ply double-walled corrugated cartons for items weighing over 15 kg to prevent box collapse during stacking.","mistake":"Using oversized master cartons with empty space inside, causing boxes to crush when stacked inside sea containers."},
    "Master Carton": {"def":"A Master Carton is the durable outer shipping box containing multiple individual retail packaged units for export transport.","imp":"Protects inner retail goods from moisture, impact, and theft during ocean container transit and handling.","ex":"Each RBC Master Carton contains 24 retail boxes of LED bulbs, labeled with shipping marks, gross weight, and destination details.","tip":"Print clear shipping marks (Consignee, Box #, Made in India/China) on at least 2 sides of every Master Carton.","mistake":"Using weak single-wall master cartons for heavy goods, leading to box bursting during port handling."},
    "Pallet": {"def":"A Pallet is a flat wooden or plastic portable platform used to stack, consolidate, and move master cartons using forklifts.","imp":"Palletization speeds up container loading/unloading, prevents manual handling damage, and meets automated warehouse receiving standards.","ex":"RBC packs 40 master cartons per pallet, securing them with plastic shrink wrap and corner edge protectors for container stuffing.","tip":"Use ISPM-15 heat-treated wooden pallets or plastic pallets for international shipments to pass customs phytosanitary rules.","mistake":"Allowing master cartons to overhang pallet edges, reducing stack strength by 30% and causing box crushing."},
    "Loading Capacity": {"def":"Loading Capacity is the maximum weight and volume payload limit a container or truck can safely carry under maritime and road transport laws.","imp":"Exceeding container Loading Capacity causes port gate rejection, heavy highway overload penalties, and container floor collapse risks.","ex":"A 20FT container has a max Loading Capacity of 28,000 kg weight and 33 CBM volume. RBC loads 24,000 kg to stay safely within limits.","tip":"Verify road weight limit regulations in destination country (e.g., US road weight limits are lower than port container limits).","mistake":"Loading heavy cargo up to container max payload without checking destination highway truck weight restrictions."},
    "FCL": {"def":"FCL stands for Full Container Load — a shipping mode where an entire ocean container is dedicated exclusively to one importer shipment.","imp":"FCL offers faster transit times, lower risk of cargo damage/theft, and cheaper freight per unit compared to shared LCL shipments.","ex":"RBC books a 40HQ FCL container for 2,200 cartons of footwear from Ningbo directly to Mundra port for exclusive company use.","tip":"Choose FCL whenever shipment volume exceeds 15 CBM, as FCL freight becomes more economical than LCL.","mistake":"Shipping 25 CBM cargo as LCL instead of FCL, incurring higher total CFS handling and origin fees."},
    "LCL": {"def":"LCL stands for Less than Container Load — a shipping mode where multiple small shipments from different importers share one ocean container.","imp":"Allows small and medium businesses to import goods without waiting to fill an entire 20FT container.","ex":"RBC imports 5 CBM of samples sharing a container with 4 other companies from Shanghai to Nhava Sheva.","tip":"Calculate total CFS destination handling charges when comparing LCL vs FCL freight costs.","mistake":"Ignoring destination CFS de-consolidation and terminal handling surcharges on LCL shipments."},
    "20FT Container": {"def":"A 20FT Container (20' Standard Dry Van) is a standard ocean shipping container measuring 20ft long × 8ft wide × 8.5ft high (usable volume ~33 CBM, max payload ~28 tons).","imp":"Ideal for heavy dense cargo like metals, stone, tiles, machinery, and liquids where weight limits are reached before volume is full.","ex":"RBC ships 24 tons of ceramic floor tiles inside a 20FT Container, utilizing maximum weight capacity efficiently.","tip":"Distribute heavy cargo weight evenly across the container floor to pass port crane lifting balance checks.","mistake":"Loading lightweight bulky goods into a 20FT container instead of a 40HQ container, wasting freight space."},
    "40FT Container": {"def":"A 40FT Container (40' Standard Dry Van) is a standard ocean container measuring 40ft long × 8ft wide × 8.5ft high (usable volume ~67 CBM, max payload ~26 tons).","imp":"Designed for voluminous general cargo, providing double the volume space of a 20FT container at only 30-40% higher freight cost.","ex":"RBC ships 1,200 cartons of plastic houseware products inside a 40FT Container from Ningbo to Chennai.","tip":"Compare 40FT vs 40HQ rates — 40HQ offers 12% more volume for almost identical freight cost.","mistake":"Overloading a 40FT container with heavy dense items, exceeding road axle weight restrictions."},
    "40HQ Container": {"def":"A 40HQ Container (40' High Cube) is an extra-height ocean container measuring 40ft long × 8ft wide × 9.5ft high (usable volume ~76 CBM, 1ft taller than standard 40FT).","imp":"Most popular container type for light voluminous goods (textiles, electronics, furniture, toys), maximizing CBM capacity.","ex":"RBC imports 72 CBM of office chairs in a 40HQ Container, taking full advantage of the extra 1-foot interior ceiling height.","tip":"Verify warehouse loading dock ceiling clearance for 9.5ft tall High Cube containers before delivery.","mistake":"Booking standard 40FT instead of 40HQ for voluminous goods, leaving 9 CBM of potential cargo capacity unused."},
    "EXW": {"def":"EXW (Ex Works) is an Incoterm where seller makes goods available at their factory. Buyer handles ALL transport, export customs, freight, and import clearance.","imp":"Maximum responsibility and cost for buyer; minimum obligation for seller. Buyer controls entire shipping logistics chain.","ex":"RBC buys goods EXW Shanghai Factory. RBC appoints forwarder to pick up goods at factory, clear China export customs, and ship to India.","tip":"Only use EXW if you have a reliable local freight forwarder in the seller's country to handle factory pickup and export customs.","mistake":"Choosing EXW without checking if supplier has export license to clear origin customs documentation."},
    "FOB": {"def":"FOB (Free on Board) is an Incoterm where seller clears export customs and loads cargo onto vessel at POL. Risk transfers to buyer once cargo is on board.","imp":"Most popular Incoterm for sea freight. Buyer controls ocean freight rates and selects their preferred shipping line and forwarder.","ex":"RBC buys goods FOB Shanghai. Supplier pays local China inland freight and export customs. RBC pays ocean freight and Indian import costs.","tip":"Specify exact named port of loading (e.g. FOB Shanghai Port) in purchase contracts.","mistake":"Assuming seller pays ocean freight under FOB terms — seller only pays costs up to vessel loading at origin port."},
    "CIF": {"def":"CIF (Cost, Insurance & Freight) is an Incoterm where seller pays ocean freight and marine insurance to destination port (POD). Risk transfers upon vessel loading.","imp":"Convenient for importers as seller arranges ocean shipping and insurance, but buyer must handle destination port clearance and customs duty.","ex":"RBC buys goods CIF Mundra. Supplier pays sea freight and marine insurance to Mundra port. RBC pays Indian customs duty and local port charges.","tip":"Request seller to provide copy of marine insurance policy (ICC-A) confirming coverage up to destination port.","mistake":"Assuming CIF includes destination port local handling charges (THC) and customs duty — CIF ends at vessel discharge."},
    "DDP": {"def":"DDP (Delivered Duty Paid) is an Incoterm where seller handles EVERYTHING — freight, insurance, destination customs clearance, and duty taxes — delivering goods to buyer doorstep.","imp":"Maximum obligation for seller; minimum effort for buyer. Importer receives goods as a domestic delivery without customs hassle.","ex":"RBC buys 500 units DDP Delhi Warehouse. Overseas seller pays freight, clears Indian customs, pays GST/BCD duty, and delivers to RBC door.","tip":"Verify seller is legally registered to pay local import customs duty and GST in your destination country under DDP.","mistake":"Using DDP when seller cannot obtain local GST tax credit receipts for duty paid, losing import tax setoff benefits."},
    "Customs": {"def":"Customs is the statutory government border authority responsible for enforcing trade laws, collecting import duties, and regulating cargo entry.","imp":"Customs compliance ensures lawful cargo entry, preventing shipment confiscation, fines, and legal prosecution.","ex":"Indian Customs audits RBC's import shipment at Mundra port, checking HSN code 8539 and assessing applicable duty rates.","tip":"Maintain audit trail of all invoices, specs, and payment receipts for 5 years per customs rules.","mistake":"Attempting to clear cargo without mandatory government regulatory approvals (e.g. BIS, FSSAI, CDSCO)."},
    "Customs Duty": {"def":"Customs Duty is the indirect tax levied by government customs authorities on imported goods entering the country.","imp":"Customs Duty is a major component of total Landed Cost, directly influencing final domestic product selling prices.","ex":"RBC imports $10,000 goods. Customs assesses 10% BCD ($1,000) + 10% SWS ($100) + 18% IGST ($2,000), total duty = $3,100.","tip":"Check if your product qualifies for duty exemption under Free Trade Agreements or export incentive schemes.","mistake":"Calculating profit margins based on FOB product price alone while ignoring 25-30% customs duty overheads."},
