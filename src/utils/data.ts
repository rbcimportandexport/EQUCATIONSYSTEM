...
const getHighFidelityContent = (title: string, lessonId: string): LessonContent | null => {
  ...
  if (title === 'Fumigation Certificate') {
    return {
      ...
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Fumigation Certificate?', options: ["Fumigation Certificate is an official pest control document certifying that wooden packaging materials (pallets, crates) have been chemically treated (ISPM-15) to kill timber pests before shipment.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Fumigation Certificate is an official pest control document certifying that wooden packaging materials (pallets, crates) have been chemically treated (ISPM-15) to kill timber pests before shipment." }],
  ...
  if (title === 'Inspection Certificate') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Inspection Certificate?', options: ["Inspection Certificate is a quality, quantity, and technical compliance audit report issued by an independent inspection agency (such as SGS, Intertek, or TÜV) after physically auditing finished goods at the factory.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Inspection Certificate is a quality, quantity, and technical compliance audit report issued by an independent inspection agency (such as SGS, Intertek, or TÜV) after physically auditing finished goods at the factory." }],
  ...
  if (title === 'Air Way Bill') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Air Way Bill?', options: ["Air Way Bill (AWB) is the official non-negotiable transport document issued by an airline for cargo transported by air, serving as a carriage contract and receipt of goods.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Air Way Bill (AWB) is the official non-negotiable transport document issued by an airline for cargo transported by air, serving as a carriage contract and receipt of goods." }],
  ...
  if (title === 'Delivery Order') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Delivery Order?', options: ["Delivery Order (DO) is a release document issued by the shipping line or freight forwarder to the port terminal/CFS authorizing the surrender of cargo to the importer after freight and local charges are settled.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Delivery Order (DO) is a release document issued by the shipping line or freight forwarder to the port terminal/CFS authorizing the surrender of cargo to the importer after freight and local charges are settled." }],
  ...
  if (title === 'Shipping Bill') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Shipping Bill?', options: ["Shipping Bill is an official export declaration document filed electronically by the exporter with Customs (via ICEGATE) to obtain \"Let Export Order\" (LEO) permission to ship goods out of India.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Shipping Bill is an official export declaration document filed electronically by the exporter with Customs (via ICEGATE) to obtain \"Let Export Order\" (LEO) permission to ship goods out of India." }],
  ...
  if (title === 'Bill of Entry') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Bill of Entry?', options: ["Bill of Entry (BOE) is a statutory import declaration document filed by an importer/CHA with Customs (via ICEGATE) detailing imported cargo value, HSN codes, and duty calculations for clearance.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Bill of Entry (BOE) is a statutory import declaration document filed by an importer/CHA with Customs (via ICEGATE) detailing imported cargo value, HSN codes, and duty calculations for clearance." }],
  ...
  if (title === 'Certificate of Origin') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Certificate of Origin?', options: ["Certificate of Origin (COO) is an official document issued by a Chamber of Commerce or government authority certifying the country where the imported product was manufactured.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Certificate of Origin (COO) is an official document issued by a Chamber of Commerce or government authority certifying the country where the imported product was manufactured." }],
  ...
  if (title === 'Insurance Certificate') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Insurance Certificate?', options: ["Insurance Certificate is an official policy document issued by a marine insurance underwriter confirming that cargo is insured against loss, damage, theft, or vessel sinking during transit.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Insurance Certificate is an official policy document issued by a marine insurance underwriter confirming that cargo is insured against loss, damage, theft, or vessel sinking during transit." }],
  ...
  if (title === 'Customs Clearance') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is Customs Clearance?', options: ["Customs Clearance is the official administrative procedure of obtaining permission from customs authorities to import or export cargo across international borders.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Customs Clearance is the official administrative procedure of obtaining permission from customs authorities to import or export cargo across international borders." }],
  ...
  if (title === 'CHA') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is CHA?', options: ["CHA (Customs House Agent) or Customs Broker is a licensed professional authorized by Customs to handle import/export documentation, tariff classification, and cargo clearance for trade clients.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "CHA (Customs House Agent) or Customs Broker is a licensed professional authorized by Customs to handle import/export documentation, tariff classification, and cargo clearance for trade clients." }],
  ...
  if (title === 'HSN Code') {
    return {
      ...
      practicalTips: ['Always double-check HSN codes and values.'],
      summary: "Key Takeaways: This lesson covers the core rules, documentation steps, cost parameters, and risk boundaries for this topic.",
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What is HSN Code?', options: ["HSN Code (Harmonized System of Nomenclature) is an international 6-to-8 digit standardized numerical code used worldwide to classify traded commodities for customs duty calculation.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "HSN Code (Harmonized System of Nomenclature) is an international 6-to-8 digit standardized numerical code used worldwide to classify traded commodities for customs duty calculation." }],
  ...
  if (title === 'Quality Control') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Quality Control do?', options: ["Quality Control (QC) refers to the operational inspection checks performed on raw materials, components, and assembly lines during production to identify and fix defects.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Quality Control (QC) refers to the operational inspection checks performed on raw materials, components, and assembly lines during production to identify and fix defects." }],
  ...
  if (title === 'Quality Assurance') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Quality Assurance do?', options: ["Quality Assurance (QA) is the systematic organizational framework of quality management protocols, ISO standards, and factory operating procedures that prevents product defects from occurring in the first place.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Quality Assurance (QA) is the systematic organizational framework of quality management protocols, ISO standards, and factory operating procedures that prevents product defects from occurring in the first place." }],
  ...
  if (title === 'Pre-Shipment Inspection') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Pre-Shipment Inspection do?', options: ["Pre-Shipment Inspection (PSI) is a comprehensive physical audit performed by an independent third-party agency (like SGS or Intertek) when production is 100% completed and at least 80% packed into master cartons.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Pre-Shipment Inspection (PSI) is a comprehensive physical audit performed by an independent third-party agency (like SGS or Intertek) when production is 100% completed and at least 80% packed into master cartons." }],
  ...
  if (title === 'Random Inspection') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Random Inspection do?', options: ["Random Inspection is an auditing technique where an inspector randomly selects sample cartons from different pallets in the warehouse using statistical AQL (Acceptable Quality Limit) tables to evaluate overall batch quality.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Random Inspection is an auditing technique where an inspector randomly selects sample cartons from different pallets in the warehouse using statistical AQL (Acceptable Quality Limit) tables to evaluate overall batch quality." }],
  ...
  if (title === 'Product Testing') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Product Testing do?', options: ["Product Testing involves sending product samples to accredited laboratories (such as UL, TÜV, or Intertek) to run rigorous electrical safety, chemical toxicity, waterproof, or drop tests.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Product Testing involves sending product samples to accredited laboratories (such as UL, TÜV, or Intertek) to run rigorous electrical safety, chemical toxicity, waterproof, or drop tests." }],
  ...
  if (title === 'Compliance') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Compliance do?', options: ["Compliance is the strict adherence of imported goods to all mandatory health, safety, environmental, labeling, and legal standards established by the destination government.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Compliance is the strict adherence of imported goods to all mandatory health, safety, environmental, labeling, and legal standards established by the destination government." }],
  ...
  if (title === 'Inquiry') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Inquiry mean?', options: ["Inquiry is a formal written request sent by a buyer to a supplier detailing required product specifications, target quantity, packaging preferences, and delivery terms.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Inquiry is a formal written request sent by a buyer to a supplier detailing required product specifications, target quantity, packaging preferences, and delivery terms." }],
  ...
  if (title === 'Quotation') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Quotation mean?', options: ["Quotation (Proforma Offer) is a formal commercial document issued by a supplier detailing unit prices, bulk discounts, MOQ, payment terms, Incoterms, and price validity period.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Quotation (Proforma Offer) is a formal commercial document issued by a supplier detailing unit prices, bulk discounts, MOQ, payment terms, Incoterms, and price validity period." }],
  ...
  if (title === 'Purchase Order') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Purchase Order mean?', options: ["Purchase Order (PO) is a legally binding contract issued by a buyer to a supplier confirming product specs, exact order quantity, agreed unit price, payment terms, and delivery deadline.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Purchase Order (PO) is a legally binding contract issued by a buyer to a supplier confirming product specs, exact order quantity, agreed unit price, payment terms, and delivery deadline." }],
  ...
  if (title === 'Sales Order') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Sales Order mean?', options: ["Sales Order (SO) is an internal sales confirmation document issued by the seller to acknowledge receipt of the buyer's Purchase Order and schedule factory production.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Sales Order (SO) is an internal sales confirmation document issued by the seller to acknowledge receipt of the buyer's Purchase Order and schedule factory production." }],
  ...
  if (title === 'Follow-up') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Follow-up mean?', options: ["Follow-up is the continuous operational tracking of factory production progress, raw material sourcing, and quality checkpoints to ensure on-time delivery.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Follow-up is the continuous operational tracking of factory production progress, raw material sourcing, and quality checkpoints to ensure on-time delivery." }],
  ...
  if (title === 'Order Confirmation') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Order Confirmation mean?', options: ["Order Confirmation is the final signed bilateral agreement between buyer and seller locking product specs, final pricing, deposit payment receipt, and estimated shipping date.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Order Confirmation is the final signed bilateral agreement between buyer and seller locking product specs, final pricing, deposit payment receipt, and estimated shipping date." }],
  ...
  if (title === 'Production Timeline') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Production Timeline mean?', options: ["Production Timeline is a detailed schedule mapping out every manufacturing phase — raw material procurement, component assembly, testing, quality inspection, and export packing.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Production Timeline is a detailed schedule mapping out every manufacturing phase — raw material procurement, component assembly, testing, quality inspection, and export packing." }],
  ...
  if (title === 'Delivery Confirmation') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Delivery Confirmation mean?', options: ["Delivery Confirmation is the final signed receipt issued by the buyer upon physically receiving, inspecting, and unloading the container at their warehouse.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Delivery Confirmation is the final signed receipt issued by the buyer upon physically receiving, inspecting, and unloading the container at their warehouse." }],
  ...
  if (title === 'Cargo Insurance') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Cargo Insurance mean?', options: ["Cargo Insurance is a commercial marine policy protecting buyers and sellers against financial loss if goods are lost, damaged, stolen, or destroyed during sea, air, or road transit.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Cargo Insurance is a commercial marine policy protecting buyers and sellers against financial loss if goods are lost, damaged, stolen, or destroyed during sea, air, or road transit." }],
  ...
  if (title === 'Force Majeure') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Force Majeure mean?', options: ["Force Majeure is a standard legal contract clause exempting both buyer and seller from contractual liability during unavoidable natural disasters, wars, port strikes, or government lockdowns.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Force Majeure is a standard legal contract clause exempting both buyer and seller from contractual liability during unavoidable natural disasters, wars, port strikes, or government lockdowns." }],
  ...
  if (title === 'Delay') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Delay mean?', options: ["Delay refers to unscheduled disruptions in raw material sourcing, factory assembly, or carrier shipping routes that push cargo arrival past agreed delivery dates.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Delay refers to unscheduled disruptions in raw material sourcing, factory assembly, or carrier shipping routes that push cargo arrival past agreed delivery dates." }],
  ...
  if (title === 'Damage Claim') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Damage Claim mean?', options: ["Damage Claim is a formal legal compensation claim filed by an importer against a shipping line, port authority, or insurance underwriter for physical cargo damage occurring during transit.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Damage Claim is a formal legal compensation claim filed by an importer against a shipping line, port authority, or insurance underwriter for physical cargo damage occurring during transit." }],
  ...
  if (title === 'Shortage') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Shortage mean?', options: ["Shortage is a physical discrepancy where the actual number of delivered master cartons or units received at the warehouse is less than declared on the Commercial Invoice and Packing List.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Shortage is a physical discrepancy where the actual number of delivered master cartons or units received at the warehouse is less than declared on the Commercial Invoice and Packing List." }],
  ...
  if (title === 'Dispute Resolution') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Dispute Resolution mean?', options: ["Dispute Resolution is the formal contractual arbitration or court litigation procedure used by buyer and seller to settle commercial disagreements over quality defects, delayed shipments, or unpaid invoices.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Dispute Resolution is the formal contractual arbitration or court litigation procedure used by buyer and seller to settle commercial disagreements over quality defects, delayed shipments, or unpaid invoices." }],
  ...
  if (title === 'Inquiry Form') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Inquiry Form mean?', options: ["Inquiry Form is the internal RBC workflow document used by account managers to record customer product requirements, target landed costs, and quantity specifications.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Inquiry Form is the internal RBC workflow document used by account managers to record customer product requirements, target landed costs, and quantity specifications." }],
  ...
  if (title === 'Product Approval') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Product Approval mean?', options: ["Product Approval is RBC's internal technical verification phase where engineering teams evaluate pre-production factory samples for design, durability, and compliance.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Product Approval is RBC's internal technical verification phase where engineering teams evaluate pre-production factory samples for design, durability, and compliance." }],
  ...
  if (title === 'Quotation Approval') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Quotation Approval mean?', options: ["Quotation Approval is RBC's internal financial review process where management evaluates supplier landed cost quotes and validates target profit margins.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Quotation Approval is RBC's internal financial review process where management evaluates supplier landed cost quotes and validates target profit margins." }],
  ...
  if (title === 'Purchase Process') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Purchase Process mean?', options: ["Purchase Process covers RBC's operational workflow for drafting binding Purchase Orders, negotiating payment terms, and remitting 30% advance deposits to factories.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Purchase Process covers RBC's operational workflow for drafting binding Purchase Orders, negotiating payment terms, and remitting 30% advance deposits to factories." }],
  ...
  if (title === 'Payment Process') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Payment Process mean?', options: ["Payment Process is RBC's finance workflow auditing shipping documents (B/L, Commercial Invoice, Packing List, PSI Report) before releasing balance 70% payments.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Payment Process is RBC's finance workflow auditing shipping documents (B/L, Commercial Invoice, Packing List, PSI Report) before releasing balance 70% payments." }],
  ...
  if (title === 'Shipment Tracking') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Shipment Tracking mean?', options: ["Shipment Tracking is RBC's logistics monitoring process following vessel location, container transshipment ports, and updated ETD/ETA milestones in real time.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Shipment Tracking is RBC's logistics monitoring process following vessel location, container transshipment ports, and updated ETD/ETA milestones in real time." }],
  ...
  if (title === 'Customs Process') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Customs Process mean?', options: ["Customs Process is RBC's clearance workflow coordinating with CHA brokers to file Bill of Entry, pay customs duties (BCD/IGST), and obtain Out-of-Charge release.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Customs Process is RBC's clearance workflow coordinating with CHA brokers to file Bill of Entry, pay customs duties (BCD/IGST), and obtain Out-of-Charge release." }],
  ...
  if (title === 'Warehouse Process') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does Warehouse Process mean?', options: ["Warehouse Process is RBC's inbound logistics workflow for container de-stuffing, carton physical count tallying, quality damage inspection, and inventory SKU stocking.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "Warehouse Process is RBC's inbound logistics workflow for container de-stuffing, carton physical count tallying, quality damage inspection, and inventory SKU stocking." }],
  ...
  if (title === 'After Sales Support') {
    return {
      ...
      quiz: [{ id: `${lessonId}-q1`, type: 'mcq', question: 'What does After Sales Support mean?', options: ["After Sales Support is RBC's customer service framework managing warranty claims, technical usage assistance, spare parts replacement, and repeat import reorders.", 'A mandatory tax penalty imposed by customs authorities during the clearance process for imported goods.', 'An illegal trade practice involving the unauthorized distribution of restricted goods across international borders.', 'A designated shipping carrier responsible for transporting commercial goods between international trade zones.'], correctAnswers: ['0'], explanation: "After Sales Support is RBC's customer service framework managing warranty claims, technical usage assistance, spare parts replacement, and repeat import reorders." }],
