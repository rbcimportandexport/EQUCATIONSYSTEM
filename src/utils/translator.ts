...
export const moduleDescriptionTranslations: {
  ...
  hi: {
    ...
    "Understand port operations, ICD dry ports, CFS warehouses, and door delivery.": "पोर्ट ऑपरेशन्स, ICD ड्राय पोर्ट्स, CFS वेअरहाऊस आणि डोअर डिलिव्हरी प्रक्रिया समजून घ्या.",
    "Master commercial invoices, packing lists, Bill of Lading, and certificates.": "कमर्शियल इनव्हॉइस, पैकिंग लिस्ट, बिल ऑफ लेडिंग आणि सर्टिफिकेट्स आत्मसात करा.",
    "Learn customs clearance, HSN codes, BCD/IGST duty calculation, and compliance.": "कस्टम्स क्लिअरन्स, HSN कोड, BCD/IGST ड्युटी गणना आणि नियम शिका.",
    "Understand advance payment, LC letters of credit, SWIFT transfers, and banking.": "ॲडव्हान्स पेमेंट, लेटर ऑफ क्रेडिट (LC), SWIFT ट्रान्सफर आणि बँकिंग प्रक्रिया समजून घ्या.",
    "Analyze ocean freight rates, THC terminal handling, demurrage, and port charges.": "दरियाई फ्रेट दर, THC टर्मिनल हँडलिंग, डेमरेज आणि पोर्ट शुल्कांचे विश्लेषण करा.",
    "Learn quality control, pre-shipment inspections, AQL standards, and testing.": "क्वालिटी कंट्रोल, प्री-शिपमेंट इन्स्पेक्शन, AQL मानके आणि चाचण्यांबद्दल शिका.",
    "Understand purchase order execution, quotation approvals, and order tracking.": "पर्चेस ऑर्डर अंमलबजावणी, कोटेशन मंजुरी आणि ऑर्डर ट्रॅकिंग प्रक्रिया समजून घ्या.",
    "Learn cargo insurance, force majeure, damage claims, and dispute resolution.": "कार्गो विमा, फोर्स मेझ्युअर, नुकसानीचे दावे आणि विवाद निवारणाबद्दल शिका.",
    "Master RBC Import & Export end-to-end SOPs, workflows, and internal processes.": "RBC आयात आणि निर्यातीचे संपूर्ण SOPs, वर्कफ्लो आणि अंतर्गत प्रक्रियांवर प्रभुत्व मिळवा."
  },
  gu: {
...
const EXPLICIT_HI_MAP: Record<string, string> = {
  ...
  "Using FOB for air shipments. Air shipping lines do not have a ": "हवाई माल ढुलाई (Air Cargo) के लिए FOB शर्तों का उपयोग करना। एयरलाइंस के पास जहाजी रेल (Ship's Rail) नहीं होती, जिससे बीमा देयता में भ्रम उत्पन्न होता है।",
  "Failing to verify when the local port handling charges (THC) at origin are paid by the seller, resulting in unexpected vendor disputes.": "उत्पत्ति स्थान पर पोर्ट हैंडलिंग चार्ज (THC) विक्रेता द्वारा दिए गए हैं या नहीं, यह सत्यापित न करना जिससे विवाद होता है।",
  "Paying deposits into a personal bank account instead of a registered corporate business account.": "पंजीकृत कॉर्पोरेट व्यवसाय खाते के बजाय व्यक्तिगत बैंक खाते में जमा राशि का भुगतान करना।",
  "Relying solely on high Alibaba review ratings without checking factory compliance documents.": "फैक्ट्री अनुपालन दस्तावेजों की जांच किए बिना केवल अलीबाबा समीक्षा रेटिंग पर भरोसा करना।",
  "Measuring inner box size instead of the outer master carton dimensions — outer dimensions determine actual CBM.": "मास्टर कार्टन के बाहरी आयामों के बजाय आंतरिक बॉक्स के आकार को मापना — बाहरी आयाम ही वास्तविक CBM निर्धारित करते हैं।",
  "Forgetting to convert centimeters to meters before multiplying — leads to massive calculation errors.": "गुणा करने से पहले सेंटीमीटर को मीटर में बदलना भूल जाना — जिससे CBM गणना में भारी त्रुटियाँ होती हैं।",
  "Not accounting for pallet volume when goods are palletized before shipping.": "शिपिंग से पहले सामान पेलेटाइज्ड होने पर पेलेट की मात्रा (Pallet Volume) को न जोड़ना।",
  "Declaring only product weight on shipping documents instead of total Gross Weight.": "शिपिंग दस्तावेजों पर कुल ग्रॉस वेट (Gross Weight) के बजाय केवल उत्पाद का शुद्ध वजन घोषित करना।",
  "Forgetting to include pallet weights (each wooden pallet weighs 15-25 kg).": "पेलेट का वजन जोड़ना भूल जाना (प्रत्येक लकड़ी के पेलेट का वजन 15-25 किग्रा होता है)।",
  "Confusing Net Weight with Gross Weight on customs declarations.": "कस्टम घोषणाओं में नेट वेट (Net Weight) और ग्रॉस वेट (Gross Weight) के बीच भ्रमित होना।",
  "Including inner retail packaging weight in Net Weight calculation.": "नेट वेट की गणना में आंतरिक खुदरा पैकेजिंग के वजन को शामिल करना।",
  "Assuming air freight is charged only on scale weight without checking box dimensions.": "बॉक्स के आयामों की जांच किए बिना यह मान लेना कि एयर फ्रेट केवल वास्तविक वजन पर लिया जाता है।",
  "Using oversized boxes with empty air space, resulting in inflated volumetric freight charges.": "खाली जगह वाले बड़े डिब्बों का उपयोग करना, जिससे वॉल्यूमेट्रिक भाड़ा खर्च बढ़ जाता है।",
  "Measuring inner dimensions instead of outer dimensions.": "बाहरी आयामों के बजाय आंतरिक आयामों को मापना।",
  "Not accounting for box bulging after packing.": "पैकिंग के बाद बक्से के फूलने (Box Bulging) का ध्यान न रखना।",
  "Using thin 3-ply cartons that collapse under heavy stacking in sea containers.": "पतले 3-प्लाई कार्टन का उपयोग करना जो समुद्री कंटेनरों में भारी स्टेकिंग के तहत दब जाते हैं।",
  "Omitting mandatory export shipping marks on master carton walls.": "मास्टर कार्टन की दीवारों पर अनिवार्य निर्यात शिपिंग मार्किंग न छापना।",
  "Using non-treated wooden pallets resulting in customs rejection due to ISPM-15 pest regulations.": "गैर-उपचारित लकड़ी के पेलेट का उपयोग करना, जिससे ISPM-15 कीट नियमों के तहत कस्टम्स अस्वीकृति होती है।",
  "Allowing cartons to overhang pallet edges, causing box crushing.": "कार्टन को पेलेट के किनारों से बाहर निकलने देना, जिससे डिब्बे दब जाते हैं।",
  "Focusing only on CBM volume and overloading container weight payload.": "केवल CBM वॉल्यूम पर ध्यान केंद्रित करना और कंटेनर की वजन पेलोड सीमा का उल्लंघन करना।",
  "Not factoring in box packing gaps when estimating CBM loading.": "CBM लोडिंग का अनुमान लगाते समय बॉक्स पैकिंग अंतराल का हिसाब न रखना।",
  "Booking LCL for 20 CBM cargo when FCL 20FT is cheaper and faster.": "20 CBM कार्गो के लिए LCL बुक करना जबकि FCL 20FT सस्ता और तेज़ होता है।",
  "Not checking container inspection before loading.": "लोडिंग से पहले कंटेनर की भौतिक स्थिति की जांच न करना।",
  "Not factoring in origin/destination CFS handling charges which make large LCL shipments expensive.": "CFS हैंडलिंग शुल्कों को न जोड़ना, जिससे बड़े LCL शिपमेंट महंगे हो जाते हैं।",
  "Shipping fragile goods via LCL without extra wooden crate protection.": "अतिरिक्त लकड़ी के क्रेट सुरक्षा के बिना LCL के माध्यम से नाजुक सामान भेजना।",
  "Trying to fit more than 28 CBM of boxed goods into a 20FT container.": "20FT कंटेनर में 28 CBM से अधिक बॉक्स वाले सामान को फिट करने का प्रयास करना।",
  "Exceeding maximum road weight limits when loading heavy cargo.": "भारी कार्गो लोड करते समय सड़क परिवहन की अधिकतम वजन सीमा से अधिक होना।",
  "Booking two 20FT containers instead of one 40FT container (one 40FT is much cheaper).": "एक 40FT कंटेनर के बजाय दो 20FT कंटेनर बुक करना (एक 40FT बहुत सस्ता होता है)।",
  "Overloading weight limit on 40FT with dense goods.": "Overloading weight limit on 40FT with dense goods.",
  "Not checking destination warehouse door height for High Cube container clearance.": "Not checking destination warehouse door height for High Cube container clearance.",
  "Forgetting that weight limit is same as 40FT (26.5 tons).": "Forgetting that weight limit is same as 40FT (26.5 tons).",
  "Focusing only on cheap ocean freight while ignoring expensive local terminal handling surcharges.": "केवल एक पहलू पर ध्यान देना: cheap ocean freight while ignoring expensive local terminal handling surcharges.",
  "Shipping urgent time-sensitive samples via sea freight instead of air freight, causing customer delays.": "असुरक्षित तरीके से शिपिंग करना: urgent time-sensitive samples via समुद्री भाड़ा instead of हवाई भाड़ा, causing customer delays.",
  "Shipping low-value heavy bulk cargo via air freight, which results in freight costs exceeding product value.": "असुरक्षित तरीके से शिपिंग करना: low-value heavy bulk cargo via हवाई भाड़ा, which results in freight costs exceeding product value.",
  "Confusing Port of Loading (POL) with Port of Discharge (POD) on transport documentation.": "नियमों में भ्रमित होना: Port of Loading (POL) with Port of Discharge (POD) on transport documentation.",
  "Failing to track vessel ETA at POD, causing container to sit at port and incur expensive demurrage charges.": "सत्यापित करने में विफल रहना: track vessel ETA at POD, causing container to sit at port and incur expensive demurrage charges.",
  "Clearing customs at seaport when an inland ICD is available near your city, increasing double handling truck costs.": "Clearing customs at seaport when an inland ICD is available near your city, increasing double handling truck costs.",
  "Leaving LCL goods at CFS beyond free storage period, incurring heavy daily storage rent.": "Leaving LCL goods at CFS beyond free storage period, incurring heavy daily storage rent.",
  "Paying advance deposit based on an informal WeChat or email quote instead of a signed formal Proforma Invoice.": "गलत तरीके से भुगतान करना: advance deposit based on an informal WeChat or email quote instead of a signed formal Proforma Invoice.",
  "Under-declaring Commercial Invoice value to evade customs duty, which is a criminal offense leading to heavy penalties and cargo seizure.": "Under-declaring कमर्शियल इनवॉइस value to evade सीमा शुल्क, which is a criminal offense leading to heavy penalties and cargo seizure.",
  "Mismatched box counts or weight discrepancies between Packing List and Bill of Lading, causing customs clearance holds.": "Mismatched box counts or weight discrepancies between पैकिंग लिस्ट and बिल ऑफ लेडिंग, causing कस्टम क्लीयरेंस holds.",
  "Losing original physical Bill of Lading paper documents, which requires bank guarantees and months of delay to get container released.": "Losing original physical बिल ऑफ लेडिंग paper documents, which requires bank guarantees and months of delay to get container released.",
  "Failing to verify documentation details before shipping.": "सत्यापित करने में विफल रहना: verify documentation details before shipping.",
  "Failing to verify document details before submission.": "सत्यापित करने में विफल रहना: verify document details before submission.",
  "Failing to audit charges before approving payments.": "सत्यापित करने में विफल रहना: audit charges before approving payments.",
  "Skipping line inspections and relying only on final packaging checks.": "Skipping line inspections and relying only on final packaging checks.",
  "Confusing QA with QC — QA is process prevention, whereas QC is product inspection.": "नियमों में भ्रमित होना: QA with QC — QA is process prevention, whereas QC is product inspection.",
  "Releasing full payment to supplier before receiving official Pre-Shipment Inspection reports.": "Releasing full payment to supplier before receiving official Pre-Shipment Inspection reports.",
  "Allowing the factory manager to pick the sample cartons instead of the independent inspector.": "लापरवाही बरतने देना: the factory manager to pick the sample cartons instead of the independent inspector.",
  "Accepting batches with defect rates above agreed contractual AQL limits.": "Accepting batches with defect rates above agreed contractual AQL limits.",
  "Relying on expired or fake lab test certificates provided by unverified suppliers.": "केवल भरोसा करना: on expired or fake lab test certificates provided by unverified suppliers.",
  "Importing goods without mandatory regional compliance marks (e.g. BIS in India, CE in EU).": "बिना आवश्यक दस्तावेज आयात करना: goods without mandatory regional compliance marks (e.g. BIS in India, CE in EU).",
  "Failing to qualify leads based on budget, quantity, and import readiness before investing time.": "सत्यापित करने में विफल रहना: qualify leads based on budget, quantity, and import readiness before investing time.",
  "Sending vague inquiries without exact specifications, material requirements, or target quantities.": "Sending vague inquiries without exact specifications, material requirements, or target quantities.",
  "Accepting quotations without checking validity dates or hidden packaging fees.": "Accepting quotations without checking validity dates or hidden packaging fees.",
  "Placing orders via chat messages without issuing a formal signed Purchase Order.": "Placing orders via chat messages without issuing a formal signed परचेज ऑर्डर.",
  "Assuming production has started before receiving a signed Sales Order confirmation from factory.": "गलत अनुमान लगाना: production has started before receiving a signed Sales Order confirmation from factory.",
  "Waiting until the scheduled completion date to contact the factory without weekly follow-ups.": "Waiting until the scheduled completion date to contact the factory without weekly follow-ups.",
  "Wiring advance deposit before both parties have signed the Order Confirmation.": "Wiring advance deposit before both parties have signed the Order Confirmation.",
  "Not accounting for Chinese New Year or national holiday shutdowns when planning production timelines.": "लागत या नियम का हिसाब न रखना: Chinese New Year or national holiday shutdowns when planning production timelines.",
  "Dispatching goods without verifying container seal numbers and truck weight bridge tickets.": "Dispatching goods without verifying container seal numbers and truck weight bridge tickets.",
  "Signing clean delivery receipts without inspecting master carton condition for water damage or crushed boxes.": "Signing clean delivery receipts without inspecting master carton condition for water damage or crushed boxes.",
  "Shipping cargo under basic carrier liability instead of comprehensive all-risk marine insurance.": "असुरक्षित तरीके से शिपिंग करना: cargo under basic carrier liability instead of comprehensive all-risk marine insurance.",
  "Assuming routine raw material shortages count as valid Force Majeure events.": "गलत अनुमान लगाना: routine raw material shortages count as valid Force Majeure events.",
  "Failing to include liquidated damages clauses for unexcused supplier production delays.": "सत्यापित करने में विफल रहना: include liquidated damages clauses for unexcused supplier production delays.",
  "Failing to notify carriers of damage within statutory time limits, invalidating insurance claims.": "सत्यापित करने में विफल रहना: notify carriers of damage within statutory time limits, invalidating insurance claims.",
  "Signing clean trucker delivery notes before tallying total master carton counts.": "Signing clean trucker delivery notes before tallying total master carton counts.",
  "Under-declaring Commercial Invoice value to evade customs duties.": "Under-declaring कमर्शियल इनवॉइस value to evade customs duties.",
  "Omitting governing law and arbitration jurisdiction clauses from international purchase contracts.": "अनिवार्य विवरण छोड़ देना: governing law and arbitration jurisdiction clauses from international purchase contracts.",
  "Accepting client inquiries without specifying target delivery deadlines or quality standards.": "Accepting client inquiries without specifying target delivery deadlines or quality standards.",
  "Approving mass production based on digital photos instead of physical sample testing.": "Approving mass production based on digital photos instead of physical sample testing.",
  "Failing to include destination port handling fees in landed cost calculations prior to approval.": "सत्यापित करने में विफल रहना: include destination port handling fees in landed cost calculations prior to approval.",
  "Omitting quality penalty clauses from Purchase Orders during the purchasing process.": "अनिवार्य विवरण छोड़ देना: quality penalty clauses from परचेज ऑर्डरs during the purchasing process.",
  "Releasing balance payment before verifying clean B/L issuance or inspection reports.": "Releasing balance payment before verifying clean B/L issuance or inspection reports.",
  "Failing to request weekly photo/video proof during active production cycles.": "सत्यापित करने में विफल रहना: request weekly photo/video proof during active production cycles.",
  "Ignoring transshipment port delay notices from ocean freight forwarders.": "Ignoring transshipment port delay notices from ocean freight forwarders.",
  "Delaying duty payment after customs assessment, accumulating daily port demurrage fees.": "Delaying duty payment after customs assessment, accumulating daily port demurrage fees.",
  "Mixing uninspected inbound cargo directly into active sellable warehouse shelves.": "Mixing uninspected inbound cargo directly into active sellable warehouse shelves.",
  "Dispatching trucks without generating mandatory GST E-Way bills for inter-state transit.": "Dispatching trucks without generating mandatory GST E-Way bills for inter-state transit.",
  "Ignoring customer post-delivery quality feedback or warranty replacement requests.": "Ignoring customer post-delivery quality feedback or warranty replacement requests.",
  "Accepting the first MOQ the supplier quotes without negotiating — always negotiate, factories expect it.": "Accepting the first MOQ the supplier quotes without negotiating — always negotiate, factories expect it.",
  "Ordering huge quantities to meet MOQ without testing product quality or market demand first.": "Ordering huge quantities to meet MOQ without testing product quality or market demand first.",
  "Confusing MOQ (units) with minimum order value (dollar amount) — always clarify which one applies.": "नियमों में भ्रमित होना: MOQ (units) with minimum order value (dollar amount) — always clarify which one applies.",
  "Using supplier model numbers as your SKU — create your own internal codes for better control.": "अनुचित तरीके से उपयोग करना: supplier model numbers as your SKU — create your own internal codes for better control.",
  "Not assigning unique SKUs to each variant (color, size, pack quantity) leading to wrong items being shipped.": "Not assigning unique SKUs to each variant (color, size, pack quantity) leading to wrong items being shipped.",
  "Using special characters like / or spaces in SKU codes that break inventory software.": "अनुचित तरीके से उपयोग करना: special characters like / or spaces in SKU codes that break inventory software.",
  "Sharing full product design files without signing an NDA — factories may copy your design and sell to your competitors.": "Sharing full product design files without signing an NDA — factories may copy your design and sell to your competitors.",
  "Confusing OEM with ODM — in OEM, the buyer owns the design; in ODM, the factory owns the design.": "नियमों में भ्रमित होना: OEM with ODM — in OEM, the buyer owns the design; in ODM, the factory owns the design.",
  "Not specifying all technical requirements in writing, leading to products that don\\": "Not specifying all technical requirements in writing, leading to products that don\\",
  "Assuming ODM gives you exclusive product rights — the factory can sell the same design to competitors.": "गलत अनुमान लगाना: ODM gives you exclusive product rights — the factory can sell the same design to competitors.",
  "Not requesting sample testing before placing large ODM orders — factories may produce slightly different specs than shown in catalog.": "Not requesting sample testing before placing large ODM orders — factories may produce slightly different specs than shown in catalog.",
  "Skipping a brand exclusivity agreement — always ask for exclusivity in your target market.": "Skipping a brand exclusivity agreement — always ask for exclusivity in your target market.",
  "Starting private label without trademark registration — competitors can copy your brand name.": "Starting private label without trademark registration — competitors can copy your brand name.",
  "Choosing a factory solely on price without checking product quality, certifications, and compliance.": "Choosing a factory solely on price without checking product quality, certifications, and compliance.",
  "Using the factory\\": "अनुचित तरीके से उपयोग करना: the factory\\",
  "Sending only verbal specifications to factories — always send written, signed spec sheets.": "Sending only verbal specifications to factories — always send written, signed spec sheets.",
  "Not including tolerance limits (e.g., ±2mm size tolerance) — factories interpret this as ": "Not including tolerance limits (e.g., ±2mm size tolerance) — factories interpret this as ",
  "Forgetting to specify required certifications (CE, BIS, FDA) in the product spec.": "शामिल करना भूल जाना: specify required certifications (CE, BIS, FDA) in the product spec.",
  "Skipping sample approval and going straight to mass production — this leads to expensive quality rejections.": "Skipping sample approval and going straight to mass production — this leads to expensive quality rejections.",
  "Approving a sample verbally instead of in writing — always send written sample approval with noted specifications.": "Approving a sample verbally instead of in writing — always send written sample approval with noted specifications.",
  "Testing only appearance and not functionality — always test the product under real-use conditions.": "Testing only appearance and not functionality — always test the product under real-use conditions.",
  "Not including model numbers on purchase orders, leading to factories shipping the wrong product version.": "Not including model numbers on परचेज ऑर्डरs, leading to factories shipping the wrong product version.",
  "Using product names instead of model numbers — names can be ambiguous, model numbers are precise.": "अनुचित तरीके से उपयोग करना: product names instead of model numbers — names can be ambiguous, model numbers are precise.",
  "Not verifying that the model number on the packing list matches the purchase order and invoice.": "Not verifying that the model number on the पैकिंग लिस्ट matches the परचेज ऑर्डर and invoice.",
  "Importing counterfeit branded products — customs worldwide actively seize fake branded goods and impose heavy penalties.": "बिना आवश्यक दस्तावेज आयात करना: counterfeit branded products — customs worldwide actively seize fake branded goods and impose heavy penalties.",
  "Launching a brand without trademark registration — competitors can copy your brand legally.": "Launching a brand without trademark registration — competitors can copy your brand legally.",
  "Using poor quality packaging for branded products — it undermines the brand value customers perceive.": "अनुचित तरीके से उपयोग करना: poor quality packaging for branded products — it undermines the brand value customers perceive.",
  "Using thin single-walled cartons for heavy or fragile goods in sea freight — they collapse under stack weight.": "अनुचित तरीके से उपयोग करना: thin single-walled cartons for heavy or fragile goods in समुद्री भाड़ा — they collapse under stack weight.",
  "Not specifying carton strength requirements (ECT/burst test rating) on purchase orders.": "Not specifying carton strength requirements (ECT/burst test rating) on परचेज ऑर्डरs.",
  "Forgetting to include ": "शामिल करना भूल जाना: include ",
  "Failing to verify documentation details before vessel dispatch.": "सत्यापित करने में विफल रहना: verify documentation details before vessel dispatch.",
  "Always request product samples to verify dimensions and quality before sending deposit wire payments.": "Always request product samples to verify dimensions and quality before sending deposit wire payments.",
  "Request the supplier to provide the HSN code early to check standard custom duty rates.": "Request the supplier to provide the HSN code early to check standard custom duty rates.",
  "Always ensure your sales agreement specifies the exact port, e.g., ": "Always ensure your sales agreement specifies the exact port, e.g., ",
  "Book your own forwarder under FOB terms to maintain full control over the shipping timeline and destination clearances.": "Book your own forwarder under FOB terms to maintain full control over the shipping timeline and destination clearances.",
  "Always conduct a live video call to see the factory floor and inventory warehouse.": "Always conduct a live video call to see the factory floor and inventory warehouse.",
  "Request references of existing buyers in your country to verify their service history.": "Request references of existing buyers in your country to verify their service history.",
  "Always ask your supplier for outer master carton dimensions (L × W × H in cm) and total carton count.": "Always ask your supplier for outer master carton dimensions (L × W × H in cm) and total carton count.",
  "Use the CBM formula: (L × W × H in cm) ÷ 1,000,000 × Number of Cartons = Total CBM.": "Use the CBM formula: (L × W × H in cm) ÷ 1,000,000 × Number of Cartons = Total CBM.",
  "If total volume exceeds 15 CBM, compare LCL charges vs 20FT FCL rates — 20FT FCL is often cheaper above 15 CBM.": "If total volume exceeds 15 CBM, compare LCL charges vs 20FT FCL rates — 20FT FCL is often cheaper above 15 CBM.",
  "Weigh packed master cartons on a certified digital scale at the factory before loading.": "Weigh packed master cartons on a certified digital scale at the factory before loading.",
  "Ensure Gross Weight on Packing List matches Commercial Invoice and VGM certificate exactly.": "Ensure Gross Weight on पैकिंग लिस्ट matches कमर्शियल इनवॉइस and VGM certificate exactly.",
  "List both Net Weight and Gross Weight clearly on every line item of your Packing List.": "List both Net Weight and Gross Weight clearly on every line item of your पैकिंग लिस्ट.",
  "Verify Net Weight for bulk commodity imports to ensure supplier did not short-ship goods.": "Verify Net Weight for bulk commodity imports to ensure supplier did not short-ship goods.",
  "Compress bulky items (like textiles or plush goods) using vacuum packaging before air freight.": "Compress bulky items (like textiles or plush goods) using vacuum packaging before हवाई भाड़ा.",
  "Optimize box dimensions to eliminate empty space and lower Volume Weight.": "Optimize box dimensions to eliminate empty space and lower Volume Weight.",
  "Measure outer dimensions after boxes are fully packed and sealed.": "Measure outer dimensions after boxes are fully packed and sealed.",
  "Standardize carton sizes across product lines to simplify palletization.": "Standardize carton sizes across product lines to simplify palletization.",
  "Require double-walled 5-ply or 7-ply corrugated cartons for all sea freight shipments.": "Require double-walled 5-ply or 7-ply corrugated cartons for all समुद्री भाड़ा shipments.",
  "Print shipping marks on at least two sides of every master carton.": "Print shipping marks on at least two sides of every master carton.",
  "Ensure supplier provides ISPM-15 Phytosanitary Certificate for all wooden pallets.": "Ensure supplier provides ISPM-15 Phytosanitary Certificate for all wooden pallets.",
  "Use plastic pallets for food or medical product imports.": "Use plastic pallets for food or medical product imports.",
  "For heavy cargo (machinery, metals), check weight payload limit first.": "For heavy cargo (machinery, metals), check weight payload limit first.",
  "For light voluminous cargo (garments, toys), check CBM volume capacity first.": "For light voluminous cargo (garments, toys), check CBM volume capacity first.",
  "Compare FCL vs LCL rates whenever cargo volume exceeds 14-15 CBM.": "Compare FCL vs LCL rates whenever cargo volume exceeds 14-15 CBM.",
  "Ensure container bolt seal number is recorded on Bill of Lading.": "Ensure container bolt seal number is recorded on बिल ऑफ लेडिंग.",
  "Use LCL for small trial shipments under 10 CBM.": "Use LCL for small trial shipments under 10 CBM.",
  "Reinforce master carton packaging for LCL because goods are handled multiple times at CFS.": "Reinforce master carton packaging for LCL because goods are handled multiple times at CFS.",
  "Use 20FT for heavy goods (metals, minerals, liquids).": "Use 20FT for heavy goods (metals, minerals, liquids).",
  "Effective usable volume is 28 CBM for standard boxes.": "Effective usable volume is 28 CBM for standard boxes.",
  "Book 40FT for general consumer goods, footwear, textiles.": "Book 40FT for general consumer goods, footwear, textiles.",
  "Effective usable volume is 58 CBM.": "Effective usable volume is 58 CBM.",
  "Always request 40HQ over standard 40FT for light bulky goods — rate difference is minimal.": "Always request 40HQ over standard 40FT for light bulky goods — rate difference is minimal.",
  "Effective usable volume is 68 CBM.": "Effective usable volume is 68 CBM.",
  "Request an itemized freight quote showing ocean freight, BAF (bunker fuel), and CAF (currency adjustment).": "Request an itemized freight quote showing ocean freight, BAF (bunker fuel), and CAF (currency adjustment).",
  "Book sea freight space 2-3 weeks in advance during peak import seasons (like Pre-Diwali or Chinese New Year).": "Book समुद्री भाड़ा space 2-3 weeks in advance during peak import seasons (like Pre-Diwali or Chinese New Year).",
  "Calculate Chargeable Weight (Max of scale weight vs volume weight ÷ 6000) before booking air freight.": "Calculate Chargeable Weight (Max of scale weight vs volume weight ÷ 6000) before booking हवाई भाड़ा.",
  "Verify origin POL terminal cutoff dates (CY Cutoff) to ensure container is gated in before ship departs.": "Verify origin POL terminal cutoff dates (CY Cutoff) to ensure container is gated in before ship departs.",
  "File advance Bill of Entry 2 days before vessel ETA at POD to clear customs immediately upon discharge.": "File advance Bill of Entry 2 days before vessel ETA at POD to clear customs immediately upon discharge.",
  "Specify your local ICD code as final destination on Bill of Lading (e.g., Destination: ICD Ahmedabad - SBIAD).": "Specify your local ICD code as final destination on बिल ऑफ लेडिंग (e.g., Destination: ICD Ahmedabad - SBIAD).",
  "Verify CFS handling charges and free storage days (usually 5 days) before container arrival at CFS.": "CFS हैंडलिंग शुल्कों को न जोड़ना, जिससे बड़े LCL शिपमेंट महंगे हो जाते हैं।",
  "Check that PI explicitly lists Incoterms (FOB/CIF), HSN codes, payment terms, and factory bank SWIFT details before paying.": "Check that PI explicitly lists Incoterms (FOB/CIF), HSN codes, payment terms, and factory bank SWIFT details before paying.",
  "Ensure Invoice Number, Date, Buyer/Seller Tax IDs, Incoterms, HSN Codes, and Currency are accurately stated.": "Ensure Invoice Number, Date, Buyer/Seller Tax IDs, Incoterms, HSN Codes, and Currency are accurately stated.",
  "Attach a copy of the Packing List inside Container Box #1 and paste pouch copies on outer carton walls.": "Attach a copy of the पैकिंग लिस्ट inside Container Box #1 and paste pouch copies on outer carton walls.",
  "Request Telex Release (Surrender B/L) from supplier to avoid mailing physical original paper documents via international courier.": "Request Telex Release (Surrender B/L) from supplier to avoid mailing physical original paper documents via international courier.",
  "Consult your logistics agent before finalizing PO terms.": "Consult your logistics agent before finalizing PO terms.",
  "Always double-check HSN codes and values.": "Always double-check HSN codes and values.",
  "Request itemized rate cards from forwarders.": "Request itemized rate cards from forwarders.",
  "Define inline inspection checkpoints at 20%, 50%, and 80% production stages.": "Define inline inspection checkpoints at 20%, 50%, and 80% production stages.",
  "Audit factory ISO certifications and standard operating procedures (SOPs) before placing orders.": "Audit factory ISO certifications and standard operating procedures (SOPs) before placing orders.",
  "Define AQL Level II inspection standards in writing inside your Purchase Order.": "Define AQL Level II inspection standards in writing inside your परचेज ऑर्डर.",
  "Ensure sampling covers boxes from front, middle, and back of the warehouse pallet stacks.": "Ensure sampling covers boxes from front, middle, and back of the warehouse pallet stacks.",
  "Include clear penalty clauses requiring factory re-inspection fees if defect rate fails AQL limits.": "Include clear penalty clauses requiring factory re-inspection fees if defect rate fails AQL limits.",
  "Verify lab test certificate authenticity directly on testing agency verification portals.": "Verify lab test certificate authenticity directly on testing agency verification portals.",
  "Check current customs tariff regulations and mandatory certification rules before placing purchase orders.": "Check current customs tariff regulations and mandatory certification rules before placing परचेज ऑर्डरs.",
  "Use a CRM tool to log lead source, contact details, and initial product specifications.": "Use a CRM tool to log lead source, contact details, and initial product specifications.",
  "Attach a detailed Product Specification Sheet to your inquiry email to receive precise quotes.": "Attach a detailed Product Specification Sheet to your inquiry email to receive precise quotes.",
  "Request quotation break-ups showing raw material cost, packaging cost, and export inland freight.": "Request quotation break-ups showing raw material cost, packaging cost, and export inland freight.",
  "Include quality inspection pass requirements and penalty clauses for late delivery inside the PO.": "Include quality inspection pass requirements and penalty clauses for late delivery inside the PO.",
  "Cross-check the Sales Order line items against your original PO to verify zero price or spec discrepancies.": "Cross-check the Sales Order line items against your original PO to verify zero price or spec discrepancies.",
  "Request weekly photo and video updates showing raw material inventory and assembly progress.": "Request weekly photo and video updates showing raw material inventory and assembly progress.",
  "Ensure Order Confirmation states exact bank SWIFT details and deposit currency.": "Ensure Order Confirmation states exact bank SWIFT details and deposit currency.",
  "Add a 7-day buffer time to the production timeline for unforeseen material shortages.": "Add a 7-day buffer time to the production timeline for unforeseen material shortages.",
  "Require factory to send photos of container seal lock and loaded truck before gate-out.": "Require factory to send photos of container seal lock and loaded truck before gate-out.",
  "Note any outer box damages or broken seals directly on the trucker delivery proof before signing.": "Note any outer box damages or broken seals directly on the trucker delivery proof before signing.",
  "Insure cargo for 110% of CIF value to cover expected profit margins in case of loss.": "Insure cargo for 110% of CIF value to cover expected profit margins in case of loss.",
  "Specify explicit notice timelines (e.g. 7 days written notice) inside Force Majeure contract clauses.": "Specify explicit notice timelines (e.g. 7 days written notice) inside Force Majeure contract clauses.",
  "Maintain a 10-day buffer stock in local warehouses to absorb international transit delays.": "Maintain a 10-day buffer stock in local warehouses to absorb international transit delays.",
  "Document cargo damage immediately with photos and written notice upon container opening.": "Document cargo damage immediately with photos and written notice upon container opening.",
  "Conduct box tallying immediately upon container unloading at port CFS or warehouse.": "Conduct box tallying immediately upon container unloading at port CFS or warehouse.",
  "Verify HSN codes and assessable values with licensed CHA brokers prior to ICEGATE filing.": "Verify HSN codes and assessable values with licensed CHA brokers prior to ICEGATE filing.",
  "Include SIAC or ICA arbitration clauses in all overseas Purchase Orders for fast resolution.": "Include SIAC or ICA arbitration clauses in all overseas परचेज ऑर्डरs for fast resolution.",
  "Require clients to sign off on the Inquiry Form before initiating supplier sourcing.": "Require clients to sign off on the Inquiry Form before initiating supplier sourcing.",
  "Store signed Golden Samples in RBC warehouse to serve as reference benchmarks for PSI inspections.": "Store signed Golden Samples in RBC warehouse to serve as reference benchmarks for PSI inspections.",
  "Use automated landed cost calculators accounting for customs duties, freight, and local logistics.": "Use automated landed cost calculators accounting for customs duties, freight, and local logistics.",
  "Require factory sign-off on Purchase Order terms before executing bank wire transfers.": "Require factory sign-off on परचेज ऑर्डर terms before executing bank wire transfers.",
  "Implement dual-authorization sign-off inside finance software for international TT wire transfers.": "Implement dual-authorization sign-off inside finance software for international TT wire transfers.",
  "Use digital production tracking dashboards updated directly by factory quality managers.": "Use digital production tracking dashboards updated directly by factory quality managers.",
  "Integrate automated container tracking APIs inside RBC ERP for real-time vessel alerts.": "Integrate automated container tracking APIs inside RBC ERP for real-time vessel alerts.",
  "Maintain sufficient balance in ICEGATE e-cash ledger for instant one-click duty payments.": "Maintain sufficient balance in ICEGATE e-cash ledger for instant one-click duty payments.",
  "Use barcode handheld scanners during container unloading for automated inventory logging.": "Use barcode handheld scanners during container unloading for automated inventory logging.",
  "Require truck drivers to obtain signed and stamped Delivery Proof (POD) upon client receipt.": "Require truck drivers to obtain signed and stamped Delivery Proof (POD) upon client receipt.",
  "Conduct a follow-up feedback call 14 days post-delivery to measure customer satisfaction.": "Conduct a follow-up feedback call 14 days post-delivery to measure customer satisfaction.",
  "Ask the supplier: ": "Ask the supplier: ",
  "If MOQ is too high, find a trading company that buys from the factory in bulk and resells in smaller quantities.": "If MOQ is too high, find a trading company that buys from the factory in bulk and resells in smaller quantities.",
  "Always confirm MOQ in writing (email/contract) before placing deposits.": "Always confirm MOQ in writing (email/contract) before placing deposits.",
  "Build your SKU with a logical structure: CATEGORY-COLOR-SIZE (e.g., BAG-BLK-LRG).": "Build your SKU with a logical structure: CATEGORY-COLOR-SIZE (e.g., BAG-BLK-LRG).",
  "Never change a SKU once it is in use — it breaks inventory history records.": "Never change a SKU once it is in use — it breaks inventory history records.",
  "Use the same SKU on your packing list, invoice, and warehouse label for error-free operations.": "Use the same SKU on your पैकिंग लिस्ट, invoice, and warehouse label for error-free operations.",
  "Always sign an NDA before sending any product designs or specifications to a factory.": "Always sign an NDA before sending any product designs or specifications to a factory.",
  "Request a sealed prototype before approving mass production in any OEM arrangement.": "Request a sealed prototype before approving mass production in any OEM arrangement.",
  "Register your product design as a patent or utility model for legal protection.": "Register your product design as a patent or utility model for legal protection.",
  "Request a ": "Request a ",
  "Always order 2–3 samples from different suppliers to compare ODM product quality before choosing.": "Always order 2–3 samples from different suppliers to compare ODM product quality before choosing.",
  "Check if the ODM product has existing certifications (CE, RoHS) that you can use in your market.": "Check if the ODM product has existing certifications (CE, RoHS) that you can use in your market.",
  "Register your brand trademark in your target country before placing your first private label order.": "Register your brand trademark in your target country before placing your first private label order.",
  "Invest in quality packaging design — 80% of consumer purchase decisions are influenced by packaging.": "Invest in quality packaging design — 80% of consumer purchase decisions are influenced by packaging.",
  "Order sample batches from 3 factories and compare quality, pricing, and MOQ before committing.": "Order sample batches from 3 factories and compare quality, pricing, and MOQ before committing.",
  "Use a standard spec sheet template with sections: Product Name, SKU, Dimensions, Weight, Material, Color, Certification, Packaging.": "પ્રોડક્ટનું નામ, SKU, પરિમાણો, વજન, સામગ્રી, રંગ, સર્ટિફિકેશન અને પેકિંગ જેવા વિભાગો સાથેના સ્ટાન્ડર્ડ સ્પેક શીટ ટેમ્પલેટનો ઉપયોગ કરો.",
  "Always include photos, diagrams, or reference samples in your spec document for clarity.": "Always include photos, diagrams, or reference samples in your spec document for clarity.",
  "Get the factory to sign and stamp your product specification document before production starts.": "Get the factory to sign and stamp your product specification document before production starts.",
  "Document all sample issues in writing to the factory with photos — this creates a record for quality accountability.": "Document all sample issues in writing to the factory with photos — this creates a record for quality accountability.",
  "Compare samples from 3 different factories before choosing your supplier.": "Compare samples from 3 different factories before choosing your supplier.",
  "Keep one approved sample sealed in a bag — it becomes your production quality benchmark.": "Keep one approved sample sealed in a bag — it becomes your production quality benchmark.",
  "Always include the exact factory model number on your Purchase Order and Commercial Invoice.": "Always include the exact factory model number on your परचेज ऑर्डर and कमर्शियल इनवॉइस.",
  "Verify model numbers in the physical product against the shipping documents before warehouse acceptance.": "Verify model numbers in the physical product against the शिपिंग दस्तावेज before warehouse acceptance.",
  "If a factory discontinues a model, request the technical spec sheet of the replacement model before accepting it.": "If a factory discontinues a model, request the technical spec sheet of the replacement model before accepting it.",
  "Register your trademark before your first import shipment — trademark disputes are expensive to fight.": "Register your trademark before your first import shipment — trademark disputes are expensive to fight.",
  "Invest in professional logo and packaging design — it is the most visible part of your brand.": "Invest in professional logo and packaging design — it is the most visible part of your brand.",
  "Keep brand positioning consistent across all products, packaging, and marketing materials.": "Keep brand positioning consistent across all products, packaging, and marketing materials.",
  "For fragile goods (ceramics, glass, electronics), always request double-walled corrugated cartons with foam inserts.": "नाज़ुक सामान (जैसे सिरामिक्स, कांच, इलेक्ट्रॉनिक्स) के लिए हमेशा फोम इनसर्ट वाले डबल-वॉल कार्टन की मांग करें।",
  "Include packing specifications in your purchase order: carton size, weight limit, units per carton, and wall thickness.": "Include packing specifications in your परचेज ऑर्डर: carton size, weight limit, units per carton, and wall thickness.",
  "Always inspect 10% of cartons upon factory loading to verify packaging quality before the container is sealed.": "Always inspect 10% of cartons upon factory loading to verify packaging quality before the container is sealed.",
  "Consult your customs broker (CHA) before finalizing purchase contracts.": "Consult your customs broker (CHA) before finalizing purchase contracts.",
  "Custom duty rates vary by HSN code.": "Custom duty rates vary by HSN code.",
  "FOB is for sea transit only.": "FOB is for sea transit only.",
  "Mismatch in company names is a major red flag.": "Mismatch in company names is a major red flag.",
  "Formula: (Length × Width × Height in cm) ÷ 1,000,000 = CBM per box.": "Formula: (Length × Width × Height in cm) ÷ 1,000,000 = CBM per box.",
  "Always check compliance rules for Courier Shipment.": "Always check compliance rules for Courier Shipment.",
  "Always check compliance rules for Transit Time.": "Always check compliance rules for Transit Time.",
  "Always check compliance rules for ETD.": "Always check compliance rules for ETD.",
  "Always check compliance rules for ETA.": "Always check compliance rules for ETA.",
  "Always check compliance rules for Vessel.": "Always check compliance rules for Vessel.",
  "Always check compliance rules for Voyage.": "Always check compliance rules for Voyage.",
  "Always check compliance rules for Mother Vessel.": "Always check compliance rules for Mother Vessel.",
  "Always check compliance rules for Feeder Vessel.": "Always check compliance rules for Feeder Vessel.",
  "Always check compliance rules for EXW.": "Always check compliance rules for EXW.",
  "Always check compliance rules for FCA.": "Always check compliance rules for FCA.",
  "Always check compliance rules for CIF.": "Always check compliance rules for CIF.",
  "Always check compliance rules for CFR.": "Always check compliance rules for CFR.",
  "Always check compliance rules for DDP.": "Always check compliance rules for DDP.",
  "Always check compliance rules for DAP.": "Always check compliance rules for DAP.",
  "Always check compliance rules for CIP.": "Always check compliance rules for CIP.",
  "Always check compliance rules for CPT.": "Always check compliance rules for CPT.",
  "Always check compliance rules for Warehouse.": "Always check compliance rules for Warehouse.",
  "Always check compliance rules for Bonded Warehouse.": "Always check compliance rules for Bonded Warehouse.",
  "Always check compliance rules for Last Mile Delivery.": "Always check compliance rules for Last Mile Delivery.",
  "Always check compliance rules for Door Delivery.": "Always check compliance rules for Door Delivery.",
  "Verify all details on Fumigation Certificate.": "Verify all details on Fumigation Certificate.",
  "Verify all details on Inspection Certificate.": "Verify all details on Inspection Certificate.",
  "Verify all details on Air Way Bill.": "Verify all details on Air Way Bill.",
  "Verify all details on Delivery Order.": "Verify all details on Delivery Order.",
  "Verify all details on Shipping Bill.": "Verify all details on Shipping Bill.",
  "Verify all details on Bill of Entry.": "Verify all details on Bill of Entry.",
  "Verify all details on Certificate of Origin.": "Verify all details on Certificate of Origin.",
  "Verify all details on Insurance Certificate.": "Verify all details on Insurance Certificate.",
  "Verify all details on Customs.": "Verify all details on Customs.",
  "Verify all details on Customs Clearance.": "Verify all details on कस्टम क्लीयरेंस.",
  "Verify all details on CHA.": "Verify all details on CHA.",
  "Verify all details on HSN Code.": "Verify all details on HSN Code.",
  "Audit all charges for Ocean Freight.": "Audit all charges for Ocean Freight.",
  "Audit all charges for Local Charges.": "Audit all charges for Local Charges.",
  "Audit all charges for THC.": "Audit all charges for THC.",
  "Audit all charges for CFS Charges.": "Audit all charges for CFS Charges.",
  "Audit all charges for DO Charges.": "Audit all charges for DO Charges.",
  "Audit all charges for Detention.": "Audit all charges for Detention.",
  "Audit all charges for Demurrage.": "Audit all charges for Demurrage.",
  "Audit all charges for Port Charges.": "Audit all charges for Port Charges.",
  "Audit all charges for Documentation Charges.": "Audit all charges for Documentation Charges.",
  "MOQ can be negotiated — offer better price per unit or commit to future repeat orders.": "MOQ can be negotiated — offer better price per unit or commit to future repeat orders.",
  "Always confirm MOQ and price together — lower MOQ usually means higher per-unit price.": "Always confirm MOQ and price together — lower MOQ usually means higher per-unit price.",
  "Every product variant must have its own unique SKU.": "Every product variant must have its own unique SKU.",
  "Keep SKU consistent across invoice, packing list, and warehouse label.": "Keep SKU consistent across invoice, पैकिंग लिस्ट, and warehouse label.",
  "Always sign NDA before sharing designs with any factory.": "Always sign NDA before sharing designs with any factory.",
  "OEM buyer owns the design; ODM buyer only owns the brand.": "OEM buyer owns the design; ODM buyer only owns the brand.",
  "Factory owns the design in ODM — you only own the brand.": "Factory owns the design in ODM — you only own the brand.",
  "Ask for market exclusivity to prevent competitors from selling the same product.": "Ask for market exclusivity to prevent competitors from selling the same product.",
  "Register your trademark before launching any private label product.": "Register your trademark before launching any private label product.",
  "Custom packaging design is key to private label success.": "Custom packaging design is key to private label success.",
  "Get spec document signed by factory before production.": "Get spec document signed by factory before production.",
  "Include tolerance limits for dimensions and weight.": "Include tolerance limits for dimensions and weight.",
  "Always test sample under real conditions, not just visually.": "Always test sample under real conditions, not just visually.",
  "Keep one approved sealed sample as production quality benchmark.": "Keep one approved sealed sample as production quality benchmark.",
  "Include model number on PO, invoice, and packing list.": "Include model number on PO, invoice, and पैकिंग लिस्ट.",
  "Verify model number on received goods against documents.": "Verify model number on received goods against documents.",
  "Register trademark before first commercial import.": "Register trademark before first commercial import.",
  "Never import counterfeit branded products — it is illegal.": "Never import counterfeit branded products — it is illegal.",
  "Always include ": "Always include ",
  "For fragile goods, specify double-walled cartons with foam inserts.": "नाज़ुक सामान के लिए फोम इनसर्ट वाले डबल-वॉल कार्टन की मांग करें।",
  "Importing feeds domestic needs.": "बिना आवश्यक दस्तावेज आयात करना: feeds domestic needs.",
  "Check HSN details early.": "Check HSN details early.",
  "Risk transfer passes at loaded origin.": "Risk transfer passes at loaded origin.",
  "Buyer books the vessel.": "Buyer books the vessel.",
  "Vetting protects wire deposits.": "Vetting protects wire deposits.",
  "Check machines and certificates.": "Check machines and certificates.",
  "CBM = Cubic Meter (Cargo Volume)": "CBM = Cubic Meter (Cargo Volume)",
  "Formula = L(m) × W(m) × H(m)": "Formula = L(m) × W(m) × H(m)",
  "Gross Weight is the total combined weight of goods + packaging + pallets. It is critical for container safety, freight calculation, and SOLAS VGM compliance.": "Gross Weight is the total combined weight of goods + packaging + pallets. It is critical for container safety, freight calculation, and SOLAS VGM compliance.",
  "Net Weight is the pure weight of goods excluding packaging. It is essential for commodity pricing, yield verification, and customs valuation.": "Net Weight is the pure weight of goods excluding packaging. It is essential for commodity pricing, yield verification, and customs valuation.",
  "Volume Weight = (L × W × H cm) ÷ 6000. Express carriers charge on whichever is higher between scale weight and volume weight.": "Volume Weight = (L × W × H cm) ÷ 6000. Express carriers charge on whichever is higher between scale weight and volume weight.",
  "Carton Size is the outer L × W × H measurement of export boxes used for CBM and container planning.": "Carton Size is the outer L × W × H measurement of export boxes used for CBM and container planning.",
  "Master Carton is the heavy-duty outer box carrying multiple units with export shipping marks.": "मास्टर कार्टन की दीवारों पर अनिवार्य निर्यात शिपिंग मार्किंग न छापना।",
  "Pallets enable forklift handling and cargo protection. Wooden pallets require ISPM-15 fumigation stamp.": "Pallets enable forklift handling and cargo protection. Wooden pallets require ISPM-15 fumigation stamp.",
  "Loading Capacity defines container volume (CBM) and payload weight (kg) limits for safe transport.": "Loading Capacity defines container volume (CBM) and payload weight (kg) limits for safe transport.",
  "FCL = Full Container Load. Dedicated container for one buyer, offering faster transit and higher security.": "FCL = Full Container Load. Dedicated container for one buyer, offering faster transit and higher security.",
  "LCL = Less than Container Load. Shared container space for small orders billed per CBM.": "LCL = Less than Container Load. Shared container space for small orders billed per CBM.",
  "Freight is the carrier fee for transporting cargo by sea, air, or land.": "Freight is the carrier fee for transporting cargo by sea, air, or land.",
  "Sea Freight is ocean vessel transport for containers and bulk cargo at lowest unit cost.": "समुद्री भाड़ा is ocean vessel transport for containers and bulk cargo at lowest unit cost.",
  "Air Freight is fast air cargo transport ideal for high-value or time-sensitive goods.": "हवाई भाड़ा is fast air cargo transport ideal for high-value or time-sensitive goods.",
  "POL = Port of Loading (Origin seaport where ship is loaded with container).": "POL = Port of Loading (Origin seaport where ship is loaded with container).",
  "POD = Port of Discharge (Destination seaport where container is unloaded from vessel).": "POD = Port of Discharge (Destination seaport where container is unloaded from vessel).",
  "ICD = Inland Container Depot (Dry Port). Inland customs facility for local clearance away from seaports.": "ICD = Inland Container Depot (Dry Port). Inland customs facility for local clearance away from seaports.",
  "CFS = Container Freight Station. Customs warehouse for consolidating and sorting LCL cargo.": "CFS = Container Freight Station. Customs warehouse for consolidating and sorting LCL cargo.",
  "Proforma Invoice is a preliminary sales agreement used for advance deposit payment and LC opening.": "Proforma Invoice is a preliminary sales agreement used for advance deposit payment and LC opening.",
  "Commercial Invoice is the legal billing document for cargo valuation, customs duty calculation, and banking settlement.": "कमर्शियल इनवॉइस is the legal billing document for cargo valuation, सीमा शुल्क calculation, and banking settlement.",
  "Packing List details total cartons, weights (Gross/Net), dimensions (CBM), and item contents for customs verification.": "पैकिंग लिस्ट details total cartons, weights (Gross/Net), dimensions (CBM), and item contents for customs verification.",
  "Bill of Lading (B/L) is the primary document of title and ocean transport contract issued by shipping line.": "बिल ऑफ लेडिंग (B/L) is the primary document of title and ocean transport contract issued by shipping line.",
  "Courier Shipment is rapid door-to-door express parcel delivery managed by global integrators like DHL, FedEx, and UPS.": "Courier Shipment is rapid door-to-door express parcel delivery managed by global integrators like DHL, FedEx, and UPS.",
  "Transit Time is the total elapsed time in days required for cargo to travel from port of origin (POL) to port of destination (POD).": "Transit Time is the total elapsed time in days required for cargo to travel from port of origin (POL) to port of destination (POD).",
  "ETD (Estimated Time of Departure) is the scheduled date and time when a shipping vessel or cargo plane departs from origin port.": "ETD (Estimated Time of Departure) is the scheduled date and time when a shipping vessel or cargo plane departs from origin port.",
  "ETA (Estimated Time of Arrival) is the anticipated date and time when vessel or aircraft arrives at destination port.": "ETA (Estimated Time of Arrival) is the anticipated date and time when vessel or aircraft arrives at destination port.",
  "Vessel is a commercial ocean-going cargo ship (container carrier, bulk vessel, tanker) used to transport goods internationally.": "Vessel is a commercial ocean-going cargo ship (container carrier, bulk vessel, tanker) used to transport goods internationally.",
  "Voyage is the unique alphanumeric identification code assigned to a specific ocean journey of a cargo vessel.": "Voyage is the unique alphanumeric identification code assigned to a specific ocean journey of a cargo vessel.",
  "Mother Vessel is a large mainline ocean container ship operating on major intercontinental routes between global hub ports.": "Mother Vessel is a large mainline ocean container ship operating on major intercontinental routes between global hub ports.",
  "Feeder Vessel is a smaller regional cargo ship carrying containers between regional ports and major ocean hub ports.": "Feeder Vessel is a smaller regional cargo ship carrying containers between regional ports and major ocean hub ports.",
  "EXW (Ex Works) means seller makes goods available at factory floor. Buyer assumes 100% transport cost, risk, and customs clearance.": "EXW (Ex Works) means seller makes goods available at factory floor. Buyer assumes 100% transport cost, risk, and कस्टम क्लीयरेंस.",
  "FCA (Free Carrier) means seller delivers goods to buyer\\": "FCA (Free Carrier) means seller delivers goods to buyer\\",
  "CIF (Cost, Insurance, Freight) means seller pays ocean freight and marine insurance to destination port. Buyer pays import customs duty & port unloading.": "CIF (Cost, Insurance, Freight) means seller pays ocean freight and marine insurance to destination port. Buyer pays import सीमा शुल्क & port unloading.",
  "CFR (Cost and Freight) means seller pays ocean freight to destination port, but buyer purchases marine cargo insurance.": "CFR (Cost and Freight) means seller pays ocean freight to destination port, but buyer purchases marine cargo insurance.",
  "DDP (Delivered Duty Paid) means seller handles entire logistics including ocean freight, customs duty, taxes, and final door delivery. Maximum seller risk.": "DDP (Delivered Duty Paid) means seller handles entire logistics including ocean freight, सीमा शुल्क, taxes, and final door delivery. Maximum seller risk.",
  "DAP (Delivered At Place) means seller delivers cargo to buyer door, but buyer pays import customs duties and taxes.": "DAP (Delivered At Place) means seller delivers cargo to buyer door, but buyer pays import customs duties and taxes.",
  "CIP (Carriage and Insurance Paid to) is multimodal Incoterm where seller pays carriage + all-risk insurance to destination place.": "CIP (Carriage and Insurance Paid to) is multimodal Incoterm where seller pays carriage + all-risk insurance to destination place.",
  "CPT (Carriage Paid To) is multimodal Incoterm where seller pays main freight carriage to named destination place.": "CPT (Carriage Paid To) is multimodal Incoterm where seller pays main freight carriage to named destination place.",
  "Warehouse is a commercial facility designed for storage of raw materials, inventory management, order picking, and distribution.": "Warehouse is a commercial facility designed for storage of raw materials, inventory management, order picking, and distribution.",
  "Bonded Warehouse is a customs-controlled storage building where imported goods can be stored duty-free until cleared for domestic sale.": "Bonded Warehouse is a customs-controlled storage building where imported goods can be stored duty-free until cleared for domestic sale.",
  "Last Mile Delivery is the final transportation leg moving cleared cargo from regional warehouse to final customer door.": "Last Mile Delivery is the final transportation leg moving cleared cargo from regional warehouse to final customer door.",
  "Door Delivery is an end-to-end shipping service where logistics provider handles pickup at factory door and delivery to importer door.": "Door Delivery is an end-to-end shipping service where logistics provider handles pickup at factory door and delivery to importer door.",
  "Fumigation Certificate is an official pest control document certifying that wooden packaging materials (pallets, crates) have been chemically treated (ISPM-15) to kill timber pests before shipment.": "Fumigation Certificate is an official pest control document certifying that wooden packaging materials (pallets, crates) have been chemically treated (ISPM-15) to kill timber pests before shipment.",
  "Inspection Certificate is a quality, quantity, and technical compliance audit report issued by an independent inspection agency (such as SGS, Intertek, or TÜV) after physically auditing finished goods at the factory.": "Inspection Certificate is a quality, quantity, and technical compliance audit report issued by an independent inspection agency (such as SGS, Intertek, or TÜV) after physically auditing finished goods at the factory.",
  "Air Way Bill (AWB) is the official non-negotiable transport document issued by an airline for cargo transported by air, serving as a carriage contract and receipt of goods.": "Air Way Bill (AWB) is the official non-negotiable transport document issued by an airline for cargo transported by air, serving as a carriage contract and receipt of goods.",
  "Delivery Order (DO) is a release document issued by the shipping line or freight forwarder to the port terminal/CFS authorizing the surrender of cargo to the importer after freight and local charges are settled.": "Delivery Order (DO) is a release document issued by the shipping line or freight forwarder to the port terminal/CFS authorizing the surrender of cargo to the importer after freight and local charges are settled.",
  "Shipping Bill is an official export declaration document filed electronically by the exporter with Customs (via ICEGATE) to obtain \\": "असुरक्षित तरीके से शिपिंग करना: Bill is an official export declaration document filed electronically by the exporter with Customs (via ICEGATE) to obtain \\",
  "Bill of Entry (BOE) is a statutory import declaration document filed by an importer/CHA with Customs (via ICEGATE) detailing imported cargo value, HSN codes, and duty calculations for clearance.": "Bill of Entry (BOE) is a statutory import declaration document filed by an importer/CHA with Customs (via ICEGATE) detailing imported cargo value, HSN codes, and duty calculations for clearance.",
  "Certificate of Origin (COO) is an official document issued by a Chamber of Commerce or government authority certifying the country where the imported product was manufactured.": "Certificate of Origin (COO) is an official document issued by a Chamber of Commerce or government authority certifying the country where the imported product was manufactured.",
  "Insurance Certificate is an official policy document issued by a marine insurance underwriter confirming that cargo is insured against loss, damage, theft, or vessel sinking during transit.": "Insurance Certificate is an official policy document issued by a marine insurance underwriter confirming that cargo is insured against loss, damage, theft, or vessel sinking during transit.",
  "Customs is the government border authority enforcing import/export trade laws, inspecting international shipments, and collecting customs duties and taxes.": "Customs is the government border authority enforcing import/export trade laws, inspecting international shipments, and collecting customs duties and taxes.",
  "Customs Clearance is the official administrative procedure of obtaining permission from customs authorities to import or export cargo across international borders.": "कस्टम क्लीयरेंस is the official administrative procedure of obtaining permission from customs authorities to import or export cargo across international borders.",
  ...
  "HSN Code (Harmonized System of Nomenclature) is an international 6-to-8 digit standardized numerical code used worldwide to classify traded commodities for customs duty calculation.": "HSN Code (Harmonized System of Nomenclature) is an international 6-to-8 digit standardized numerical code used worldwide to classify traded commodities for सीमा शुल्क calculation.",
  "Ocean Freight is the main ocean transport fee charged by shipping lines to transport containerized or bulk cargo across international sea routes.": "Ocean Freight is the main ocean transport fee charged by shipping lines to transport containerized or bulk cargo across international sea routes.",
  "Local Charges are origin and destination port handling fees charged by forwarders and port terminals (such as THC, documentation, and gate fees) outside of main ocean freight.": "Local Charges are origin and destination port handling fees charged by forwarders and port terminals (such as THC, documentation, and gate fees) outside of main ocean freight.",
  "Terminal Handling Charge (THC) is the port fee charged by terminal operators for using port cranes and equipment to load or unload containers between vessel and port yard.": "Terminal Handling Charge (THC) is the port fee charged by terminal operators for using port cranes and equipment to load or unload containers between vessel and port yard.",
  "CFS Charges are handling, de-stuffing, sorting, and ground storage fees billed by Container Freight Stations for processing LCL cargo shipments.": "CFS Charges are handling, de-stuffing, sorting, and ground storage fees billed by Container Freight Stations for processing LCL cargo shipments.",
  "DO Charges are administrative fees billed by shipping lines or forwarders for issuing the electronic Delivery Order (DO) authorizing cargo release.": "DO Charges are administrative fees billed by shipping lines or forwarders for issuing the electronic Delivery Order (DO) authorizing cargo release.",
  "Detention is a penalty fee charged by shipping lines when an importer holds an empty container outside the port beyond agreed free days (usually 7-14 days).": "Detention is a penalty fee charged by shipping lines when an importer holds an empty container outside the port beyond agreed free days (usually 7-14 days).",
  "Demurrage is a daily penalty fee charged by ports or shipping lines when a loaded container stays inside the port terminal beyond free storage days (usually 3-5 days).": "Demurrage is a daily penalty fee charged by ports or shipping lines when a loaded container stays inside the port terminal beyond free storage days (usually 3-5 days).",
  "Port Charges are statutory pilotage, berth hire, anchorage, and port entry fees levied by port trusts on vessels and cargo handling.": "Port Charges are statutory pilotage, berth hire, anchorage, and port entry fees levied by port trusts on vessels and cargo handling.",
  "Documentation Charges are administrative processing fees billed by freight forwarders or shipping lines for creating B/L, HBL, manifest filings, and EDI entries.": "Documentation Charges are administrative processing fees billed by freight forwarders or shipping lines for creating B/L, HBL, manifest filings, and EDI entries.",
  "Quality Control is operational inspection during production to detect and correct manufacturing defects.": "Quality Control is operational inspection during production to detect and correct manufacturing defects.",
  "Quality Assurance is systematic process management preventing defects prior to manufacturing.": "Quality Assurance is systematic process management preventing defects prior to manufacturing.",
  "Pre-Shipment Inspection is a final third-party factory audit verifying goods prior to balance payment and dispatch.": "Pre-Shipment Inspection is a final third-party factory audit verifying goods prior to balance payment and dispatch.",
  "Random Inspection evaluates batch quality by sampling random boxes using AQL statistical tables.": "Random Inspection evaluates batch quality by sampling random boxes using AQL statistical tables.",
  "Defect Rate measures the percentage of non-conforming units in a batch.": "Defect Rate measures the percentage of non-conforming units in a batch.",
  "Product Testing certifies safety, toxicity, and electrical standards in accredited laboratories.": "Product Testing certifies safety, toxicity, and electrical standards in accredited laboratories.",
  "Compliance is full legal, environmental, and safety adherence to destination country import laws.": "Compliance is full legal, environmental, and safety adherence to destination country import laws.",
  "Lead is an initial potential sales opportunity representing prospective buyer interest.": "Lead is an initial potential sales opportunity representing prospective buyer interest.",
  "Inquiry is a formal written request sent to suppliers detailing product requirements and quantities.": "Inquiry is a formal written request sent to suppliers detailing product requirements and quantities.",
  "Quotation is a formal price and terms proposal submitted by a supplier.": "Quotation is a formal price and terms proposal submitted by a supplier.",
  "Purchase Order is a legally binding order contract issued by buyer to supplier.": "परचेज ऑर्डर is a legally binding order contract issued by buyer to supplier.",
  "Sales Order is a seller confirmation acknowledging PO receipt and locking production scheduling.": "Sales Order is a seller confirmation acknowledging PO receipt and locking production scheduling.",
  "Follow-up is continuous production tracking ensuring manufacturing milestones stay on schedule.": "Follow-up is continuous production tracking ensuring manufacturing milestones stay on schedule.",
  "Order Confirmation is the final signed bilateral agreement triggering active manufacturing.": "Order Confirmation is the final signed bilateral agreement triggering active manufacturing.",
  "Production Timeline maps out manufacturing milestones from raw material sourcing to packing.": "Production Timeline maps out manufacturing milestones from raw material sourcing to packing.",
  "Dispatch is the physical handover of finished goods from factory to port transport.": "Dispatch is the physical handover of finished goods from factory to port transport.",
  "Delivery Confirmation is the final buyer sign-off confirming successful cargo receipt at warehouse.": "Delivery Confirmation is the final buyer sign-off confirming successful cargo receipt at warehouse.",
  "Cargo Insurance is marine policy protection covering financial loss against transit damage or theft.": "Cargo Insurance is marine policy protection covering financial loss against transit damage or theft.",
  "Force Majeure exempts contractual liability during extraordinary acts of God or uncontrollable events.": "Force Majeure exempts contractual liability during extraordinary acts of God or uncontrollable events.",
  "Delay represents transit or production schedule slowdowns extending delivery deadlines.": "Delay represents transit or production schedule slowdowns extending delivery deadlines.",
  "Damage Claim is a formal compensation claim filed for transit-damaged cargo.": "Damage Claim is a formal compensation claim filed for transit-damaged cargo.",
  "Shortage is a physical carton count discrepancy between delivered cargo and packing documents.": "Shortage is a physical carton count discrepancy between delivered cargo and packing documents.",
  "Misdeclaration is filing false values or HSN codes on customs entries leading to seizure and fines.": "Misdeclaration is filing false values or HSN codes on customs entries leading to seizure and fines.",
  "Dispute Resolution is contractual arbitration or litigation settling commercial buyer-seller conflicts.": "Dispute Resolution is contractual arbitration or litigation settling commercial buyer-seller conflicts.",
  "Inquiry Form is the internal document recording client product requirements and target pricing.": "Inquiry Form is the internal document recording client product requirements and target pricing.",
  "Product Approval is internal technical sample evaluation validating specs before mass production.": "Product Approval is internal technical sample evaluation validating specs before mass production.",
  "Quotation Approval is internal management sign-off validating landed costs and profit margins.": "Quotation Approval is internal management sign-off validating landed costs and profit margins.",
  "Purchase Process executes legally binding PO drafting and advance deposit transfers.": "Purchase Process executes legally binding PO drafting and advance deposit transfers.",
  "Payment Process audits shipping documents before releasing final vendor balance payments.": "Payment Process audits शिपिंग दस्तावेज before releasing final vendor balance payments.",
  "Production Tracking monitors factory assembly milestones to guarantee on-time completion.": "Production Tracking monitors factory assembly milestones to guarantee on-time completion.",
  "Shipment Tracking monitors real-time vessel location and container ETA milestones.": "Shipment Tracking monitors real-time vessel location and container ETA milestones.",
  "Customs Process coordinates CHA filing, duty payments, and ICEGATE clearance release.": "Customs Process coordinates CHA filing, duty payments, and ICEGATE clearance release.",
  "Warehouse Process manages container de-stuffing, box count tallying, and ERP inventory stocking.": "Warehouse Process manages container de-stuffing, box count tallying, and ERP inventory stocking.",
  "Customer Delivery Process manages final-mile truck transport, E-Way bills, and client delivery proof.": "Customer Delivery Process manages final-mile truck transport, E-Way bills, and client delivery proof.",
  "After Sales Support provides warranty service, technical spare parts, and repeat order management.": "After Sales Support provides warranty service, technical spare parts, and repeat order management.",
  "MOQ = Minimum Order Quantity": "MOQ = Minimum Order Quantity",
  "Negotiate with higher per-unit price offer": "Negotiate with higher per-unit price offer",
  "Always get MOQ confirmed in writing": "Always get MOQ confirmed in writing",
  "SKU = Stock Keeping Unit": "SKU = Stock Keeping Unit",
  "Each variant (color/size) = different SKU": "Each variant (color/size) = different SKU",
  "Create logical SKU structure": "Create logical SKU structure",
  "OEM = Buyer owns design, factory manufactures": "OEM = Buyer owns design, factory manufactures",
  "Sign NDA before sharing technical files": "Sign NDA before sharing technical files",
  "Request prototype before mass production": "બલ્ક ઉત્પાદન પહેલાં પ્રોટોટાઇપ સેમ્પલનો આગ્રહ રાખો",
  "ODM = Factory owns design, buyer brands it": "ODM = ફેક્ટરી પાસે ડિઝાઇનની માલિકી હોય છે, ખરીદદાર પોતાની બ્રાન્ડ લગાવે છે",
  "Faster and cheaper than OEM": "OEM કરતાં ઝડપી અને સસ્તું",
  "Request market exclusivity agreement": "બજારની વિશિષ્ટ માર્કેટિંગ એગ્રીમેન્ટનો આગ્રહ રાખો",
  "Private Label = Factory makes, you brand": "પ્રાઇવેટ લેબલ = ફેક્ટરી ઉત્પાદન કરે છે, તમે બ્રાન્ડ બનાવો છો",
  "Register trademark first": "પહેલાં ટ્રેડમાર્ક રજીસ્ટર કરો",
  "Invest in packaging design": "પેકિંગ ડિઝાઇનમાં રોકાણ કરો",
  "Product Spec = Legal document between buyer and factory": "પ્રોડક્ટ સ્પેક = ખરીદદાર અને ફેક્ટરી વચ્ચેનો કાનૂની દસ્તાવેજ",
  "Include dimensions, materials, certifications": "પરિમાણો, સામગ્રી અને સર્ટિફિકેશન શામેલ કરો",
  "Factory must sign before production starts": "ઉત્પાદન શરૂ થાય તે પહેલાં ફેક્ટરીએ સહી કરવી આવશ્યક છે",
  "Sample before mass production = essential": "બલ્ક ઉત્પાદન પહેલાં સેમ્પલ અત્યંત આવશ્યક છે",
  "Test functionality + dimensions + quality": "કાર્યક્ષમતા + પરિમાણો + ગુણવત્તા ચકાસો",
  "Written approval before deposit": "ડિપોઝિટ ચૂકવતા પહેલાં લેખિત મંજૂરી મેળવો",
  "Model Number = Manufacturer\\": "Model Number = Manufacturer\\",
  "Brand = Product identity and perception": "બ્રાન્ડ = પ્રોડક્ટની ઓળખ અને પ્રતિષ્ઠા",
  "Trademark registration = legal protection": "ટ્રેડમાર્ક રજીસ્ટ્રેશન = કાનૂની રક્ષણ",
  "Never import counterfeit brands": "ક્યારેય પણ બનાવટી કે નકલી બ્રાન્ડ્સ આયાત કરશો નહીં",
  "Packaging = Protection + Compliance + Presentation": "પેકિંગ = સુરક્ષા + કાયદાકીય પાલન + પ્રસ્તુતિ",
  "Specify packaging in Purchase Order": "પરચેજ ઓર્ડરમાં પેકિંગ જરૂરિયાતો સ્પષ્ટ રીતે દર્શાવો",
  "Inspect carton quality before container loading": "કન્ટેનર લોડ કરતા પહેલાં કાર્ટનની ગુણવત્તા ચકાસો"
};
const EXPLICIT_GU_MAP: Record<string, string> = {
  "Calculating profits based only on the supplier’s FOB invoice price without factoring in custom duty taxes and sea freight charges.": "કસ્ટમ્સ ડ્યુટી और समुद्री भाड़े के खर्चों को जोड़े बिना केवल सप्लायर की FOB इनवॉइस कीमत के आधार पर लाभ की गणना करना।",
  "Importing branded or regulated items without checking local quality certificates (like BIS or FDA).": "स्थानीय गुणवत्ता प्रमाणपत्र (जैसे BIS या FDA) की जांच किए बिना ब्रांडेड या विनियमित वस्तुओं का आयात करना।",
  "Using FOB for air shipments. Air shipping lines do not have a ": "हवाई माल ढुलाई (Air Cargo) के लिए FOB शर्तों का ઉપયોગ કરવો। एयरलाइंस के पास जहाजी रेल (Ship's Rail) नहीं होती, जिससे बीमा देयता में भ्रम उत्पन्न होता है।",
  "Failing to verify when the local port handling charges (THC) at origin are paid by the seller, resulting in unexpected vendor disputes.": "उत्पत्ति स्थान पर पोर्ट हैंडलिंग चार्ज (THC) विक्रेता द्वारा दिए गए हैं या नहीं, यह सत्यापित न करना जिससे विवाद होता है।",
  "Paying deposits into a personal bank account instead of a registered corporate business account.": "पंजीकृत कॉर्पोरेट व्यवसाय खाते के बजाय व्यक्तिगत बैंक खाते में जमा राशि का ચુકવણી કરવી।",
  "Relying solely on high Alibaba review ratings without checking factory compliance documents.": "फैक्ट्री अनुपालन दस्तावेजों की जांच किए बिना केवल अलीबाबा समीक्षा रेटिंग पर વિશ્વાસ રાખવો।",
  "Measuring inner box size instead of the outer master carton dimensions — outer dimensions determine actual CBM.": "मास्टर कार्टन के बाहरी आयामों के बजाय आंतरिक बॉक्स के आकार को मापना — बाहरी आयाम ही वास्तविक CBM निर्धारित करते हैं।",
  "Forgetting to convert centimeters to meters before multiplying — leads to massive calculation errors.": "गुणा करने से पहले सेंटीमीटर को मीटर में बदलना ભૂલી જવું — जिससे CBM गणना में भारी त्रुटियाँ होती हैं।",
  "Not accounting for pallet volume when goods are palletized before shipping.": "शिपिंग से पहले सामान पेलेटाइज्ड होने पर पेलेट की मात्रा (Pallet Volume) को न जोड़ना।",
  "Declaring only product weight on shipping documents instead of total Gross Weight.": "શિપિંગ દસ્તાવેજોों पर कुल ग्रॉस वेट (Gross Weight) के बजाय केवल उत्पाद का शुद्ध वजन घोषित करना।",
  "Forgetting to include pallet weights (each wooden pallet weighs 15-25 kg).": "पेलेट का वजन जोड़ना ભૂલી જવું (प्रत्येक लकड़ी के पेलेट का वजन 15-25 किग्रा होता है)।",
  "Confusing Net Weight with Gross Weight on customs declarations.": "કસ્ટમ્સ જાહેરાતओं में नेट वेट (Net Weight) और ग्रॉस वेट (Gross Weight) के बीच મૂંઝવણ અનુભવવી।",
  "Including inner retail packaging weight in Net Weight calculation.": "नेट वेट की गणना में आंतरिक खुदरा पैकेजिंग के वजन को સામેલ કરવું।",
  "Assuming air freight is charged only on scale weight without checking box dimensions.": "बॉक्स के आयामों की जांच किए बिना यह मान लेना कि एयर फ्रेट केवल वास्तविक वजन पर लिया जाता है।",
  "Using oversized boxes with empty air space, resulting in inflated volumetric freight charges.": "खाली जगह वाले बड़े डिब्बों का ઉપયોગ કરવો, जिससे वॉल्यूमेट्रिक भाड़ा खर्च बढ़ जाता है।",
  "Measuring inner dimensions instead of outer dimensions.": "बाहरी आयामों के बजाय आंतरिक आयामों को मापना।",
  "Not accounting for box bulging after packing.": "पैकिंग के बाद बक्से के फूलने (Box Bulging) का ध्यान न रखना।",
  "Using thin 3-ply cartons that collapse under heavy stacking in sea containers.": "पतले 3-प्लाई कार्टन का ઉપયોગ કરવો जो समुद्री कंटेनरों में भारी स्टेकिंग के तहत दब जाते हैं।",
  "Omitting mandatory export shipping marks on master carton walls.": "मास्टर कार्टन की दीवारों पर अनिवार्य निर्यात शिपिंग मार्किंग न छापना।",
  "Using non-treated wooden pallets resulting in customs rejection due to ISPM-15 pest regulations.": "गैर-उपचारित लकड़ी के पेलेट का ઉપયોગ કરવો, जिससे ISPM-15 कीट नियमों के तहत कस्टम्स अस्वीकृति होती है।",
  "Allowing cartons to overhang pallet edges, causing box crushing.": "कार्टन को पेलेट के किनारों से बाहर निकलने देना, जिससे डिब्बे दब जाते हैं।",
  "Focusing only on CBM volume and overloading container weight payload.": "केवल CBM वॉल्यूम पर ध्यान केंद्रित करना और कंटेनर की वजन पेलोड सीमा का ઉલ્લંઘન કરવું।",
  "Not factoring in box packing gaps when estimating CBM loading.": "CBM लोडिंग का अनुमान लगाते समय बॉक्स पैकिंग अंतराल का ગણતરી ન કરવી।",
  "Booking LCL for 20 CBM cargo when FCL 20FT is cheaper and faster.": "20 CBM कार्गो के लिए LCL बुक करना जबकि FCL 20FT सस्ता और तेज़ होता है।",
  "Not checking container inspection before loading.": "लोडिंग से पहले कंटेनर की भौतिक स्थिति की जांच न करना।",
  "Not factoring in origin/destination CFS handling charges which make large LCL shipments expensive.": "CFS हैंडलिंग शुल्कों को न जोड़ना, जिससे बड़े LCL शिपमेंट महंगे हो जाते हैं।",
  "Shipping fragile goods via LCL without extra wooden crate protection.": "अतिरिक्त लकड़ी के क्रेट सुरक्षा के बिना LCL के माध्यम से नाजुक सामान भेजना।",
  ...
  "Not checking destination warehouse door height for High Cube container clearance.": "Not checking destination warehouse door height for High Cube container clearance.",
  "Forgetting that weight limit is same as 40FT (26.5 tons).": "Forgetting that weight limit is same as 40FT (26.5 tons).",
  "Focusing only on cheap ocean freight while ignoring expensive local terminal handling surcharges.": "केवल एक पहलू पर ધ્યાન આપવું: cheap ocean freight while ignoring expensive local terminal handling surcharges.",
  "Shipping urgent time-sensitive samples via sea freight instead of air freight, causing customer delays.": "असुरक्षित तरीके से શિપિંગ કરવું: urgent time-sensitive samples via समुद्री भाड़ा instead of हवाई भाड़ा, causing customer delays.",
  "Shipping low-value heavy bulk cargo via air freight, which results in freight costs exceeding product value.": "असुरक्षित तरीके से શિપિંગ કરવું: low-value heavy bulk cargo via हवाई भाड़ा, which results in freight costs exceeding product value.",
  "Confusing Port of Loading (POL) with Port of Discharge (POD) on transport documentation.": "नियमों में મૂંઝવણ અનુભવવી: Port of Loading (POL) with Port of Discharge (POD) on transport documentation.",
  "Failing to track vessel ETA at POD, causing container to sit at port and incur expensive demurrage charges.": "ચકાસણી ન કરવી: track vessel ETA at POD, causing container to sit at port and incur expensive demurrage charges.",
  "Clearing customs at seaport when an inland ICD is available near your city, increasing double handling truck costs.": "Clearing customs at seaport when an inland ICD is available near your city, increasing double handling truck costs.",
  "Leaving LCL goods at CFS beyond free storage period, incurring heavy daily storage rent.": "Leaving LCL goods at CFS beyond free storage period, incurring heavy daily storage rent.",
  "Paying advance deposit based on an informal WeChat or email quote instead of a signed formal Proforma Invoice.": "गलत तरीके से ચુકવણી કરવી: advance deposit based on an informal WeChat or email quote instead of a signed formal Proforma Invoice.",
  "Under-declaring Commercial Invoice value to evade customs duty, which is a criminal offense leading to heavy penalties and cargo seizure.": "Under-declaring कमर्शियल इनवॉइस value to evade કસ્ટમ્સ ડ્યુટી, which is a criminal offense leading to heavy penalties and cargo seizure.",
  "Mismatched box counts or weight discrepancies between Packing List and Bill of Lading, causing customs clearance holds.": "Mismatched box counts or weight discrepancies between पैकिंग लिस्ट and बिल ऑफ लेडिंग, causing કસ્ટમ્સ ક્લિયરન્સ holds.",
  "Losing original physical Bill of Lading paper documents, which requires bank guarantees and months of delay to get container released.": "Losing original physical बिल ऑफ लेडिंग paper documents, which requires bank guarantees and months of delay to get container released.",
  "Failing to verify documentation details before shipping.": "ચકાસણી ન કરવી: verify documentation details before shipping.",
  "Failing to verify document details before submission.": "ચકાસણી ન કરવી: verify document details before submission.",
  "Failing to audit charges before approving payments.": "ચકાસણી ન કરવી: audit charges before approving payments.",
  "Skipping line inspections and relying only on final packaging checks.": "Skipping line inspections and relying only on final packaging checks.",
  "Confusing QA with QC — QA is process prevention, whereas QC is product inspection.": "नियमों में મૂંઝવણ અનુભવવી: QA with QC — QA is process prevention, whereas QC is product inspection.",
  "Releasing full payment to supplier before receiving official Pre-Shipment Inspection reports.": "Releasing full payment to supplier before receiving official Pre-Shipment Inspection reports.",
  "Allowing the factory manager to pick the sample cartons instead of the independent inspector.": "लापरवाही बरतने देना: the factory manager to pick the sample cartons instead of the independent inspector.",
  "Accepting batches with defect rates above agreed contractual AQL limits.": "Accepting batches with defect rates above agreed contractual AQL limits.",
  "Relying on expired or fake lab test certificates provided by unverified suppliers.": "केवल વિશ્વાસ રાખવો: on expired or fake lab test certificates provided by unverified suppliers.",
  "Importing goods without mandatory regional compliance marks (e.g. BIS in India, CE in EU).": "बिना आवश्यक दस्तावेज आयात करना: goods without mandatory regional compliance marks (e.g. BIS in India, CE in EU).",
  "Failing to qualify leads based on budget, quantity, and import readiness before investing time.": "ચકાસણી ન કરવી: qualify leads based on budget, quantity, and import readiness before investing time.",
  "Sending vague inquiries without exact specifications, material requirements, or target quantities.": "Sending vague inquiries without exact specifications, material requirements, or target quantities.",
  "Accepting quotations without checking validity dates or hidden packaging fees.": "Accepting quotations without checking validity dates or hidden packaging fees.",
  "Placing orders via chat messages without issuing a formal signed Purchase Order.": "Placing orders via chat messages without issuing a formal signed परचेज ऑर्डर.",
  "Assuming production has started before receiving a signed Sales Order confirmation from factory.": "गलत અંદાજ લગાવવો: production has started before receiving a signed Sales Order confirmation from factory.",
  "Waiting until the scheduled completion date to contact the factory without weekly follow-ups.": "Waiting until the scheduled completion date to contact the factory without weekly follow-ups.",
  "Wiring advance deposit before both parties have signed the Order Confirmation.": "Wiring advance deposit before both parties have signed the Order Confirmation.",
  "Not accounting for Chinese New Year or national holiday shutdowns when planning production timelines.": "लागत या नियम का ગણતરી ન કરવી: Chinese New Year or national holiday shutdowns when planning production timelines.",
  "Dispatching goods without verifying container seal numbers and truck weight bridge tickets.": "Dispatching goods without verifying container seal numbers and truck weight bridge tickets.",
  "Signing clean delivery receipts without inspecting master carton condition for water damage or crushed boxes.": "Signing clean delivery receipts without inspecting master carton condition for water damage or crushed boxes.",
  "Shipping cargo under basic carrier liability instead of comprehensive all-risk marine insurance.": "असुरक्षित तरीके से શિપિંગ કરવું: cargo under basic carrier liability instead of comprehensive all-risk marine insurance.",
  "Assuming routine raw material shortages count as valid Force Majeure events.": "गलत અંદાજ લગાવવો: routine raw material shortages count as valid Force Majeure events.",
  "Failing to include liquidated damages clauses for unexcused supplier production delays.": "ચકાસણી ન કરવી: include liquidated damages clauses for unexcused supplier production delays.",
  "Failing to notify carriers of damage within statutory time limits, invalidating insurance claims.": "ચકાસણી ન કરવી: notify carriers of damage within statutory time limits, invalidating insurance claims.",
  "Signing clean trucker delivery notes before tallying total master carton counts.": "Signing clean trucker delivery notes before tallying total master carton counts.",
  "Under-declaring Commercial Invoice value to evade customs duties.": "Under-declaring कमर्शियल इनवॉइस value to evade customs duties.",
  "Omitting governing law and arbitration jurisdiction clauses from international purchase contracts.": "अनिवार्य विवरण છોડી દેવું: governing law and arbitration jurisdiction clauses from international purchase contracts.",
  "Accepting client inquiries without specifying target delivery deadlines or quality standards.": "Accepting client inquiries without specifying target delivery deadlines or quality standards.",
  "Approving mass production based on digital photos instead of physical sample testing.": "Approving mass production based on digital photos instead of physical sample testing.",
  "Failing to include destination port handling fees in landed cost calculations prior to approval.": "ચકાસણી ન કરવી: include destination port handling fees in landed cost calculations prior to approval.",
  "Omitting quality penalty clauses from Purchase Orders during the purchasing process.": "अनिवार्य विवरण છોડી દેવું: quality penalty clauses from परचेज ऑर्डरs during the purchasing process.",
  "Releasing balance payment before verifying clean B/L issuance or inspection reports.": "Releasing balance payment before verifying clean B/L issuance or inspection reports.",
  "Failing to request weekly photo/video proof during active production cycles.": "ચકાસણી ન કરવી: request weekly photo/video proof during active production cycles.",
  "Ignoring transshipment port delay notices from ocean freight forwarders.": "Ignoring transshipment port delay notices from ocean freight forwarders.",
  "Delaying duty payment after customs assessment, accumulating daily port demurrage fees.": "Delaying duty payment after customs assessment, accumulating daily port demurrage fees.",
  "Mixing uninspected inbound cargo directly into active sellable warehouse shelves.": "Mixing uninspected inbound cargo directly into active sellable warehouse shelves.",
  "Dispatching trucks without generating mandatory GST E-Way bills for inter-state transit.": "Dispatching trucks without generating mandatory GST E-Way bills for inter-state transit.",
  ...
  "Accepting the first MOQ the supplier quotes without negotiating — always negotiate, factories expect it.": "Accepting the first MOQ the supplier quotes without negotiating — always negotiate, factories expect it.",
  "Ordering huge quantities to meet MOQ without testing product quality or market demand first.": "Ordering huge quantities to meet MOQ without testing product quality or market demand first.",
  "Confusing MOQ (units) with minimum order value (dollar amount) — always clarify which one applies.": "नियमों में મૂંઝવણ અનુભવવી: MOQ (units) with minimum order value (dollar amount) — always clarify which one applies.",
  "Using supplier model numbers as your SKU — create your own internal codes for better control.": "अनुचित तरीके से ઉપયોગ કરવો: supplier model numbers as your SKU — create your own internal codes for better control.",
  "Not assigning unique SKUs to each variant (color, size, pack quantity) leading to wrong items being shipped.": "Not assigning unique SKUs to each variant (color, size, pack quantity) leading to wrong items being shipped.",
  "Using special characters like / or spaces in SKU codes that break inventory software.": "अनुचित तरीके से ઉપયોગ કરવો: special characters like / or spaces in SKU codes that break inventory software.",
  "Sharing full product design files without signing an NDA — factories may copy your design and sell to your competitors.": "Sharing full product design files without signing an NDA — factories may copy your design and sell to your competitors.",
  "Confusing OEM with ODM — in OEM, the buyer owns the design; in ODM, the factory owns the design.": "नियमों में મૂંઝવણ અનુભવવી: OEM with ODM — in OEM, the buyer owns the design; in ODM, the factory owns the design.",
  "Not specifying all technical requirements in writing, leading to products that don\\": "Not specifying all technical requirements in writing, leading to products that don\\",
  "Assuming ODM gives you exclusive product rights — the factory can sell the same design to competitors.": "गलत અંદાજ લગાવવો: ODM gives you exclusive product rights — the factory can sell the same design to competitors.",
  "Not requesting sample testing before placing large ODM orders — factories may produce slightly different specs than shown in catalog.": "Not requesting sample testing before placing large ODM orders — factories may produce slightly different specs than shown in catalog.",
  "Skipping a brand exclusivity agreement — always ask for exclusivity in your target market.": "Skipping a brand exclusivity agreement — always ask for exclusivity in your target market.",
  "Starting private label without trademark registration — competitors can copy your brand name.": "Starting private label without trademark registration — competitors can copy your brand name.",
  "Choosing a factory solely on price without checking product quality, certifications, and compliance.": "Choosing a factory solely on price without checking product quality, certifications, and compliance.",
  "Using the factory\\": "अनुचित तरीके से ઉપયોગ કરવો: the factory\\",
  "Sending only verbal specifications to factories — always send written, signed spec sheets.": "Sending only verbal specifications to factories — always send written, signed spec sheets.",
  "Not including tolerance limits (e.g., ±2mm size tolerance) — factories interpret this as ": "Not including tolerance limits (e.g., ±2mm size tolerance) — factories interpret this as ",
  "Forgetting to specify required certifications (CE, BIS, FDA) in the product spec.": "સામેલ કરવું ભૂલી જવું: specify required certifications (CE, BIS, FDA) in the product spec.",
  "Skipping sample approval and going straight to mass production — this leads to expensive quality rejections.": "Skipping sample approval and going straight to mass production — this leads to expensive quality rejections.",
  "Approving a sample verbally instead of in writing — always send written sample approval with noted specifications.": "Approving a sample verbally instead of in writing — always send written sample approval with noted specifications.",
  "Testing only appearance and not functionality — always test the product under real-use conditions.": "Testing only appearance and not functionality — always test the product under real-use conditions.",
  "Not including model numbers on purchase orders, leading to factories shipping the wrong product version.": "Not including model numbers on परचेज ऑर्डरs, leading to factories shipping the wrong product version.",
  "Using product names instead of model numbers — names can be ambiguous, model numbers are precise.": "अनुचित तरीके से ઉપયોગ કરવો: product names instead of model numbers — names can be ambiguous, model numbers are precise.",
  "Not verifying that the model number on the packing list matches the purchase order and invoice.": "Not verifying that the model number on the पैकिंग लिस्ट matches the परचेज ऑर्डर and invoice.",
  "Importing counterfeit branded products — customs worldwide actively seize fake branded goods and impose heavy penalties.": "बिना आवश्यक दस्तावेज आयात करना: counterfeit branded products — customs worldwide actively seize fake branded goods and impose heavy penalties.",
  "Launching a brand without trademark registration — competitors can copy your brand legally.": "Launching a brand without trademark registration — competitors can copy your brand legally.",
  "Using poor quality packaging for branded products — it undermines the brand value customers perceive.": "अनुचित तरीके से ઉપયોગ કરવો: poor quality packaging for branded products — it undermines the brand value customers perceive.",
  "Using thin single-walled cartons for heavy or fragile goods in sea freight — they collapse under stack weight.": "अनुचित तरीके से ઉપયોગ કરવો: thin single-walled cartons for heavy or fragile goods in समुद्री भाड़ा — they collapse under stack weight.",
  "Not specifying carton strength requirements (ECT/burst test rating) on purchase orders.": "Not specifying carton strength requirements (ECT/burst test rating) on परचेज ऑर्डरs.",
  "Forgetting to include ": "સામેલ કરવું ભૂલી જવું: include ",
  "Failing to verify documentation details before vessel dispatch.": "ચકાસણી ન કરવી: verify documentation details before vessel dispatch.",
  "Always request product samples to verify dimensions and quality before sending deposit wire payments.": "Always request product samples to verify dimensions and quality before sending deposit wire payments.",
  "Request the supplier to provide the HSN code early to check standard custom duty rates.": "Request the supplier to provide the HSN code early to check standard custom duty rates.",
  "Always ensure your sales agreement specifies the exact port, e.g., ": "Always ensure your sales agreement specifies the exact port, e.g., ",
  "Book your own forwarder under FOB terms to maintain full control over the shipping timeline and destination clearances.": "Book your own forwarder under FOB terms to maintain full control over the shipping timeline and destination clearances.",
  ...
  "Keep one approved sample sealed in a bag — it becomes your production quality benchmark.": "Keep one approved sample sealed in a bag — it becomes your production quality benchmark.",
  "Always include the exact factory model number on your Purchase Order and Commercial Invoice.": "Always include the exact factory model number on your परचेज ऑर्डर and कमर्शियल इनवॉइस.",
  "Verify model numbers in the physical product against the shipping documents before warehouse acceptance.": "Verify model numbers in the physical product against the શિપિંગ દસ્તાવેજો before warehouse acceptance.",
  "If a factory discontinues a model, request the technical spec sheet of the replacement model before accepting it.": "If a factory discontinues a model, request the technical spec sheet of the replacement model before accepting it.",
  "Register your trademark before your first import shipment — trademark disputes are expensive to fight.": "Register your trademark before your first import shipment — trademark disputes are expensive to fight.",
  "Invest in professional logo and packaging design — it is the most visible part of your brand.": "Invest in professional logo and packaging design — it is the most visible part of your brand.",
  "Keep brand positioning consistent across all products, packaging, and marketing materials.": "Keep brand positioning consistent across all products, packaging, and marketing materials.",
  "For fragile goods (ceramics, glass, electronics), always request double-walled corrugated cartons with foam inserts.": "For fragile goods (ceramics, glass, electronics), always request double-walled corrugated cartons with foam inserts.",
  "Include packing specifications in your purchase order: carton size, weight limit, units per carton, and wall thickness.": "Include packing specifications in your परचेज ऑर्डर: carton size, weight limit, units per carton, and wall thickness.",
  "Always inspect 10% of cartons upon factory loading to verify packaging quality before the container is sealed.": "Always inspect 10% of cartons upon factory loading to verify packaging quality before the container is sealed.",
  "Consult your customs broker (CHA) before finalizing purchase contracts.": "Consult your customs broker (CHA) before finalizing purchase contracts.",
  "Custom duty rates vary by HSN code.": "Custom duty rates vary by HSN code.",
  ...
  "Verify all details on Insurance Certificate.": "Verify all details on Insurance Certificate.",
  "Verify all details on Customs.": "Verify all details on Customs.",
  "Verify all details on Customs Clearance.": "Verify all details on કસ્ટમ્સ ક્લિયરન્સ.",
  "Verify all details on CHA.": "Verify all details on CHA.",
  "Verify all details on HSN Code.": "Verify all details on HSN Code.",
  "Audit all charges for Ocean Freight.": "Audit all charges for Ocean Freight.",
  "Audit all charges for Local Charges.": "Audit all charges for Local Charges.",
  ...
  "Never import counterfeit branded products — it is illegal.": "Never import counterfeit branded products — it is illegal.",
  "Always include ": "Always include ",
  "For fragile goods, specify double-walled cartons with foam inserts.": "For fragile goods, specify double-walled cartons with foam inserts.",
  "Importing feeds domestic needs.": "बिना आवश्यक दस्तावेज आयात करना: feeds domestic needs.",
  "Check HSN details early.": "Check HSN details early.",
  "Risk transfer passes at loaded origin.": "Risk transfer passes at loaded origin.",
  "Buyer books the vessel.": "Buyer books the vessel.",
  ...
  "CFS = Container Freight Station. Customs warehouse for consolidating and sorting LCL cargo.": "CFS = Container Freight Station. Customs warehouse for consolidating and sorting LCL cargo.",
  "Proforma Invoice is a preliminary sales agreement used for advance deposit payment and LC opening.": "Proforma Invoice is a preliminary sales agreement used for advance deposit payment and LC opening.",
  "Commercial Invoice is the legal billing document for cargo valuation, customs duty calculation, and banking settlement.": "कमर्शियल इनवॉइस is the legal billing document for cargo valuation, કસ્ટમ્સ ડ્યુટી calculation, and banking settlement.",
  "Packing List details total cartons, weights (Gross/Net), dimensions (CBM), and item contents for customs verification.": "पैकिंग लिस्ट details total cartons, weights (Gross/Net), dimensions (CBM), and item contents for customs verification.",
  "Bill of Lading (B/L) is the primary document of title and ocean transport contract issued by shipping line.": "बिल ऑफ लेडिंग (B/L) is the primary document of title and ocean transport contract issued by shipping line.",
  "Courier Shipment is rapid door-to-door express parcel delivery managed by global integrators like DHL, FedEx, and UPS.": "Courier Shipment is rapid door-to-door express parcel delivery managed by global integrators like DHL, FedEx, and UPS.",
  "Transit Time is the total elapsed time in days required for cargo to travel from port of origin (POL) to port of destination (POD).": "Transit Time is the total elapsed time in days required for cargo to travel from port of origin (POL) to port of destination (POD).",
  ...
  "Mother Vessel is a large mainline ocean container ship operating on major intercontinental routes between global hub ports.": "Mother Vessel is a large mainline ocean container ship operating on major intercontinental routes between global hub ports.",
  "Feeder Vessel is a smaller regional cargo ship carrying containers between regional ports and major ocean hub ports.": "Feeder Vessel is a smaller regional cargo ship carrying containers between regional ports and major ocean hub ports.",
  "EXW (Ex Works) means seller makes goods available at factory floor. Buyer assumes 100% transport cost, risk, and customs clearance.": "EXW (Ex Works) means seller makes goods available at factory floor. Buyer assumes 100% transport cost, risk, and કસ્ટમ્સ ક્લિયરન્સ.",
  "FCA (Free Carrier) means seller delivers goods to buyer\\": "FCA (Free Carrier) means seller delivers goods to buyer\\",
  "CIF (Cost, Insurance, Freight) means seller pays ocean freight and marine insurance to destination port. Buyer pays import customs duty & port unloading.": "CIF (Cost, Insurance, Freight) means seller pays ocean freight and marine insurance to destination port. Buyer pays import કસ્ટમ્સ ડ્યુટી & port unloading.",
  "CFR (Cost and Freight) means seller pays ocean freight to destination port, but buyer purchases marine cargo insurance.": "CFR (Cost and Freight) means seller pays ocean freight to destination port, but buyer purchases marine cargo insurance.",
  "DDP (Delivered Duty Paid) means seller handles entire logistics including ocean freight, customs duty, taxes, and final door delivery. Maximum seller risk.": "DDP (Delivered Duty Paid) means seller handles entire logistics including ocean freight, કસ્ટમ્સ ડ્યુટી, taxes, and final door delivery. Maximum seller risk.",
  "DAP (Delivered At Place) means seller delivers cargo to buyer door, but buyer pays import customs duties and taxes.": "DAP (Delivered At Place) means seller delivers cargo to buyer door, but buyer pays import customs duties and taxes.",
  "CIP (Carriage and Insurance Paid to) is multimodal Incoterm where seller pays carriage + all-risk insurance to destination place.": "CIP (Carriage and Insurance Paid to) is multimodal Incoterm where seller pays carriage + all-risk insurance to destination place.",
  "CPT (Carriage Paid To) is multimodal Incoterm where seller pays main freight carriage to named destination place.": "CPT (Carriage Paid To) is multimodal Incoterm where seller pays main freight carriage to named destination place.",
  "Warehouse is a commercial facility designed for storage of raw materials, inventory management, order picking, and distribution.": "Warehouse is a commercial facility designed for storage of raw materials, inventory management, order picking, and distribution.",
  ...
  "Air Way Bill (AWB) is the official non-negotiable transport document issued by an airline for cargo transported by air, serving as a carriage contract and receipt of goods.": "Air Way Bill (AWB) is the official non-negotiable transport document issued by an airline for cargo transported by air, serving as a carriage contract and receipt of goods.",
  "Delivery Order (DO) is a release document issued by the shipping line or freight forwarder to the port terminal/CFS authorizing the surrender of cargo to the importer after freight and local charges are settled.": "Delivery Order (DO) is a release document issued by the shipping line or freight forwarder to the port terminal/CFS authorizing the surrender of cargo to the importer after freight and local charges are settled.",
  "Shipping Bill is an official export declaration document filed electronically by the exporter with Customs (via ICEGATE) to obtain \\": "असुरक्षित तरीके से શિપિંગ કરવું: Bill is an official export declaration document filed electronically by the exporter with Customs (via ICEGATE) to obtain \\",
  "Bill of Entry (BOE) is a statutory import declaration document filed by an importer/CHA with Customs (via ICEGATE) detailing imported cargo value, HSN codes, and duty calculations for clearance.": "Bill of Entry (BOE) is a statutory import declaration document filed by an importer/CHA with Customs (via ICEGATE) detailing imported cargo value, HSN codes, and duty calculations for clearance.",
  "Certificate of Origin (COO) is an official document issued by a Chamber of Commerce or government authority certifying the country where the imported product was manufactured.": "Certificate of Origin (COO) is an official document issued by a Chamber of Commerce or government authority certifying the country where the imported product was manufactured.",
  "Insurance Certificate is an official policy document issued by a marine insurance underwriter confirming that cargo is insured against loss, damage, theft, or vessel sinking during transit.": "Insurance Certificate is an official policy document issued by a marine insurance underwriter confirming that cargo is insured against loss, damage, theft, or vessel sinking during transit.",
  "Customs is the government border authority enforcing import/export trade laws, inspecting international shipments, and collecting customs duties and taxes.": "Customs is the government border authority enforcing import/export trade laws, inspecting international shipments, and collecting customs duties and taxes.",
  "Customs Clearance is the official administrative procedure of obtaining permission from customs authorities to import or export cargo across international borders.": "કસ્ટમ્સ ક્લિયરન્સ is the official administrative procedure of obtaining permission from customs authorities to import or export cargo across international borders.",
  "CHA (Customs House Agent) or Customs Broker is a licensed professional authorized by Customs to handle import/export documentation, tariff classification, and cargo clearance for trade clients.": "CHA (Customs House Agent) or Customs Broker is a licensed professional authorized by Customs to handle import/export documentation, tariff classification, and cargo clearance for trade clients.",
  "HSN Code (Harmonized System of Nomenclature) is an international 6-to-8 digit standardized numerical code used worldwide to classify traded commodities for customs duty calculation.": "HSN Code (Harmonized System of Nomenclature) is an international 6-to-8 digit standardized numerical code used worldwide to classify traded commodities for કસ્ટમ્સ ડ્યુટી calculation.",
  "Ocean Freight is the main ocean transport fee charged by shipping lines to transport containerized or bulk cargo across international sea routes.": "Ocean Freight is the main ocean transport fee charged by shipping lines to transport containerized or bulk cargo across international sea routes.",
  "Local Charges are origin and destination port handling fees charged by forwarders and port terminals (such as THC, documentation, and gate fees) outside of main ocean freight.": "Local Charges are origin and destination port handling fees charged by forwarders and port terminals (such as THC, documentation, and gate fees) outside of main ocean freight.",
  "Terminal Handling Charge (THC) is the port fee charged by terminal operators for using port cranes and equipment to load or unload containers between vessel and port yard.": "Terminal Handling Charge (THC) is the port fee charged by terminal operators for using port cranes and equipment to load or unload containers between vessel and port yard.",
  "CFS Charges are handling, de-stuffing, sorting, and ground storage fees billed by Container Freight Stations for processing LCL cargo shipments.": "CFS Charges are handling, de-stuffing, sorting, and ground storage fees billed by Container Freight Stations for processing LCL cargo shipments.",
  ...
  "Quotation Approval is internal management sign-off validating landed costs and profit margins.": "Quotation Approval is internal management sign-off validating landed costs and profit margins.",
  "Purchase Process executes legally binding PO drafting and advance deposit transfers.": "Purchase Process executes legally binding PO drafting and advance deposit transfers.",
  "Payment Process audits shipping documents before releasing final vendor balance payments.": "Payment Process audits શિપિંગ દસ્તાવેજો before releasing final vendor balance payments.",
  "Production Tracking monitors factory assembly milestones to guarantee on-time completion.": "Production Tracking monitors factory assembly milestones to guarantee on-time completion.",
  "Shipment Tracking monitors real-time vessel location and container ETA milestones.": "Shipment Tracking monitors real-time vessel location and container ETA milestones.",
  "Customs Process coordinates CHA filing, duty payments, and ICEGATE clearance release.": "Customs Process coordinates CHA filing, duty payments, and ICEGATE clearance release.",
  "Warehouse Process manages container de-stuffing, box count tallying, and ERP inventory stocking.": "Warehouse Process manages container de-stuffing, box count tallying, and ERP inventory stocking.",
...
const EXPLICIT_MR_MAP: Record<string, string> = {
  "Calculating profits based only on the supplier’s FOB invoice price without factoring in custom duty taxes and sea freight charges.": "सीमा शुल्क और समुद्री भाड़े के खर्चों को जोड़े बिना केवल सप्लायर की FOB इनवॉइस कीमत के आधार पर लाभ की गणना करना।",
  "Importing branded or regulated items without checking local quality certificates (like BIS or FDA).": "स्थानीय गुणवत्ता प्रमाणपत्र (जैसे BIS या FDA) की जांच किए बिना ब्रांडेड या विनियमित वस्तुओं का आयात करना।",
  "Using FOB for air shipments. Air shipping lines do not have a ": "हवाई माल ढुलाई (Air Cargo) के लिए FOB शर्तों का वापर करणे। एयरलाइंस के पास जहाजी रेल (Ship's Rail) नहीं होती, जिससे बीमा देयता में भ्रम उत्पन्न होता है।",
  "Failing to verify when the local port handling charges (THC) at origin are paid by the seller, resulting in unexpected vendor disputes.": "उत्पत्ति स्थान पर पोर्ट हैंडलिंग चार्ज (THC) विक्रेता द्वारा दिए गए हैं या नहीं, यह सत्यापित न करना जिससे विवाद होता है।",
  "Paying deposits into a personal bank account instead of a registered corporate business account.": "पंजीकृत कॉर्पोरेट व्यवसाय खाते के बजाय व्यक्तिगत बैंक खाते में जमा राशि का पैसे भरणे।",
  "Relying solely on high Alibaba review ratings without checking factory compliance documents.": "फैक्ट्री अनुपालन दस्तावेजों की जांच किए बिना केवल अलीबाबा समीक्षा रेटिंग पर विश्वास ठेवणे।",
  "Measuring inner box size instead of the outer master carton dimensions — outer dimensions determine actual CBM.": "मास्टर कार्टन के बाहरी आयामों के बजाय आंतरिक बॉक्स के आकार को मापना — बाहरी आयाम ही वास्तविक CBM निर्धारित करते हैं।",
  "Forgetting to convert centimeters to meters before multiplying — leads to massive calculation errors.": "गुणा करने से पहले सेंटीमीटर को मीटर में बदलना विसरणे — जिससे CBM गणना में भारी त्रुटियाँ होती हैं।",
  "Not accounting for pallet volume when goods are palletized before shipping.": "शिपिंग से पहले सामान पेलेटाइज्ड होने पर पेलेट की मात्रा (Pallet Volume) को न जोड़ना।",
  "Declaring only product weight on shipping documents instead of total Gross Weight.": "शिपिंग दस्तऐवजों पर कुल ग्रॉस वेट (Gross Weight) के बजाय केवल उत्पाद का शुद्ध वजन घोषित करना।",
  "Forgetting to include pallet weights (each wooden pallet weighs 15-25 kg).": "पेलेट का वजन जोड़ना विसरणे (प्रत्येक लकड़ी के पेलेट का वजन 15-25 किग्रा होता है)।",
  "Confusing Net Weight with Gross Weight on customs declarations.": "कस्टम्स घोषणाओं में नेट वेट (Net Weight) और ग्रॉस वेट (Gross Weight) के बीच गोंधळणे।",
  "Including inner retail packaging weight in Net Weight calculation.": "नेट वेट की गणना में आंतरिक खुदरा पैकेजिंग के वजन को समाविष्ट करणे।",
  "Assuming air freight is charged only on scale weight without checking box dimensions.": "बॉक्स के आयामों की जांच किए बिना यह मान लेना कि एयर फ्रेट केवल वास्तविक वजन पर लिया जाता है।",
  "Using oversized boxes with empty air space, resulting in inflated volumetric freight charges.": "खाली जगह वाले बड़े डिब्बों का वापर करणे, जिससे वॉल्यूमेट्रिक भाड़ा खर्च बढ़ जाता है।",
  "Measuring inner dimensions instead of outer dimensions.": "बाहरी आयामों के बजाय आंतरिक आयामों को मापना।",
  "Not accounting for box bulging after packing.": "पैकिंग के बाद बक्से के फूलने (Box Bulging) का ध्यान न रखना।",
  "Using thin 3-ply cartons that collapse under heavy stacking in sea containers.": "पतले 3-प्लाई कार्टन का वापर करणे जो समुद्री कंटेनरों में भारी स्टेकिंग के तहत दब जाते हैं।",
  "Omitting mandatory export shipping marks on master carton walls.": "मास्टर कार्टन की दीवारों पर अनिवार्य निर्यात शिपिंग मार्किंग न छापना।",
  "Using non-treated wooden pallets resulting in customs rejection due to ISPM-15 pest regulations.": "गैर-उपचारित लकड़ी के पेलेट का वापर करणे, जिससे ISPM-15 कीट नियमों के तहत कस्टम्स अस्वीकृति होती है।",
  "Allowing cartons to overhang pallet edges, causing box crushing.": "कार्टन को पेलेट के किनारों से बाहर निकलने देना, जिससे डिब्बे दब जाते हैं।",
  "Focusing only on CBM volume and overloading container weight payload.": "केवल CBM वॉल्यूम पर ध्यान केंद्रित करना और कंटेनर की वजन पेलोड सीमा का उल्लंघन करणे।",
  "Not factoring in box packing gaps when estimating CBM loading.": "CBM लोडिंग का अनुमान लगाते समय बॉक्स पैकिंग अंतराल का हिशोब न ठेवणे।",
  "Booking LCL for 20 CBM cargo when FCL 20FT is cheaper and faster.": "20 CBM कार्गो के लिए LCL बुक करना जबकि FCL 20FT सस्ता और तेज़ होता है।",
  "Not checking container inspection before loading.": "लोडिंग से पहले कंटेनर की भौतिक स्थिति की जांच न करना।",
  "Not factoring in origin/destination CFS handling charges which make large LCL shipments expensive.": "CFS हैंडलिंग शुल्कों को न जोड़ना, जिससे बड़े LCL शिपमेंट महंगे हो जाते हैं।",
  "Shipping fragile goods via LCL without extra wooden crate protection.": "अतिरिक्त लकड़ी के क्रेट सुरक्षा के बिना LCL के माध्यम से नाजुक सामान भेजना।",
  ...
  "Not checking destination warehouse door height for High Cube container clearance.": "Not checking destination warehouse door height for High Cube container clearance.",
  "Forgetting that weight limit is same as 40FT (26.5 tons).": "Forgetting that weight limit is same as 40FT (26.5 tons).",
  "Focusing only on cheap ocean freight while ignoring expensive local terminal handling surcharges.": "केवल एक पहलू पर लक्ष देणे: cheap ocean freight while ignoring expensive local terminal handling surcharges.",
  "Shipping urgent time-sensitive samples via sea freight instead of air freight, causing customer delays.": "असुरक्षित तरीके से शिपिंग करणे: urgent time-sensitive samples via समुद्री भाड़ा instead of हवाई भाड़ा, causing customer delays.",
  "Shipping low-value heavy bulk cargo via air freight, which results in freight costs exceeding product value.": "असुरक्षित तरीके से शिपिंग करणे: low-value heavy bulk cargo via हवाई भाड़ा, which results in freight costs exceeding product value.",
  "Confusing Port of Loading (POL) with Port of Discharge (POD) on transport documentation.": "नियमों में गोंधळणे: Port of Loading (POL) with Port of Discharge (POD) on transport documentation.",
  "Failing to track vessel ETA at POD, causing container to sit at port and incur expensive demurrage charges.": "पडताळणी न करणे: track vessel ETA at POD, causing container to sit at port and incur expensive demurrage charges.",
  "Clearing customs at seaport when an inland ICD is available near your city, increasing double handling truck costs.": "Clearing customs at seaport when an inland ICD is available near your city, increasing double handling truck costs.",
  "Leaving LCL goods at CFS beyond free storage period, incurring heavy daily storage rent.": "Leaving LCL goods at CFS beyond free storage period, incurring heavy daily storage rent.",
  "Paying advance deposit based on an informal WeChat or email quote instead of a signed formal Proforma Invoice.": "गलत तरीके से पैसे भरणे: advance deposit based on an informal WeChat or email quote instead of a signed formal Proforma Invoice.",
  "Under-declaring Commercial Invoice value to evade customs duty, which is a criminal offense leading to heavy penalties and cargo seizure.": "Under-declaring कमर्शियल इनवॉइस value to evade सीमा शुल्क, which is a criminal offense leading to heavy penalties and cargo seizure.",
  "Mismatched box counts or weight discrepancies between Packing List and Bill of Lading, causing customs clearance holds.": "Mismatched box counts or weight discrepancies between पैकिंग लिस्ट and बिल ऑफ लेडिंग, causing कस्टम्स क्लिअरन्स holds.",
  "Losing original physical Bill of Lading paper documents, which requires bank guarantees and months of delay to get container released.": "Losing original physical बिल ऑफ लेडिंग paper documents, which requires bank guarantees and months of delay to get container released.",
  "Failing to verify documentation details before shipping.": "पडताळणी न करणे: verify documentation details before shipping.",
  "Failing to verify document details before submission.": "पडताळणी न करणे: verify document details before submission.",
  "Failing to audit charges before approving payments.": "पडताळणी न करणे: audit charges before approving payments.",
  "Skipping line inspections and relying only on final packaging checks.": "Skipping line inspections and relying only on final packaging checks.",
  "Confusing QA with QC — QA is process prevention, whereas QC is product inspection.": "नियमों में गोंधळणे: QA with QC — QA is process prevention, whereas QC is product inspection.",
  "Releasing full payment to supplier before receiving official Pre-Shipment Inspection reports.": "Releasing full payment to supplier before receiving official Pre-Shipment Inspection reports.",
  "Allowing the factory manager to pick the sample cartons instead of the independent inspector.": "लापरवाही बरतने देना: the factory manager to pick the sample cartons instead of the independent inspector.",
  "Accepting batches with defect rates above agreed contractual AQL limits.": "Accepting batches with defect rates above agreed contractual AQL limits.",
  "Relying on expired or fake lab test certificates provided by unverified suppliers.": "केवल विश्वास ठेवणे: on expired or fake lab test certificates provided by unverified suppliers.",
  "Importing goods without mandatory regional compliance marks (e.g. BIS in India, CE in EU).": "बिना आवश्यक दस्तावेज आयात करना: goods without mandatory regional compliance marks (e.g. BIS in India, CE in EU).",
  "Failing to qualify leads based on budget, quantity, and import readiness before investing time.": "पडताळणी न करणे: qualify leads based on budget, quantity, and import readiness before investing time.",
  "Sending vague inquiries without exact specifications, material requirements, or target quantities.": "Sending vague inquiries without exact specifications, material requirements, or target quantities.",
  "Accepting quotations without checking validity dates or hidden packaging fees.": "Accepting quotations without checking validity dates or hidden packaging fees.",
  "Placing orders via chat messages without issuing a formal signed Purchase Order.": "Placing orders via chat messages without issuing a formal signed परचेज ऑर्डर.",
  "Assuming production has started before receiving a signed Sales Order confirmation from factory.": "गलत अंदाज लावणे: production has started before receiving a signed Sales Order confirmation from factory.",
  "Waiting until the scheduled completion date to contact the factory without weekly follow-ups.": "Waiting until the scheduled completion date to contact the factory without weekly follow-ups.",
  "Wiring advance deposit before both parties have signed the Order Confirmation.": "Wiring advance deposit before both parties have signed the Order Confirmation.",
  "Not accounting for Chinese New Year or national holiday shutdowns when planning production timelines.": "लागत या नियम का हिशोब न ठेवणे: Chinese New Year or national holiday shutdowns when planning production timelines.",
  "Dispatching goods without verifying container seal numbers and truck weight bridge tickets.": "Dispatching goods without verifying container seal numbers and truck weight bridge tickets.",
  "Signing clean delivery receipts without inspecting master carton condition for water damage or crushed boxes.": "Signing clean delivery receipts without inspecting master carton condition for water damage or crushed boxes.",
  "Shipping cargo under basic carrier liability instead of comprehensive all-risk marine insurance.": "असुरक्षित तरीके से शिपिंग करणे: cargo under basic carrier liability instead of comprehensive all-risk marine insurance.",
  "Assuming routine raw material shortages count as valid Force Majeure events.": "गलत अंदाज लावणे: routine raw material shortages count as valid Force Majeure events.",
  "Failing to include liquidated damages clauses for unexcused supplier production delays.": "पडताळणी न करणे: include liquidated damages clauses for unexcused supplier production delays.",
  "Failing to notify carriers of damage within statutory time limits, invalidating insurance claims.": "पडताळणी न करणे: notify carriers of damage within statutory time limits, invalidating insurance claims.",
  "Signing clean trucker delivery notes before tallying total master carton counts.": "Signing clean trucker delivery notes before tallying total master carton counts.",
  "Under-declaring Commercial Invoice value to evade customs duties.": "Under-declaring कमर्शियल इनवॉइस value to evade customs duties.",
  "Omitting governing law and arbitration jurisdiction clauses from international purchase contracts.": "अनिवार्य विवरण सोडून देणे: governing law and arbitration jurisdiction clauses from international purchase contracts.",
  "Accepting client inquiries without specifying target delivery deadlines or quality standards.": "Accepting client inquiries without specifying target delivery deadlines or quality standards.",
  "Approving mass production based on digital photos instead of physical sample testing.": "Approving mass production based on digital photos instead of physical sample testing.",
  "Failing to include destination port handling fees in landed cost calculations prior to approval.": "पडताळणी न करणे: include destination port handling fees in landed cost calculations prior to approval.",
  "Omitting quality penalty clauses from Purchase Orders during the purchasing process.": "अनिवार्य विवरण सोडून देणे: quality penalty clauses from परचेज ऑर्डरs during the purchasing process.",
  "Releasing balance payment before verifying clean B/L issuance or inspection reports.": "Releasing balance payment before verifying clean B/L issuance or inspection reports.",
  "Failing to request weekly photo/video proof during active production cycles.": "पडताळणी न करणे: request weekly photo/video proof during active production cycles.",
  "Ignoring transshipment port delay notices from ocean freight forwarders.": "Ignoring transshipment port delay notices from ocean freight forwarders.",
  "Delaying duty payment after customs assessment, accumulating daily port demurrage fees.": "Delaying duty payment after customs assessment, accumulating daily port demurrage fees.",
  "Mixing uninspected inbound cargo directly into active sellable warehouse shelves.": "Mixing uninspected inbound cargo directly into active sellable warehouse shelves.",
  "Dispatching trucks without generating mandatory GST E-Way bills for inter-state transit.": "Dispatching trucks without generating mandatory GST E-Way bills for inter-state transit.",
  ...
  "Accepting the first MOQ the supplier quotes without negotiating — always negotiate, factories expect it.": "Accepting the first MOQ the supplier quotes without negotiating — always negotiate, factories expect it.",
  "Ordering huge quantities to meet MOQ without testing product quality or market demand first.": "Ordering huge quantities to meet MOQ without testing product quality or market demand first.",
  "Confusing MOQ (units) with minimum order value (dollar amount) — always clarify which one applies.": "नियमों में गोंधळणे: MOQ (units) with minimum order value (dollar amount) — always clarify which one applies.",
  "Using supplier model numbers as your SKU — create your own internal codes for better control.": "अनुचित तरीके से वापर करणे: supplier model numbers as your SKU — create your own internal codes for better control.",
  "Not assigning unique SKUs to each variant (color, size, pack quantity) leading to wrong items being shipped.": "Not assigning unique SKUs to each variant (color, size, pack quantity) leading to wrong items being shipped.",
  "Using special characters like / or spaces in SKU codes that break inventory software.": "अनुचित तरीके से वापर करणे: special characters like / or spaces in SKU codes that break inventory software.",
  "Sharing full product design files without signing an NDA — factories may copy your design and sell to your competitors.": "Sharing full product design files without signing an NDA — factories may copy your design and sell to your competitors.",
  "Confusing OEM with ODM — in OEM, the buyer owns the design; in ODM, the factory owns the design.": "नियमों में गोंधळणे: OEM with ODM — in OEM, the buyer owns the design; in ODM, the factory owns the design.",
  "Not specifying all technical requirements in writing, leading to products that don\\": "Not specifying all technical requirements in writing, leading to products that don\\",
  "Assuming ODM gives you exclusive product rights — the factory can sell the same design to competitors.": "गलत अंदाज लावणे: ODM gives you exclusive product rights — the factory can sell the same design to competitors.",
  "Not requesting sample testing before placing large ODM orders — factories may produce slightly different specs than shown in catalog.": "Not requesting sample testing before placing large ODM orders — factories may produce slightly different specs than shown in catalog.",
  "Skipping a brand exclusivity agreement — always ask for exclusivity in your target market.": "Skipping a brand exclusivity agreement — always ask for exclusivity in your target market.",
  "Starting private label without trademark registration — competitors can copy your brand name.": "Starting private label without trademark registration — competitors can copy your brand name.",
  "Choosing a factory solely on price without checking product quality, certifications, and compliance.": "Choosing a factory solely on price without checking product quality, certifications, and compliance.",
  "Using the factory\\": "अनुचित तरीके से वापर करणे: the factory\\",
  "Sending only verbal specifications to factories — always send written, signed spec sheets.": "Sending only verbal specifications to factories — always send written, signed spec sheets.",
  "Not including tolerance limits (e.g., ±2mm size tolerance) — factories interpret this as ": "Not including tolerance limits (e.g., ±2mm size tolerance) — factories interpret this as ",
  "Forgetting to specify required certifications (CE, BIS, FDA) in the product spec.": "समाविष्ट करणे विसरणे: specify required certifications (CE, BIS, FDA) in the product spec.",
  "Skipping sample approval and going straight to mass production — this leads to expensive quality rejections.": "Skipping sample approval and going straight to mass production — this leads to expensive quality rejections.",
  "Approving a sample verbally instead of in writing — always send written sample approval with noted specifications.": "Approving a sample verbally instead of in writing — always send written sample approval with noted specifications.",
  "Testing only appearance and not functionality — always test the product under real-use conditions.": "Testing only appearance and not functionality — always test the product under real-use conditions.",
  "Not including model numbers on purchase orders, leading to factories shipping the wrong product version.": "Not including model numbers on परचेज ऑर्डरs, leading to factories shipping the wrong product version.",
  "Using product names instead of model numbers — names can be ambiguous, model numbers are precise.": "अनुचित तरीके से वापर करणे: product names instead of model numbers — names can be ambiguous, model numbers are precise.",
  "Not verifying that the model number on the packing list matches the purchase order and invoice.": "Not verifying that the model number on the पैकिंग लिस्ट matches the परचेज ऑर्डर and invoice.",
  "Importing counterfeit branded products — customs worldwide actively seize fake branded goods and impose heavy penalties.": "बिना आवश्यक दस्तावेज आयात करना: counterfeit branded products — customs worldwide actively seize fake branded goods and impose heavy penalties.",
  "Launching a brand without trademark registration — competitors can copy your brand legally.": "Launching a brand without trademark registration — competitors can copy your brand legally.",
  "Using poor quality packaging for branded products — it undermines the brand value customers perceive.": "अनुचित तरीके से वापर करणे: poor quality packaging for branded products — it undermines the brand value customers perceive.",
  "Using thin single-walled cartons for heavy or fragile goods in sea freight — they collapse under stack weight.": "अनुचित तरीके से वापर करणे: thin single-walled cartons for heavy or fragile goods in समुद्री भाड़ा — they collapse under stack weight.",
  "Not specifying carton strength requirements (ECT/burst test rating) on purchase orders.": "Not specifying carton strength requirements (ECT/burst test rating) on परचेज ऑर्डरs.",
  "Forgetting to include ": "समाविष्ट करणे विसरणे: include ",
  "Failing to verify documentation details before vessel dispatch.": "पडताळणी न करणे: verify documentation details before vessel dispatch.",
  "Always request product samples to verify dimensions and quality before sending deposit wire payments.": "Always request product samples to verify dimensions and quality before sending deposit wire payments.",
  "Request the supplier to provide the HSN code early to check standard custom duty rates.": "Request the supplier to provide the HSN code early to check standard custom duty rates.",
  "Always ensure your sales agreement specifies the exact port, e.g., ": "Always ensure your sales agreement specifies the exact port, e.g., ",
  "Book your own forwarder under FOB terms to maintain full control over the shipping timeline and destination clearances.": "Book your own forwarder under FOB terms to maintain full control over the shipping timeline and destination clearances.",
  ...
  "Keep one approved sample sealed in a bag — it becomes your production quality benchmark.": "Keep one approved sample sealed in a bag — it becomes your production quality benchmark.",
  "Always include the exact factory model number on your Purchase Order and Commercial Invoice.": "Always include the exact factory model number on your परचेज ऑर्डर and कमर्शियल इनवॉइस.",
  "Verify model numbers in the physical product against the shipping documents before warehouse acceptance.": "Verify model numbers in the physical product against the शिपिंग दस्तऐवज before warehouse acceptance.",
  "If a factory discontinues a model, request the technical spec sheet of the replacement model before accepting it.": "If a factory discontinues a model, request the technical spec sheet of the replacement model before accepting it.",
  "Register your trademark before your first import shipment — trademark disputes are expensive to fight.": "Register your trademark before your first import shipment — trademark disputes are expensive to fight.",
  "Invest in professional logo and packaging design — it is the most visible part of your brand.": "Invest in professional logo and packaging design — it is the most visible part of your brand.",
  "Keep brand positioning consistent across all products, packaging, and marketing materials.": "Keep brand positioning consistent across all products, packaging, and marketing materials.",
  ...
  "Verify all details on Insurance Certificate.": "Verify all details on Insurance Certificate.",
  "Verify all details on Customs.": "Verify all details on Customs.",
  "Verify all details on Customs Clearance.": "Verify all details on कस्टम्स क्लिअरन्स.",
  "Verify all details on CHA.": "Verify all details on CHA.",
  "Verify all details on HSN Code.": "Verify all details on HSN Code.",
  "Audit all charges for Ocean Freight.": "Audit all charges for Ocean Freight.",
  "Audit all charges for Local Charges.": "Audit all charges for Local Charges.",
  ...
  "Mother Vessel is a large mainline ocean container ship operating on major intercontinental routes between global hub ports.": "Mother Vessel is a large mainline ocean container ship operating on major intercontinental routes between global hub ports.",
  "Feeder Vessel is a smaller regional cargo ship carrying containers between regional ports and major ocean hub ports.": "Feeder Vessel is a smaller regional cargo ship carrying containers between regional ports and major ocean hub ports.",
  "EXW (Ex Works) means seller makes goods available at factory floor. Buyer assumes 100% transport cost, risk, and customs clearance.": "EXW (Ex Works) means seller makes goods available at factory floor. Buyer assumes 100% transport cost, risk, and कस्टम्स क्लिअरन्स.",
  "FCA (Free Carrier) means seller delivers goods to buyer\\": "FCA (Free Carrier) means seller delivers goods to buyer\\",
  "CIF (Cost, Insurance, Freight) means seller pays ocean freight and marine insurance to destination port. Buyer pays import customs duty & port unloading.": "CIF (Cost, Insurance, Freight) means seller pays ocean freight and marine insurance to destination port. Buyer pays import सीमा शुल्क & port unloading.",
  "CFR (Cost and Freight) means seller pays ocean freight to destination port, but buyer purchases marine cargo insurance.": "CFR (Cost and Freight) means seller pays ocean freight to destination port, but buyer purchases marine cargo insurance.",
  "DDP (Delivered Duty Paid) means seller handles entire logistics including ocean freight, customs duty, taxes, and final door delivery. Maximum seller risk.": "DDP (Delivered Duty Paid) means seller handles entire logistics including ocean freight, सीमा शुल्क, taxes, and final door delivery. Maximum seller risk.",
  ...
  "Air Way Bill (AWB) is the official non-negotiable transport document issued by an airline for cargo transported by air, serving as a carriage contract and receipt of goods.": "Air Way Bill (AWB) is the official non-negotiable transport document issued by an airline for cargo transported by air, serving as a carriage contract and receipt of goods.",
  "Delivery Order (DO) is a release document issued by the shipping line or freight forwarder to the port terminal/CFS authorizing the surrender of cargo to the importer after freight and local charges are settled.": "Delivery Order (DO) is a release document issued by the shipping line or freight forwarder to the port terminal/CFS authorizing the surrender of cargo to the importer after freight and local charges are settled.",
  "Shipping Bill is an official export declaration document filed electronically by the exporter with Customs (via ICEGATE) to obtain \\": "असुरक्षित तरीके से शिपिंग करणे: Bill is an official export declaration document filed electronically by the exporter with Customs (via ICEGATE) to obtain \\",
  "Bill of Entry (BOE) is a statutory import declaration document filed by an importer/CHA with Customs (via ICEGATE) detailing imported cargo value, HSN codes, and duty calculations for clearance.": "Bill of Entry (BOE) is a statutory import declaration document filed by an importer/CHA with Customs (via ICEGATE) detailing imported cargo value, HSN codes, and duty calculations for clearance.",
  "Certificate of Origin (COO) is an official document issued by a Chamber of Commerce or government authority certifying the country where the imported product was manufactured.": "Certificate of Origin (COO) is an official document issued by a Chamber of Commerce or government authority certifying the country where the imported product was manufactured.",
  "Insurance Certificate is an official policy document issued by a marine insurance underwriter confirming that cargo is insured against loss, damage, theft, or vessel sinking during transit.": "Insurance Certificate is an official policy document issued by a marine insurance underwriter confirming that cargo is insured against loss, damage, theft, or vessel sinking during transit.",
  "Customs is the government border authority enforcing import/export trade laws, inspecting international shipments, and collecting customs duties and taxes.": "Customs is the government border authority enforcing import/export trade laws, inspecting international shipments, and collecting customs duties and taxes.",
  "Customs Clearance is the official administrative procedure of obtaining permission from customs authorities to import or export cargo across international borders.": "कस्टम्स क्लिअरन्स is the official administrative procedure of obtaining permission from customs authorities to import or export cargo across international borders.",
  "CHA (Customs House Agent) or Customs Broker is a licensed professional authorized by Customs to handle import/export documentation, tariff classification, and cargo clearance for trade clients.": "CHA (Customs House Agent) or Customs Broker is a licensed professional authorized by Customs to handle import/export documentation, tariff classification, and cargo clearance for trade clients.",
  "HSN Code (Harmonized System of Nomenclature) is an international 6-to-8 digit standardized numerical code used worldwide to classify traded commodities for customs duty calculation.": "HSN Code (Harmonized System of Nomenclature) is an international 6-to-8 digit standardized numerical code used worldwide to classify traded commodities for सीमा शुल्क calculation.",
  "Ocean Freight is the main ocean transport fee charged by shipping lines to transport containerized or bulk cargo across international sea routes.": "Ocean Freight is the main ocean transport fee charged by shipping lines to transport containerized or bulk cargo across international sea routes.",
  "Local Charges are origin and destination port handling fees charged by forwarders and port terminals (such as THC, documentation, and gate fees) outside of main ocean freight.": "Local Charges are origin and destination port handling fees charged by forwarders and port terminals (such as THC, documentation, and gate fees) outside of main ocean freight.",
  ...
  "Quotation Approval is internal management sign-off validating landed costs and profit margins.": "Quotation Approval is internal management sign-off validating landed costs and profit margins.",
  "Purchase Process executes legally binding PO drafting and advance deposit transfers.": "Purchase Process executes legally binding PO drafting and advance deposit transfers.",
  "Payment Process audits shipping documents before releasing final vendor balance payments.": "Payment Process audits शिपिंग दस्तऐवज before releasing final vendor balance payments.",
  "Production Tracking monitors factory assembly milestones to guarantee on-time completion.": "Production Tracking monitors factory assembly milestones to guarantee on-time completion.",
  "Shipment Tracking monitors real-time vessel location and container ETA milestones.": "Shipment Tracking monitors real-time vessel location and container ETA milestones.",
  "Customs Process coordinates CHA filing, duty payments, and ICEGATE clearance release.": "Customs Process coordinates CHA filing, duty payments, and ICEGATE clearance release.",
  "Warehouse Process manages container de-stuffing, box count tallying, and ERP inventory stocking.": "Warehouse Process manages container de-stuffing, box count tallying, and ERP inventory stocking.",
...
export const translateDynamicContent = (
  ...
  if (lang === 'gu') {
    if (EXPLICIT_GU_MAP[text] && !/[a-zA-Z]{3,}/.test(EXPLICIT_GU_MAP[text])) return EXPLICIT_GU_MAP[text];
        ...
        translatedQuiz = lesson.content.quiz.map((q: any) => {
          ...
          if (q.question.includes('Correctly understanding')) {
            ...
            if (lang === 'hi') {
              ...
              translatedOptions = [
                'शिपिंग लाइनों से स्वचालित माल ढुलाई दर छूट और प्राथमिकता टर्मिनल हैंडलिंग अनुमति प्राप्त करना।',
                'आयातकों को भारी बंदरगाह विलंब शुल्क (डेमरेज), कंटेनर डिटेंशन और सीमा शुल्क जुर्माना देना।',
                'अनिवार्य बंदरगाह कार्गो सुरक्षा जांच और स्वचालित सीमा शुल्क प्रविष्टि घोषणाओं को बायपास करना।',
                'समग्र समुद्री पारगमन यात्रा समय-सारणी को कम करना और गारंटीकृत मुफ्त गंतव्य भंडारण प्राप्त करना।'
              ];
              ...
              translatedOptions = [
                'શિપિંગ લાઇનો પાસેથી આપમેળે ફ્રેઇટ રેટ ડિસ્કાઉન્ટ અને પ્રાથમિકતા ટર્મિનલ મંજૂરી મેળવવી.',
                'આયાતકારોને ભારે પોર્ટ ડેમરેજ, કન્ટેનર ડિટેન્શન અને કસ્ટમ્સ દંડનો સામનો કરવો પડે છે.',
                'ફરજિયાત પોર્ટ કાર્ગો સુરક્ષા તપાસ અને સ્વચાલિત કસ્ટમ્સ પ્રવેશ ઘોષણાઓને બાયપાસ કરવી.',
                'એકંદર દરિયાઈ પરિવહન પ્રવાસના સમયપત્રકને ઘટાડવું અને ગેરંટીયુક્ત મફત ડેસ્ટિનેશન સ્ટોરેજ મેળવવું.'
              ];
              ...
              translatedOptions = [
                'शिपिंग लाइन्सकडून स्वयंचलित मालवाहतूक दर सवलत आणि प्राधान्य टर्मिनल मंजुरी मिळणे.',
                'आयातदारांना मोठा पोर्ट ડેમરેજ, कंटेनर डिटेंशन आणि सीमा शुल्क दंड शुल्क भरावा लागणे.',
                'अनिवार्य पोर्ट कार्गो सुरक्षा तपासणी आणि स्वयंचलित सीमा शुल्क नोंदणी घोषणा बायपास करणे.',
                'एकूण सागरी प्रवास वेळ वेळापत्रक कमी करणे आणि हमी दिलेली मोफत गंतव्य साठवणूक मिळवणे.'
              ];
              ...
              translatedQuestion = `What is a common risk or mistake associated with mishandling ${cleanTitle}?`;
              translatedOptions = [
                'Receiving automatic ocean freight rate discounts and priority terminal handling clearance.',
                'Importers incurring heavy port demurrage, container detention, and customs penalty charges.',
                'Bypassing mandatory port cargo security checks and automated customs entry declarations.',
                'Reducing overall ocean transit travel schedules and securing guaranteed free destination storage.'
              ];
              translatedExplanation = `Mishandling ${cleanTitle} often leads to severe customs inspection delays and heavy port demurrage penalties.`;
            }
          }
