...
export const translateDynamicContent = (
  ...
  if (lang === 'hi') {
    translated = translated
      // SKU & General Lesson Content Translations
      .replaceAll('Every product variant must have its own unique SKU.', 'प्रत्येक उत्पाद संस्करण (Product Variant) का अपना विशिष्ट SKU होना अनिवार्य है।')
      .replaceAll('Keep SKU consistent across invoice, packing list, and warehouse label.', 'इनवॉइस, पैकिंग लिस्ट और वेयरहाउस लेबल पर SKU हमेशा एक समान रखें।')
      .replaceAll('Using supplier model numbers as your SKU — create your own internal codes for better control.', 'सप्लायर मॉडल नंबर का SKU के रूप में उपयोग करना — बेहतर नियंत्रण के लिए अपने आंतरिक कोड बनाएं।')
      .replaceAll('Not assigning unique SKUs to each variant (color, size, pack quantity) leading to wrong items being shipped.', 'प्रत्येक संस्करण (रंग, आकार, पैक मात्रा) को विशिष्ट SKU न देना जिससे गलत सामान शिप हो जाता है।')
      .replaceAll('Using special characters like / or spaces in SKU codes that break inventory software.', 'SKU कोड में / या स्पेस जैसे विशेष वर्णों का उपयोग करना जिससे इन्वेंट्री सॉफ्टवेयर में त्रुटि आती है।')
      .replaceAll('Build your SKU with a logical structure: CATEGORY-COLOR-SIZE (e.g., BAG-BLK-LRG).', 'अपने SKU को एक तार्किक संरचना के साथ बनाएं: श्रेणी-रंग-आकार (जैसे, BAG-BLK-LRG)।')
      .replaceAll('SKU (Stock Keeping Unit) is a unique internal alphanumeric code assigned to each distinct product variant (color, size, packaging) for inventory tracking.', 'SKU (स्टॉक कीपिंग यूनिट) इन्वेंट्री ट्रैकिंग के लिए प्रत्येक उत्पाद संस्करण (रंग, आकार, पैकेजिंग) को सौंपा गया एक विशिष्ट आंतरिक कोड है।')
      .replaceAll('Accurate SKU coding eliminates warehouse packing errors, speeds up order fulfillment, and enables automated stock reconciliation.', 'सटीक SKU कोडिंग वेयरहाउस पैकिंग त्रुटियों को समाप्त करती है, ऑर्डर पूर्ति में तेजी लाती है और स्वचालित स्टॉक मिलान सक्षम बनाती है।')
      .replaceAll('Declaring only product weight on shipping documents instead of total Gross Weight.', 'कुल ग्रॉस वेट के बजाय शिपिंग दस्तावेजों पर केवल उत्पाद के वजन की घोषणा करना।')
      .replaceAll('Forgetting to include pallet weights (each wooden pallet weighs 15-25 kg).', 'पैलेट के वजन को शामिल करना भूलना (प्रत्येक लकड़ी के पैलेट का वजन 15-25 किलोग्राम होता है)।')
      .replaceAll('Weigh packed master cartons on a certified digital scale at the factory before loading.', 'लोड करने से पहले कारखाने में एक प्रमाणित डिजिटल स्केल पर पैक किए गए मास्टर कार्टन का वजन करें।')
      .replaceAll('Ensure Gross Weight on Packing List matches Commercial Invoice and VGM certificate exactly.', 'यह सुनिश्चित करें कि पैकिंग लिस्ट पर ग्रॉस वेट कमर्शियल इनवॉइस और VGM प्रमाणपत्र से बिल्कुल मेल खाता हो।')
      .replaceAll('Gross Weight is the total combined weight of goods + packaging + pallets. It is critical for container safety, freight calculation, and SOLAS VGM compliance.', 'ग्रॉस वेट सामान + पैकेजिंग + पैलेट का कुल संयुक्त वजन है। यह कंटेनर सुरक्षा, भाड़ा गणना और SOLAS VGM अनुपालन के लिए महत्वपूर्ण है।')
      .replaceAll('Net Weight is the pure weight of goods excluding packaging. It is essential for commodity pricing, yield verification, and customs valuation.', 'नेट वेट पैकेजिंग को छोड़कर सामान का शुद्ध वजन है। यह कमोडिटी मूल्य निर्धारण, उपज सत्यापन और सीमा शुल्क मूल्यांकन के लिए आवश्यक है।')
      .replaceAll('Confusing Net Weight with Gross Weight on customs declarations.', 'सीमा शुल्क घोषणाओं पर नेट वेट को ग्रॉस वेट के साथ भ्रमित करना।')
      .replaceAll('Including inner retail packaging weight in Net Weight calculation.', 'नेट वेट की गणना में आंतरिक खुदरा पैकेजिंग वजन शामिल करना।')
      .replaceAll('List both Net Weight and Gross Weight clearly on every line item of your Packing List.', 'अपनी पैकिंग लिस्ट के प्रत्येक लाइन आइटम पर नेट वेट और ग्रॉस वेट दोनों को स्पष्ट रूप से सूचीबद्ध करें।')
      .replaceAll('Verify Net Weight for bulk commodity imports to ensure supplier did not short-ship goods.', 'यह सुनिश्चित करने के लिए कि सप्लायर ने कम सामान शिप नहीं किया है, थोक वस्तु आयातों के लिए नेट वेट की पुष्टि करें।')
      .replaceAll('Volume Weight = (L × W × H cm) ÷ 6000. Express carriers charge on whichever is higher between scale weight and volume weight.', 'वॉल्यूम वेट = (L × W × H सेमी) ÷ 6000। एक्सप्रेस वाहक स्केल वजन और वॉल्यूम वजन में से जो भी अधिक हो, उस पर शुल्क लेते हैं।')
      .replaceAll('is a critical weight and measurement standard in cargo logistics. It dictates cargo density, space allocation, container loading capacity, and freight cost billing for sea and air transport.', 'कार्गो लॉजिस्टिक्स में एक महत्वपूर्ण वजन और माप मानक है। यह समुद्री और हवाई परिवहन के लिए कार्गो घनत्व, स्थान आवंटन, कंटेनर लोडिंग क्षमता और माल भाड़ा बिलिंग तय करता है।')
      .replaceAll('Accurately computing', 'सटीक रूप से गणना करना')
      .replaceAll('prevents freight overcharges, container overloading penalties, vessel stability risks, and customs clearance delays at origin and destination ports.', 'माल भाड़े के अधिक प्रभार, कंटेनर ओवरलोडिंग पेनल्टी, जहाज की स्थिरता के जोखिम और मूल व गंतव्य बंदरगाहों पर कस्टम्स क्लीयरेंस में देरी को रोकता है।')
      .replaceAll('Always double-check outer carton dimensions and total scale weight before signing the final Packing List and VGM declaration.', 'अंतिम पैकिंग लिस्ट और VGM घोषणा पत्र पर हस्ताक्षर करने से पहले हमेशा बाहरी कार्टन के आयामों और कुल वजन की दोबारा जांच करें।')
      .replaceAll('Relying on estimated packaging weights or inner box dimensions rather than actual outer master carton measurements.', 'वास्तविक बाहरी मास्टर कार्टन मापों के बजाय अनुमानित पैकेजिंग वजन या आंतरिक बॉक्स आयामों पर भरोसा करना।')
      .replaceAll('is an essential container transport concept defining container utilization, loading method, and cargo security protocols during ocean freight.', 'समुद्री माल ढुलाई के दौरान कंटेनर उपयोग, लोडिंग विधि और कार्गो सुरक्षा प्रोटोकॉल को परिभाषित करने वाली एक आवश्यक कंटेनर परिवहन अवधारणा है।')
      .replaceAll('Choosing the right container strategy', 'सही कंटेनर रणनीति चुनना')
      .replaceAll('optimizes ocean freight rates, protects goods against transit damage, and ensures smooth port operations.', 'समुद्री माल भाड़ा दरों को अनुकूलित करता है, सामान को पारगमन क्षति से बचाता है और सुचारू बंदरगाह संचालन सुनिश्चित करता है।')
      .replaceAll('Inspect container floor integrity, door seal gaskets, and bolt seal numbers before signing container loading reports.', 'कंटेनर लोडिंग रिपोर्ट पर हस्ताक्षर करने से पहले कंटेनर के फर्श की अखंडता, दरवाजे की सील गास्केट और बोल्ट सील नंबरों का निरीक्षण करें।')
      .replaceAll('Selecting an improper container type or shipping mode leading to underutilized container space or excess freight charges.', 'अनुचित कंटेनर प्रकार या शिपिंग मोड का चयन करना जिसके परिणामस्वरूप कंटेनर स्थान का कम उपयोग होता है या अतिरिक्त भाड़ा शुल्क लगता है।')
      .replaceAll('represents a core maritime and air freight shipping term governing vessel schedules, transit times, carrier bookings, and freight movement.', 'एक मुख्य समुद्री और हवाई माल शिपिंग शब्द है जो जहाज के शेड्यूल, ट्रांजिट समय, वाहक बुकिंग और माल की आवाजाही को नियंत्रित करता है।')
      .replaceAll('enables importers to track cargo milestones, plan inventory arrival schedules, and avoid unexpected port demurrage or transit delays.', 'आयातकों को कार्गो मील के पत्थरों को ट्रैक करने, इन्वेंट्री आगमन कार्यक्रम की योजना बनाने और अप्रत्याशित पोर्ट डेमरेज या ट्रांजिट देरी से बचने में सक्षम बनाता है।')
      .replaceAll('Request regular milestone updates (ETD, ETA, transshipment logs) from your freight forwarder to manage supply chain expectations.', 'आपूर्ति श्रृंखला की उम्मीदों को प्रबंधित करने के लिए अपने फ्रेट फॉरवर्डर से नियमित अपडेट (ETD, ETA, ट्रांसशिपमेंट लॉग) का अनुरोध करें।')
      .replaceAll('Ignoring transit schedule updates and failing to prepare customs clearance documents before vessel arrival.', 'ट्रांजिट शेड्यूल अपडेट की अनदेखी करना और जहाज के आगमन से पहले कस्टम्स क्लीयरेंस दस्तावेज तैयार करने में विफल रहना।')
      .replaceAll('is an official Incoterm (International Commercial Term) published by the ICC defining the exact point of risk transfer, cost allocation, and division of responsibilities between seller and buyer.', 'ICC द्वारा प्रकाशित एक आधिकारिक इंकोटर्म है जो विक्रेता और खरीदार के बीच जोखिम हस्तांतरण, लागत आवंटन और जिम्मेदारियों के विभाजन के सटीक बिंदु को परिभाषित करता है।')
      .replaceAll('clearly establishes who pays ocean freight, who purchases marine insurance, and who handles export/import customs clearance, preventing costly legal disputes.', 'स्पष्ट रूप से स्थापित करता है कि समुद्री भाड़ा कौन देता है, समुद्री बीमा कौन खरीदता है, और निर्यात/आयात कस्टम्स क्लीयरेंस कौन संभालता है, जिससे महंगे कानूनी विवादों से बचा जा सके।')
      .replaceAll('is a key port and infrastructure concept in international trade, facilitating cargo handling, inland transit, warehousing, and customs clearance.', 'अंतरराष्ट्रीय व्यापार में एक प्रमुख बंदरगाह और बुनियादी ढांचा अवधारणा है, जो कार्गो हैंडलिंग, अंतर्देशीय पारगमन, वेयरहाउसिंग और कस्टम्स क्लीयरेंस की सुविधा प्रदान करती है।')
      .replaceAll('infrastructure speeds up cargo movement, reduces port dwell time, and avoids costly demurrage and detention charges.', 'बुनियादी ढांचा कार्गो की आवाजाही को गति देता है, पोर्ट ड्वेल समय को कम करता है और महंगे डेमरेज व डिटेंशन शुल्क से बचाता है।')
      .replaceAll('is a critical trade document required for legal compliance, customs clearance, foreign exchange settlement, and title of ownership in international trade.', 'अंतरराष्ट्रीय व्यापार में कानूनी अनुपालन, कस्टम्स क्लीयरेंस, विदेशी मुद्रा निपटान और स्वामित्व के अधिकार के लिए आवश्यक एक महत्वपूर्ण व्यापार दस्तावेज है।')
      .replaceAll('Without an accurate', 'सटीक दस्तावेज के बिना')
      .replaceAll('customs authorities cannot assess duty or clear shipments, leading to container holds, port fines, and payment delays.', 'सीमा शुल्क अधिकारी ड्यूटी का आकलन नहीं कर सकते या शिपमेंट को क्लियर नहीं कर सकते, जिससे कंटेनर होल्ड, पोर्ट जुर्माना और भुगतान में देरी होती है।')
      .replaceAll('is a statutory customs regulation, tariff classification, or compliance requirement governing import duties, taxes, and entry clearance.', 'आयात शुल्क, करों और प्रवेश निकासी को नियंत्रित करने वाला एक वैधानिक सीमा शुल्क नियम, शुल्क वर्गीकरण या अनुपालन आवश्यकता है।')
      .replaceAll('ensures smooth customs release, prevents heavy penalty duties, avoids cargo confiscation, and ensures legal import entry.', 'सुचारू सीमा शुल्क रिलीज सुनिश्चित करता है, भारी जुर्माना शुल्कों को रोकता है, कार्गो जब्ती से बचाता है और कानूनी आयात प्रवेश सुनिश्चित करता है।')
      .replaceAll('is a standard international financial payment mechanism governing trade settlement, credit risk management, and banking transfers.', 'व्यापार निपटान, क्रेडिट जोखिम प्रबंधन और बैंकिंग ट्रांसफर को नियंत्रित करने वाला एक मानक अंतरराष्ट्रीय वित्तीय भुगतान तंत्र है।')
      .replaceAll('protects buyer and seller against payment default, currency fluctuations, and non-delivery of goods.', 'खरीदार और विक्रेता को भुगतान चूक, मुद्रा में उतार-चढ़ाव और सामान की गैर-डिलीवरी से बचाता है।')
      .replaceAll('refers to specific freight, terminal, or port handling fee charged by shipping lines, port authorities, and forwarders during cargo movement.', 'कार्गो की आवाजाही के दौरान शिपिंग लाइनों, बंदरगाह अधिकारियों और फॉरवर्डर्स द्वारा लिए जाने वाले विशिष्ट माल भाड़े, टर्मिनल या पोर्ट हैंडलिंग शुल्क को संदर्भित करता है।')
      .replaceAll('prevents unexpected landed cost inflation and helps importers negotiate competitive all-inclusive freight quotes.', 'अप्रत्याशित लैंडेड लागत वृद्धि को रोकता है और आयातकों को प्रतिस्पर्धी सर्व-समावेशी भाड़ा कोटेशन पर बातचीत करने में मदद करता है।')
      .replaceAll('is a formal quality control procedure, defect inspection method, or compliance standard ensuring manufactured goods meet required specifications.', 'एक औपचारिक गुणवत्ता नियंत्रण प्रक्रिया, दोष निरीक्षण विधि या अनुपालन मानक है जो यह सुनिश्चित करता है कि निर्मित उत्पाद आवश्यक विनिर्देशों को पूरा करते हैं।')
      .replaceAll('prevents receiving defective or non-compliant goods, protecting brand reputation and avoiding costly product recalls.', 'दोषपूर्ण या गैर-अनुपालन वाले सामान प्राप्त करने से रोकता है, ब्रांड की प्रतिष्ठा की रक्षा करता है और महंगे उत्पाद वापस मंगाने से बचाता है।')
      .replaceAll('is a core operational process in international business workflows, governing order processing, quotation, production tracking, and order fulfillment.', 'अंतरराष्ट्रीय व्यावसायिक वर्कफ़्लो में एक मुख्य परिचालन प्रक्रिया है, जो ऑर्डर प्रोसेसिंग, कोटेशन, प्रोडक्शन ट्रैकिंग और ऑर्डर पूर्ति को नियंत्रित करती है।')
      .replaceAll('ensures timely production execution, clear supplier communication, and reliable product delivery schedules.', 'समय पर उत्पादन निष्पादन, स्पष्ट आपूर्तिकर्ता संचार और विश्वसनीय उत्पाद वितरण कार्यक्रम सुनिश्चित करता है।')
      .replaceAll('is a key risk management protocol, insurance provision, or legal remedy designed to mitigate trade losses, transit damage, and contract breaches.', 'व्यापारिक नुकसान, पारगमन क्षति और अनुबंध उल्लंघनों को कम करने के लिए डिज़ाइन किया गया एक प्रमुख जोखिम प्रबंधन प्रोटोकॉल, बीमा प्रावधान या कानूनी उपाय है।')
      .replaceAll('management protects business capital against unexpected maritime losses, shipment delays, and supplier default.', 'प्रबंधन अप्रत्याशित समुद्री नुकसान, शिपमेंट में देरी और आपूर्तिकर्ता चूक के खिलाफ व्यावसायिक पूंजी की रक्षा करता है।')
      .replaceAll('is a specialized internal operational workflow at RBC designed to ensure quality control, supplier verification, and seamless import execution.', 'गुणवत्ता नियंत्रण, सप्लायर सत्यापन और निर्बाध आयात निष्पादन सुनिश्चित करने के लिए RBC में डिज़ाइन किया गया एक विशेष आंतरिक परिचालन वर्कफ़्लो है।')
      .replaceAll('procedure guarantees operational consistency, risk mitigation, and high customer satisfaction across all trade transactions.', 'प्रक्रिया सभी व्यापारिक लेनदेन में परिचालन निरंतरता, जोखिम शमन और उच्च ग्राहक संतुष्टि की गारंटी देती है।')
      .replaceAll('is a fundamental operational term in global import-export trade, defining rules, documentation, and compliance standards.', 'वैश्विक आयात-निर्यात व्यापार में एक मूलभूत परिचालन शब्द है, जो नियमों, दस्तावेज़ीकरण और अनुपालन मानकों को परिभाषित करता है।')
      .replaceAll('helps international trade teams optimize logistics costs, ensure legal compliance, and avoid customs delays.', 'अंतरराष्ट्रीय व्यापार टीमों को लॉजिस्टिक्स लागत को अनुकूलित करने, कानूनी अनुपालन सुनिश्चित करने और सीमा शुल्क देरी से बचने में मदद करता है।')
      .replaceAll('is a fundamental product definition, identification code, or technical specification parameter in commercial trade.', 'वाणिज्यिक व्यापार में एक मूलभूत उत्पाद परिभाषा, पहचान कोड या तकनीकी विनिर्देश पैरामीटर है।')
      .replaceAll('guarantees product consistency, prevents supplier misunderstandings, and ensures correct customs classification.', 'उत्पाद की निरंतरता की गारंटी देता है, आपूर्तिकर्ता की गलतफहमी को रोकता है और सही सीमा शुल्क वर्गीकरण सुनिश्चित करता है।')
...
export const getTranslatedLesson = (
  ...
  const translatedLesson = {
    ...
    content: {
      ...
      keyPoints: (override as any)?.keyPoints || lesson.content.keyPoints?.map((k: string) => translateDynamicContent(k, lesson.title, lang)) || [],
      objectives: (override as any)?.objectives || lesson.content.objectives?.map((o: string) => translateDynamicContent(o, lesson.title, lang)) || [],
      faqs: (override as any)?.faqs || lesson.content.faqs?.map((f: any) => ({
        question: translateDynamicContent(f.question, lesson.title, lang),
        answer: translateDynamicContent(f.answer, lesson.title, lang)
      })) || [],
