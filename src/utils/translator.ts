...
const EXPLICIT_HI_MAP: Record<string, string> = {
  ...
  "Use a standard spec sheet template with sections: Product Name, SKU, Dimensions, Weight, Material, Color, Certification, Packaging.": "Use a standard spec sheet template with sections: Product Name, SKU, Dimensions, Weight, Material, Color, Certification, Packaging.",
  ...
  "Request prototype before mass production": "Request prototype before mass production",
  "ODM = Factory owns design, buyer brands it": "ODM = Factory owns design, buyer brands it",
  "Faster and cheaper than OEM": "Faster and cheaper than OEM",
  "Request market exclusivity agreement": "Request market exclusivity agreement",
  "Private Label = Factory makes, you brand": "Private Label = Factory makes, you brand",
  "Register trademark first": "Register trademark first",
  "Invest in packaging design": "Invest in packaging design",
  "Product Spec = Legal document between buyer and factory": "Product Spec = Legal document between buyer and factory",
  "Include dimensions, materials, certifications": "Include dimensions, materials, certifications",
  "Factory must sign before production starts": "Factory must sign before production starts",
  "Sample before mass production = essential": "Sample before mass production = essential",
  "Test functionality + dimensions + quality": "Test functionality + dimensions + quality",
  "Written approval before deposit": "Written approval before deposit",
  "Model Number = Manufacturer\\": "Model Number = Manufacturer\\",
  "Brand = Product identity and perception": "Brand = Product identity and perception",
  "Trademark registration = legal protection": "Trademark registration = legal protection",
